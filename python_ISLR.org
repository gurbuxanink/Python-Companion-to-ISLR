...
#+LATEX_HEADER: \usepackage{amsmath,booktabs,placeins,fancyhdr,xcolor}
...
#+LATEX_HEADER: \lstset{keywordstyle=\color{blue}\bfseries, stringstyle=\ttfamily, commentstyle=\color{olive}\slshape, basicstyle=\ttfamily, showstringspaces=false, breaklines=true, showstringspaces=false}
# #+LATEX_HEADER: \input{listings-acm.prf}
