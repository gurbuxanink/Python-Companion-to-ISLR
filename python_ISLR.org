...
#+CAPTION: A linear model fit by least squares to the =Income= data from previous figure.  The observations are shown in red, and the blue plane indicates the least squares fit to the data.
#+RESULTS: fig2_4plot
