...
#+NAME: getBetas
#+BEGIN_SRC python :session calc :exports results :results values drawer
  import pandas as pd
...
#+NAME: sales_tv_reg
#+BEGIN_SRC python :exports results :results value latex
    import pandas as pd
    import statsmodels.formula.api as smf
...
In the next table [[tab:linearRegTab2]], we report more information about the least squares model.  
