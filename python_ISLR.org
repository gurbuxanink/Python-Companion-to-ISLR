...
#+LATEX_HEADER: \lstset{keywordstyle=\color{blue}\bfseries, commentstyle=\color{purple}\slshape, showstringspaces=false, breaklines=true, breakwhitespace=false, stringstyle=\color{red}, basicstyle=\fontfamily{lmtt}\selectfont\footnotesize, procnamekeys={def,class}, frame=lines}
