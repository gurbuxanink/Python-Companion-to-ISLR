...
1.  [Introduction](#orgf744025)
2.  [Statistical Learning](#org92a5f9c)
    1.  [What is Statistical Learning?](#orgf5371e0)
    2.  [Assessing Model Accuracy](#orgcef1f68)
    3.  [Lab: Introduction to Python](#org3f444c8)
        1.  [Basic Commands](#org7cbac99)
        2.  [Graphics](#org693603c)
        3.  [Indexing Data](#org1081db5)
        4.  [Loading Data](#orgb9aa960)
        5.  [Additional Graphical and Numerical Summaries](#org977b53f)
3.  [Linear Regression](#orgae65e70)
    1.  [Simple Linear Regression](#orgd19d9f9)
    2.  [Multiple Linear Regression](#org0b820b2)
    3.  [Other Considerations in the Regression Model](#orgc950ff1)
    4.  [The Marketing Plan](#org7bec431)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org780b531)
    6.  [Lab: Linear Regression](#orgf7763d9)
        1.  [Libraries](#org1691dda)
        2.  [Simple Linear Regression](#org6e6c1a0)
        3.  [Multiple Linear Regression](#org012b34f)
        4.  [Interaction Terms](#org8bdf111)
        5.  [Non-linear Transformations of the Predictors](#org560d7e4)
        6.  [Qualitative Predictors](#org6d3a27a)
        7.  [Calling `R` from `Python`](#orgbad57ba)
4.  [Classification](#orgb3c3680)
    1.  [An Overview of Classification](#org07971a5)
    2.  [Why Not Linear Regression?](#org098e0ea)
    3.  [Logistic Regression](#org85f05a8)
    4.  [Linear Discriminant Analysis](#org1ae9944)
    5.  [A Comparison of Classification Methods](#org3d6ed9b)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org97fa98f)
        1.  [The Stock Market Data](#orgf85232c)
        2.  [Logistc Regression](#org781b55e)
        3.  [Linear Discriminant Analysis](#org8ceefc4)
        4.  [Quadratic Discriminant Analysis](#org699b945)
        5.  [K-Nearest Neightbors](#org343c651)
        6.  [An Application to Caravan Insurance Data](#orgeee6e4d)
5.  [Resampling Methods](#org582d979)
    1.  [Cross-Validation](#org960c724)
    2.  [The Bootstrap](#org08f5201)
    3.  [Lab: Cross-Validation and the Bootstrap](#orge1373ac)
...
Figure [2](#orgca7ca68) shows graphs of Wage versus three variables. 
...
Figure [4](#orgd64a17e) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org62b4bcd) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org33bd23a) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org3e0338c) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgdc510da) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org3e0338c).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org368959a) provides an illustration of the trade-off between
...
Figure [17](#org764faca) provides a simple illustration of the clustering problem.
...
Figure [21](#org36c41c9) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org36c41c9), we see considerable
...
Figure [23](#org08bd083) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org36c41c9) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orgd8d5038) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org36c41c9), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgf17d9ab) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org36c41c9) - [25](#orgd8d5038).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org3778ed1) provides an example using a simulated data set in
...
Figure [31](#orgf934f47) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org3778ed1).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org3778ed1), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org3778ed1).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgdbe446d) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org3778ed1) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgbc6c421) displays the simple linear regression fit to the
...
In figure [50](#orgacc3558), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgdb620c1) displays *population regression
...
right-hand panel of figure [52](#orgdb620c1) we have generated five different
...
For `Advertising` data, table [1](#org3289e74) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org3289e74" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgdac1262), we report more information about the least squares model.  

<table id="orgdac1262" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org814de16)  shows results of two simple linear
...
<table id="org814de16" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#orgb86fc42) illustrates an example of the least squares fit to a
...
Table [4](#org0ae24f3) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org0ae24f3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org24d6b66) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org0ae24f3). 

<table id="org24d6b66" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgf347d46" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org0ae24f3).</caption>
...
Figure [61](#org27c6c12) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org500f00b) records `balance`
...
Table [7](#org1eedc82) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org1eedc82" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org466b8c7) we see that the estimated `balance` for the
...
<table id="org466b8c7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org8e025de) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org5603f42), the left panel shows least squares lines when
...
<table id="org8e025de" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org521018e) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org03beda5) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org03beda5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org045e279) displays a residual plot from the
...
of figure[73](#org045e279) displays the residual plot results from the model
...
Figure [75](#orgfba7219) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgcc04334), the magnitude of the
...
[79](#orgc852b15) illustrates a typical outlier.  The red solid line is the
...
[79](#orgc852b15), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgcc9b32d) has
...
[81](#orgcc9b32d) are the same as the data displayed in figure
[79](#orgc852b15), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgc852b15) and
[81](#orgcc9b32d), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgcc9b32d), for a data set with two
...
point. The right-panel of figure [81](#orgcc9b32d) provides a plot of
...
Figure [83](#orgff668f4) illustrates the concept of collinearity.
...
Figure [86](#org807cbad) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org807cbad) displays contour
...
Table [11](#org389d200) compares the coefficient estimates obtained from two
...
<table id="org389d200" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org06559b8) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org88b4213) provides an example of KNN regression with data
...
Figure [93](#orge526b85) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orge526b85)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org88b4213) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orga131f5f) examines the relative performances of least squares
...
Figure [97](#orgfe24e28) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orga131f5f), except that we have added additional *noise*
...
In figure [110](#org36c935a), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgd5a0c2a) we show probability of default as a function of
...
Table [12](#orgf6ca2e1) shows the coefficient estimates and related
...
<table id="orgf6ca2e1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org7fd2dd9) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org3563aa1) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org7fd2dd9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org3563aa1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgc4d5a08) shows average default rates
...
[14](#org3563aa1).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orga33a4df), two normal density functions
...
figure [121](#org87858e5).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org87858e5).  In this situation, the base
...
Figure [123](#org1944a7e) shows an example of three equally sized Gaussian
...
[15](#orgbd1197d), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgf37a60d) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgbd1197d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgf37a60d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org2233593) illustrates the trade-off that results from
...
Figure [128](#org55c9492) displays the ROC curve for the LDA classifier on
...
Table [17](#org699c52f) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org699c52f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgb0adc3b) lists many of the popular performance measures that
are used in this context.

<table id="orgb0adc3b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org699c52f).</caption>
...
Figure [132](#orgabceddd) illustrates the performances of LDA and QDA in two
...
Figure [134](#org7856a6b) illustrates the performances of the four
...
Figure [143](#org566d80d) displays the *validation set approach*, a simple
...
In figure [145](#orga0154fe), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org583d946) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org8677124) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org8677124) shows nine different 10-fold
...
Figure [151](#org3c8200d) illustrates the *k*-fold CV approach.
...
In figure [153](#orge76a02a), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org36c41c9),
[23](#org08bd083), and [25](#orgd8d5038) of chapter [2](#orgb6b1387).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org36c41c9) (left), [23](#org08bd083) (center), and [25](#orgd8d5038) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org2b1c90d) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org3778ed1).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgee4262a) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgee4262a) displays the same three curves
...
Figure [160](#orgab006fd) illustrates the approach for estimating &alpha; by
...
figure [163](#org2b2e746) displays a histogram of the resulting estimates.  The
...
[163](#org2b2e746), which displays a histogram of 1000 bootstrap estimates of
