...
1.  [Introduction](#orgcc996a6)
2.  [Statistical Learning](#org9c856a5)
    1.  [What is Statistical Learning?](#org35f92ad)
    2.  [Assessing Model Accuracy](#org12fcd0a)
    3.  [Lab: Introduction to Python](#orgc2af949)
        1.  [Basic Commands](#org6765a35)
        2.  [Graphics](#org02818b3)
        3.  [Indexing Data](#org3d45cd3)
        4.  [Loading Data](#org9a9d875)
        5.  [Additional Graphical and Numerical Summaries](#orgdb8b60b)
3.  [Linear Regression](#orgdbfec2b)
    1.  [Simple Linear Regression](#org6016d90)
    2.  [Multiple Linear Regression](#org87f9b26)
    3.  [Other Considerations in the Regression Model](#orgdada9bd)
    4.  [The Marketing Plan](#orgbeb4d99)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orgc634386)
    6.  [Lab: Linear Regression](#org97c009f)
        1.  [Libraries](#org6749338)
        2.  [Simple Linear Regression](#orgbae5176)
        3.  [Multiple Linear Regression](#org8fe4bd3)
        4.  [Interaction Terms](#org8b7cd12)
        5.  [Non-linear Transformations of the Predictors](#org57f89dc)
        6.  [Qualitative Predictors](#org4195680)
        7.  [Calling `R` from `Python`](#org586e3fc)
4.  [Classification](#org26f8f6d)
    1.  [An Overview of Classification](#orgb42dd9f)
    2.  [Why Not Linear Regression?](#org1b858bc)
    3.  [Logistic Regression](#org41c476a)
    4.  [Linear Discriminant Analysis](#orgeb8aaed)
    5.  [A Comparison of Classification Methods](#org5e53e1d)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orge7e7321)
        1.  [The Stock Market Data](#org8d05637)
        2.  [Logistc Regression](#org849609c)
        3.  [Linear Discriminant Analysis](#orgb4e17a1)
        4.  [Quadratic Discriminant Analysis](#orgb5ef57f)
        5.  [K-Nearest Neightbors](#org92f21a4)
        6.  [An Application to Caravan Insurance Data](#org23d671b)
5.  [Resampling Methods](#orgbde55dd)
    1.  [Cross-Validation](#org2ed4bed)
    2.  [The Bootstrap](#orgb5f7f7c)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgf9da431)
        1.  [The Validation Set Approach](#org46fe524)
        2.  [Leave-One-Out Cross-Validation](#orgc53897d)
        3.  [k-Fold Cross-Validation](#org28842b8)
        4.  [The Bootstrap](#org1f4d8db)
6.  [Linear Model Selection and Regularization](#orge27f036)
    1.  [Subset Selection](#org09727d3)
    2.  [Shrinkage Methods](#org41f498a)
    3.  [Dimension Reduction Methods](#org90b8812)
    4.  [Considerations in High Dimensions](#orga56d491)
    5.  [Lab 1: Subset Selection Methods](#org7ca763e)
        1.  [Best Subset Selection](#org00dab60)
        2.  [Forward and Backward Stepwise Selection](#org7266e86)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org07c070b)
    6.  [Lab 2: Ridge Regression and the Lasso](#org8ac33cb)
        1.  [Ridge Regression](#org1f3a0de)
        2.  [The Lasso](#org75d4f9d)
...
Figure [2](#org44f9de7) shows graphs of Wage versus three variables. 
...
Figure [4](#orgf86603f) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgd91d37c) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org6811ddd) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org8891a60) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orge83ff92) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org8891a60).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org100f35d) provides an illustration of the trade-off between
...
Figure [17](#org1a3c3f5) provides a simple illustration of the clustering problem.
...
Figure [21](#org9d1b553) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org9d1b553), we see considerable
...
Figure [23](#org5cf2ec7) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org9d1b553) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org35acd2f) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org9d1b553), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgd71c3b2) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org9d1b553) - [25](#org35acd2f).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgeab2c87) provides an example using a simulated data set in
...
Figure [31](#org0b05e54) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgeab2c87).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgeab2c87), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgeab2c87).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org318bf8e) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orgeab2c87) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgfcec094) displays the simple linear regression fit to the
...
In figure [50](#orga9e59f0), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org3e9db88) displays *population regression
...
right-hand panel of figure [52](#org3e9db88) we have generated five different
...
For `Advertising` data, table [1](#org16bec14) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org16bec14" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org03d8008), we report more information about the least squares model.  

<table id="org03d8008" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgb31cd51)  shows results of two simple linear
...
<table id="orgb31cd51" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org4cca600) illustrates an example of the least squares fit to a
...
Table [4](#org3ed45ae) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org3ed45ae" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgcff903a) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org3ed45ae). 

<table id="orgcff903a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgb596a86" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org3ed45ae).</caption>
...
Figure [61](#org9bea52a) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgf681900) records `balance`
...
Table [7](#org3a154e7) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org3a154e7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org135fd00) we see that the estimated `balance` for the
...
<table id="org135fd00" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org04e46f3) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orga6fa1dc), the left panel shows least squares lines when
...
<table id="org04e46f3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org7e7114b) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgfadd31f) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgfadd31f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgee356b5) displays a residual plot from the
...
of figure[73](#orgee356b5) displays the residual plot results from the model
...
Figure [75](#orgd5bcf1a) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org4a10dd1), the magnitude of the
...
[79](#org6681cb0) illustrates a typical outlier.  The red solid line is the
...
[79](#org6681cb0), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org37d77ef) has
...
[81](#org37d77ef) are the same as the data displayed in figure
[79](#org6681cb0), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org6681cb0) and
[81](#org37d77ef), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org37d77ef), for a data set with two
...
point. The right-panel of figure [81](#org37d77ef) provides a plot of
...
Figure [83](#org66e85f7) illustrates the concept of collinearity.
...
Figure [86](#org63d089a) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org63d089a) displays contour
...
Table [11](#org404904c) compares the coefficient estimates obtained from two
...
<table id="org404904c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org68435ae) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org3131217) provides an example of KNN regression with data
...
Figure [93](#org2c8ee0d) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org2c8ee0d)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org3131217) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgf41d442) examines the relative performances of least squares
...
Figure [97](#org929238a) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgf41d442), except that we have added additional *noise*
...
In figure [110](#org8d86278), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgbc3a971) we show probability of default as a function of
...
Table [12](#org55868f9) shows the coefficient estimates and related
...
<table id="org55868f9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org7a22f46) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org6903a4e) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org7a22f46" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org6903a4e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org0c5922c) shows average default rates
...
[14](#org6903a4e).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org65c4f8e), two normal density functions
...
figure [121](#org2b6f28b).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org2b6f28b).  In this situation, the base
...
Figure [123](#org2fcc224) shows an example of three equally sized Gaussian
...
[15](#org65e3188), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orge884f48) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org65e3188" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orge884f48" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org3162019) illustrates the trade-off that results from
...
Figure [128](#orgead1902) displays the ROC curve for the LDA classifier on
...
Table [17](#orgbc9dd2d) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orgbc9dd2d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org4fadb87) lists many of the popular performance measures that
are used in this context.

<table id="org4fadb87" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orgbc9dd2d).</caption>
...
Figure [132](#org26fe604) illustrates the performances of LDA and QDA in two
...
Figure [134](#org9531c36) illustrates the performances of the four
...
Figure [143](#org6ddf0c7) displays the *validation set approach*, a simple
...
In figure [145](#org5d68cea), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org3561db3) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org645422d) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org645422d) shows nine different 10-fold
...
Figure [151](#org6478aca) illustrates the *k*-fold CV approach.
...
In figure [153](#org9deb377), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org9d1b553),
[23](#org5cf2ec7), and [25](#org35acd2f) of chapter [2](#org32a210d).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org9d1b553) (left), [23](#org5cf2ec7) (center), and [25](#org35acd2f) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orge1dd8e7) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgeab2c87).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orga5987e8) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orga5987e8) displays the same three curves
...
Figure [160](#org7a0d9fd) illustrates the approach for estimating &alpha; by
...
figure [163](#orgcef0f3e) displays a histogram of the resulting estimates.  The
...
[163](#orgcef0f3e), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org40b289b).
...
Table [19](#org69f70bf) shows first four selected models for the best subset and
...
<table id="org69f70bf" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org94fff92) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org94fff92) displays the same ridge
...
[182](#org479e550) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org8a087e8), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org8a087e8), as we
...
Figure [186](#org95730da) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org484ba18) displays the choice of &lambda; that results from
...
Figure [190](#orge440803) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgd495d0a), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgd495d0a), the left-hand panel has
...
Figure [195](#orgfe22d17) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org0505638) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orgf5e4cd0) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgaba6ca0) further illustrates the risk of carelessly applying
...
Figure [203](#org4eb2a1a) illustrates the performance of the lasso in a simple
