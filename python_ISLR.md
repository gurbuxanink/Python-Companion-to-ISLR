...
1.  [Introduction](#org104d2e2)
2.  [Statistical Learning](#org8960f51)
    1.  [What is Statistical Learning?](#orgd5e82e8)
    2.  [Assessing Model Accuracy](#orgb28765c)
    3.  [Lab: Introduction to Python](#orga90ee60)
        1.  [Basic Commands](#orgd72ed8c)
        2.  [Graphics](#org7de6fa3)
        3.  [Indexing Data](#orgfe606d4)
        4.  [Loading Data](#org08e9ade)
        5.  [Additional Graphical and Numerical Summaries](#org1c1cf18)
3.  [Linear Regression](#org88c5845)
    1.  [Simple Linear Regression](#org686f4e7)
    2.  [Multiple Linear Regression](#orgcee9d01)
    3.  [Other Considerations in the Regression Model](#org6da4a28)
    4.  [The Marketing Plan](#org96e2a96)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org51b64be)
    6.  [Lab: Linear Regression](#orgdd9df9e)
        1.  [Libraries](#org597c835)
        2.  [Simple Linear Regression](#org4410c1b)
        3.  [Multiple Linear Regression](#orge19036e)
        4.  [Interaction Terms](#orgf401628)
        5.  [Non-linear Transformations of the Predictors](#orgcb47d64)
        6.  [Qualitative Predictors](#org0ff2018)
        7.  [Calling `R` from `Python`](#orgc817d5c)
4.  [Classification](#orge56aec0)
    1.  [An Overview of Classification](#org424a0e5)
    2.  [Why Not Linear Regression?](#org9fb7535)
    3.  [Logistic Regression](#org33b42d0)
    4.  [Linear Discriminant Analysis](#org75202e8)
    5.  [A Comparison of Classification Methods](#org9819a31)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orga6f74f0)
        1.  [The Stock Market Data](#orga96215e)
        2.  [Logistc Regression](#orgcf4514c)
        3.  [Linear Discriminant Analysis](#orgbeaa2fa)
        4.  [Quadratic Discriminant Analysis](#org318d212)
        5.  [K-Nearest Neightbors](#orgb2013dc)
        6.  [An Application to Caravan Insurance Data](#org08d9579)
5.  [Resampling Methods](#org8d1360a)
    1.  [Cross-Validation](#org9330472)
    2.  [The Bootstrap](#org4b3c8bf)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgf7dde99)
        1.  [The Validation Set Approach](#org89a5f52)
        2.  [Leave-One-Out Cross-Validation](#org4cc00b6)
        3.  [k-Fold Cross-Validation](#org8138c5c)
        4.  [The Bootstrap](#orgde04d06)
6.  [Linear Model Selection and Regularization](#orge72962d)
    1.  [Subset Selection](#orgc8846be)
    2.  [Shrinkage Methods](#orgb1b8da1)
    3.  [Dimension Reduction Methods](#orgf534bb0)
    4.  [Considerations in High Dimensions](#org084a6aa)
    5.  [Lab 1: Subset Selection Methods](#org74e126f)
        1.  [Best Subset Selection](#org5067224)
        2.  [Forward and Backward Stepwise Selection](#org462515e)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org42f3abe)
    6.  [Lab 2: Ridge Regression and the Lasso](#org4037118)
        1.  [Ridge Regression](#orga7779da)
        2.  [The Lasso](#org569c56b)
    7.  [Lab 3: PCR and PLS Regression](#orgb778920)
        1.  [Principal Components Regression](#org453b4c7)
        2.  [Partial Least Squares](#org99f18b9)
7.  [Moving Beyond Linearity](#orgb36b52d)
    1.  [Polynomial Regression](#org0b0f0f7)
    2.  [Step Functions](#org3643611)
    3.  [Basis Functions](#org8468061)
    4.  [Regression Splines](#orgba4753f)
    5.  [Lab: Non-linear Modeling](#org3479ff9)
        1.  [Polynomial Regression and Step Functions](#org232c685)
8.  [Tree-Based Models](#org28197b3)
    1.  [The Basics of Decision Trees](#org543e698)
        1.  [Regression Trees](#orgda361f0)
        2.  [Classification Trees](#org49cca86)
        3.  [Trees versus Linear Models](#org4b908a2)
    2.  [Bagging, Random Forests, Boosting](#orgbf577b8)
    3.  [Lab: Decision Trees](#org4bc8edb)
        1.  [Fitting Classification Trees](#org2504cb1)
        2.  [Fitting Regression Trees](#org99206aa)
        3.  [Bagging and Random Forests](#orga348518)
        4.  [Boosting](#org55e0466)
9.  [Support Vector Machines](#orgae02716)
    1.  [Maximal Margin Classifier](#org72ed982)
        1.  [What is a Hyperplane?](#org0746c90)
        2.  [Classification Using a Separating Hyperplane](#orgc5061ad)
        3.  [The Maximal Margin Classifier](#org46d901a)
        4.  [Construction of the Maximal Margin Classifier](#org52971c0)
        5.  [The Non-separable Case](#org22bc15e)
    2.  [Support Vector Classifiers](#org9b91bad)
        1.  [Overview of the Support Vector Classifier](#org050ae54)
        2.  [Details of the Support Vector Classifier](#org7e95a62)
    3.  [Support Vector Machines](#org07f6051)
        1.  [Classification with Non-linear Decision Boundaries](#org92a84f5)
        2.  [The Support Vector Machine](#orgf5d7a7e)
        3.  [An Application to the Heart Disease Data](#org8c2c796)
    4.  [SVMs with More than Two Classes](#orgb0a5146)
        1.  [One-Versus-One Classification](#org45fb94e)
        2.  [One-Versus-All Classification](#org3c50968)
    5.  [Relationship with Logistic Regression](#orgf0ea068)
    6.  [Lab: Support Vector Machines](#org433aebe)
        1.  [Support Vector Classifier](#orga5c3349)
        2.  [Support Vector Machine](#org37e8096)
        3.  [ROC Curves](#orgd8f5f15)
        4.  [SVM with Multiple Classes](#org3a5042a)
        5.  [Application to Gene Expression Data](#orge40d6d2)
10. [Unsupervised Learning](#org9725807)
    1.  [The Challenge of Unsupervised Learning](#org31a8605)
    2.  [Principal Component Analysis](#orga56190a)
        1.  [What are Principal Components?](#org86744c6)
        2.  [Another Interpretation of Principal Components](#orgfcc0e28)
        3.  [More on PCA](#org5e8ac5f)
    3.  [Clustering Methods](#orge67d57f)
        1.  [K-Means Clustering](#org4807723)
        2.  [Hierarchical Clustering](#orgb4b6fd6)
...
Figure [2](#org191cb6e) shows graphs of Wage versus three variables. 
...
Figure [4](#org5de0467) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org1ef0c08) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org7e708d8) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org7c717b4) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgc704db5) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org7c717b4).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org3a2936e) provides an illustration of the trade-off between
...
Figure [17](#org93b9214) provides a simple illustration of the clustering problem.
...
Figure [21](#orga1ff0e9) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orga1ff0e9), we see considerable
...
Figure [23](#orgde336c6) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orga1ff0e9) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org247afa9) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orga1ff0e9), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgbece78c) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orga1ff0e9) - [25](#org247afa9).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org46a5034) provides an example using a simulated data set in
...
Figure [31](#orge4db2f6) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org46a5034).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org46a5034), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org46a5034).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgec3f7b0) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org46a5034) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org65e7dfb) displays the simple linear regression fit to the
...
In figure [50](#org4b21cee), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org8a8d72c) displays *population regression
...
right-hand panel of figure [52](#org8a8d72c) we have generated five different
...
For `Advertising` data, table [1](#org300d467) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org300d467" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org502cb13), we report more information about the least squares model.  

<table id="org502cb13" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgce6787e)  shows results of two simple linear
...
<table id="orgce6787e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org29179ef) illustrates an example of the least squares fit to a
...
Table [4](#orgade2aad) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgade2aad" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org297c049) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgade2aad). 

<table id="org297c049" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orge741c5a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgade2aad).</caption>
...
Figure [61](#org2092192) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgc964229) records `balance`
...
Table [7](#orga922bda) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orga922bda" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org688402a) we see that the estimated `balance` for the
...
<table id="org688402a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org7a8385c) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org53b86ed), the left panel shows least squares lines when
...
<table id="org7a8385c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgc11fecc) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org2ccf0f1) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org2ccf0f1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orge8f73b5) displays a residual plot from the
...
of figure[73](#orge8f73b5) displays the residual plot results from the model
...
Figure [75](#org1c99a50) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org6022225), the magnitude of the
...
[79](#org3f7f7aa) illustrates a typical outlier.  The red solid line is the
...
[79](#org3f7f7aa), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orge2817fa) has
...
[81](#orge2817fa) are the same as the data displayed in figure
[79](#org3f7f7aa), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org3f7f7aa) and
[81](#orge2817fa), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orge2817fa), for a data set with two
...
point. The right-panel of figure [81](#orge2817fa) provides a plot of
...
Figure [83](#org3645e15) illustrates the concept of collinearity.
...
Figure [86](#org6917f68) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org6917f68) displays contour
...
Table [11](#orgaa67523) compares the coefficient estimates obtained from two
...
<table id="orgaa67523" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#orgd63ea81) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org8081b92) provides an example of KNN regression with data
...
Figure [93](#org80ca27c) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org80ca27c)
...
Figure [97](#orgee9c748) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orga89372d), except that we have added additional *noise*
...
In figure [110](#orgbfebccd), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org6ae013d) we show probability of default as a function of
...
Table [12](#org837c112) shows the coefficient estimates and related
...
<table id="org837c112" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org20dff9f) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org635b717) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org20dff9f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org635b717" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org7c83493) shows average default rates
...
[14](#org635b717).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org58c23fa), two normal density functions
...
figure [121](#orgdbe0bd3).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgdbe0bd3).  In this situation, the base
...
Figure [123](#orged50c93) shows an example of three equally sized Gaussian
...
[15](#orgad5017b), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgcea2661) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgad5017b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgcea2661" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgbbc3c33) illustrates the trade-off that results from
...
Figure [128](#orga1c94d7) displays the ROC curve for the LDA classifier on
...
Table [17](#org7278fac) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org7278fac" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org4f111d3) lists many of the popular performance measures that
are used in this context.

<table id="org4f111d3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org7278fac).</caption>
...
Figure [132](#org6417008) illustrates the performances of LDA and QDA in two
...
Figure [134](#org544d120) illustrates the performances of the four
...
Figure [143](#org0ae9af9) displays the *validation set approach*, a simple
...
In figure [145](#org706b38d), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orge4ee541) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org8dd2f27) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org8dd2f27) shows nine different 10-fold
...
Figure [151](#orgd1a91e1) illustrates the *k*-fold CV approach.
...
In figure [153](#orga8c0422), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orga1ff0e9),
[23](#orgde336c6), and [25](#org247afa9) of chapter [2](#orgf6d45e5).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orga1ff0e9) (left), [23](#orgde336c6) (center), and [25](#org247afa9) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org70cb40e) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org46a5034).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgddefcb1) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgddefcb1) displays the same three curves
...
Figure [160](#orgd28d942) illustrates the approach for estimating &alpha; by
...
figure [163](#org9f721f3) displays a histogram of the resulting estimates.  The
...
[163](#org9f721f3), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org6ccdc58).
...
Table [19](#org9614c31) shows first four selected models for the best subset and
...
<table id="org9614c31" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org16e3eaa) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org16e3eaa) displays the same ridge
...
[182](#org9dfb1dc) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org5dcf89d), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org5dcf89d), as we
...
Figure [186](#org825df12) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgd8de04d) displays the choice of &lambda; that results from
...
Figure [190](#org11517c1) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgff74460), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgff74460), the left-hand panel has
...
Figure [195](#orgcf80bde) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgddf07d1) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org261155c) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org65d0242) further illustrates the risk of carelessly applying
...
Figure [203](#orge2b4994) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org72d6e3e) is a plot of `wage` against
...
The left-hand panel of figure [227](#org8498639) shows a fit of step functions
to the `Wage` data from figure [225](#org72d6e3e).  We also fit the logistic
...
Figure [234](#org05283a0) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#orga82e666) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org05283a0).")

Figure [238](#org7df6810) shows a five-region example of prediction via
...
Figure [240](#orgc7e3596) is an example of when a linear model or a tree
...
Figure [242](#org8b898a9) is a graphical representation of *variable
...
Figure [247](#org665a93e) shows a hyperplane in two-dimensional space.
...
Figure [249](#org8b3b5e0) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#org0461352), we see that three training observations are
...
[251](#org0461352), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#org808b0fe) shows an example where we cannot *exactly* separate the two
...
In figures [255](#org79c5ecd), addition of a single observation in the right hand panel
...
Figure [257](#orge639d03) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#org58fb3ee) illustrates the width of margin for different values of
...
In figure [261](#org007ade3) consider the data shown in the left panel.  It is clear
...
In figure [263](#org372111c), the left-hand panel shows an example of SVM with a
polynomial kernel applied the non-linear data from figure [261](#org007ade3).  The fit
...
![img](figures/fig9_9.png "Left: An SVM with a polynomial kernel of degree 3 is applied to the non-linear data from figure [261](#org007ade3), resulting in a more appropriate decision rule.  Right: An SVM with a radial kernel is applied.  In this example, radial kernel is the most capable of capturing the decision boundary.")
...
In figure [265](#orgf5fb82a), the left-hand panel displays ROC curves for training set
...
Figure [267](#orgfaf5f17) compares ROC curves on test observations.  Using default
...
[20](#org65cde51) shows loadings of the first two principal components.
Figure [273](#org213dcf8) plots the first two principal components of these
data.  The figure represents both the principal component scores and the loading
vectors in a single *biplot* display.

<table id="org65cde51" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 20:</span> The principal component loading factors, &phi;<sub>1</sub> and &phi;<sub>2</sub>, for the `USArrests` data.  These are also displayed in figure [273](#org213dcf8).</caption>
...
In figure [275](#org5e9e6cb), the left-hand panel is the same as figure
[273](#org213dcf8), where each variable was first scaled to have mean zero and standard
...
![img](figures/fig10_3.png "Two principal component biplots for `USArrests` data.  Left: Same as figure [273](#org213dcf8), with variables scaled to have unit standard deviations.  Right: Principal components using unscaled data.  `Assault` has by far the largest loading on the first principal component because it has the largest variance among the four variables.  In general, it is recommended to scale variables to have standard deviation one.")

In Figure [277](#orgc0684aa), the left-hand panel shows the proportion of
...
Figure [279](#org6847a1d) shows the results obtained from performing *K*-means
...
We begin with the simulated data set shown in figure [285](#org09eb9d7),
...
figure [286](#org5ce845d).  In the center-panel, cutting the dendrogram at a
