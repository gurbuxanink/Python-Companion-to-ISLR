...
1.  [Introduction](#org741df76)
2.  [Statistical Learning](#org4df2a09)
    1.  [What is Statistical Learning?](#org9c947f0)
    2.  [Assessing Model Accuracy](#org47e65e3)
    3.  [Lab: Introduction to Python](#orge0735f4)
        1.  [Basic Commands](#org6519f9c)
        2.  [Graphics](#org134db23)
        3.  [Indexing Data](#org65c8785)
        4.  [Loading Data](#org382b060)
        5.  [Additional Graphical and Numerical Summaries](#orgb8c634e)
3.  [Linear Regression](#org9ddfb83)
    1.  [Simple Linear Regression](#orge5677f1)
    2.  [Multiple Linear Regression](#orge8c0501)
    3.  [Other Considerations in the Regression Model](#orgb665101)
    4.  [The Marketing Plan](#org3a6bd36)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org108a6e6)
    6.  [Lab: Linear Regression](#org0e206f5)
        1.  [Libraries](#orgf314e7b)
        2.  [Simple Linear Regression](#org5347498)
        3.  [Multiple Linear Regression](#org9129401)
        4.  [Interaction Terms](#orga3ca63e)
        5.  [Non-linear Transformations of the Predictors](#org34dde79)
        6.  [Qualitative Predictors](#org1ea21b1)
        7.  [Calling `R` from `Python`](#orga3662ee)
4.  [Classification](#orga6d09c0)
    1.  [An Overview of Classification](#org6345273)
    2.  [Why Not Linear Regression?](#orgc1a1f5d)
    3.  [Logistic Regression](#org044404b)
    4.  [Linear Discriminant Analysis](#org5ee55b9)
    5.  [A Comparison of Classification Methods](#org82ef12a)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org460b589)
        1.  [The Stock Market Data](#orgfc352db)
        2.  [Logistc Regression](#org98d6303)
        3.  [Linear Discriminant Analysis](#org77bff3a)
        4.  [Quadratic Discriminant Analysis](#org1ea7b0b)
        5.  [K-Nearest Neightbors](#orgdf1dcfb)
        6.  [An Application to Caravan Insurance Data](#orgc2f41c3)
5.  [Resampling Methods](#org97a0275)
    1.  [Cross-Validation](#orgc1ec916)
    2.  [The Bootstrap](#orgd3a6ff0)
    3.  [Lab: Cross-Validation and the Bootstrap](#org82c1cff)
        1.  [The Validation Set Approach](#org11c3acc)
        2.  [Leave-One-Out Cross-Validation](#orgf1b1c82)
        3.  [k-Fold Cross-Validation](#org9ddc692)
        4.  [The Bootstrap](#org6d48551)
6.  [Linear Model Selection and Regularization](#org0c1f02a)
    1.  [Subset Selection](#org366e73f)
    2.  [Shrinkage Methods](#org8877e78)
    3.  [Dimension Reduction Methods](#orgeaf567b)
    4.  [Considerations in High Dimensions](#org4adb5f5)
    5.  [Lab 1: Subset Selection Methods](#orgaf5f83c)
        1.  [Best Subset Selection](#org8d358db)
        2.  [Forward and Backward Stepwise Selection](#org894b5d8)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org5b1c4da)
    6.  [Lab 2: Ridge Regression and the Lasso](#orgd5c6c21)
        1.  [Ridge Regression](#org3b1b387)
        2.  [The Lasso](#org33d524e)
    7.  [Lab 3: PCR and PLS Regression](#org6f7ca03)
        1.  [Principal Components Regression](#orgec729cf)
        2.  [Partial Least Squares](#org7a92cc9)
7.  [Moving Beyond Linearity](#org9255f1f)
    1.  [Polynomial Regression](#orgec37b9b)
    2.  [Step Functions](#org41ec517)
    3.  [Basis Functions](#orgac30698)
    4.  [Regression Splines](#org90c0756)
    5.  [Lab: Non-linear Modeling](#org3d24227)
        1.  [Polynomial Regression and Step Functions](#org20bc941)
8.  [Tree-Based Models](#org7d70213)
    1.  [The Basics of Decision Trees](#org607db7b)
        1.  [Regression Trees](#orgff2c712)
...
Figure [2](#org669cc8e) shows graphs of Wage versus three variables. 
...
Figure [4](#orgc65f60f) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org75b08e8) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgb5359fc) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org89ab406) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgb41b037) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org89ab406).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org52771ae) provides an illustration of the trade-off between
...
Figure [17](#orgc19db48) provides a simple illustration of the clustering problem.
...
Figure [21](#orgf0b20f4) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgf0b20f4), we see considerable
...
Figure [23](#org3e13732) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgf0b20f4) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orgde7111c) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgf0b20f4), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orga6577ee) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgf0b20f4) - [25](#orgde7111c).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgb2afa25) provides an example using a simulated data set in
...
Figure [31](#orgfde6b23) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgb2afa25).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgb2afa25), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgb2afa25).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org77f3bae) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orgb2afa25) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org64e4714) displays the simple linear regression fit to the
...
In figure [50](#org930c083), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org34f04ab) displays *population regression
...
right-hand panel of figure [52](#org34f04ab) we have generated five different
...
For `Advertising` data, table [1](#org43a8ed2) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org43a8ed2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org6d9c2d8), we report more information about the least squares model.  

<table id="org6d9c2d8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orga41389c)  shows results of two simple linear
...
<table id="orga41389c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org0a4b530) illustrates an example of the least squares fit to a
...
Table [4](#org7ae7932) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org7ae7932" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org0c3f60d) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org7ae7932). 

<table id="org0c3f60d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org754c7ec" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org7ae7932).</caption>
...
Figure [61](#org6978b5a) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgae8d68b) records `balance`
...
Table [7](#orge9c27ff) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orge9c27ff" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org1c12ef8) we see that the estimated `balance` for the
...
<table id="org1c12ef8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orga321eef) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgfafbd95), the left panel shows least squares lines when
...
<table id="orga321eef" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org68bddb6) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org6694da7) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org6694da7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgbee25d2) displays a residual plot from the
...
of figure[73](#orgbee25d2) displays the residual plot results from the model
...
Figure [75](#org445f326) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgc5dc5fb), the magnitude of the
...
[79](#orgf5eb2b6) illustrates a typical outlier.  The red solid line is the
...
[79](#orgf5eb2b6), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org666092b) has
...
[81](#org666092b) are the same as the data displayed in figure
[79](#orgf5eb2b6), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgf5eb2b6) and
[81](#org666092b), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org666092b), for a data set with two
...
point. The right-panel of figure [81](#org666092b) provides a plot of
...
Figure [83](#org5b52199) illustrates the concept of collinearity.
...
Figure [86](#org685e8c3) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org685e8c3) displays contour
...
Table [11](#org14c647c) compares the coefficient estimates obtained from two
...
<table id="org14c647c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org3d2fd49) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orge5cb1e9) provides an example of KNN regression with data
...
Figure [93](#org5cc9d87) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org5cc9d87)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orge5cb1e9) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgc11db85) examines the relative performances of least squares
...
Figure [97](#orgb3bc4c1) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgc11db85), except that we have added additional *noise*
...
In figure [110](#orgf9266ca), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgcfc4c97) we show probability of default as a function of
...
Table [12](#orgb277cd6) shows the coefficient estimates and related
...
<table id="orgb277cd6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orga7e196c) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org1649279) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orga7e196c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org1649279" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org51f2f0b) shows average default rates
...
[14](#org1649279).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org34f4592), two normal density functions
...
figure [121](#orgb5a1a13).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgb5a1a13).  In this situation, the base
...
Figure [123](#orgb783559) shows an example of three equally sized Gaussian
...
[15](#orge3a699c), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orga267d2a) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orge3a699c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orga267d2a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orga67a282) illustrates the trade-off that results from
...
Figure [128](#org3f5594c) displays the ROC curve for the LDA classifier on
...
Table [17](#org1de76d2) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org1de76d2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org3315d55) lists many of the popular performance measures that
are used in this context.

<table id="org3315d55" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org1de76d2).</caption>
...
Figure [132](#org9203b2d) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgb41d318) illustrates the performances of the four
...
Figure [143](#org11b6d1a) displays the *validation set approach*, a simple
...
In figure [145](#org270f85e), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org609b86a) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orgebd9fe3) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orgebd9fe3) shows nine different 10-fold
...
Figure [151](#org723dff4) illustrates the *k*-fold CV approach.
...
In figure [153](#org35ebe27), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgf0b20f4),
[23](#org3e13732), and [25](#orgde7111c) of chapter [2](#org7061565).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgf0b20f4) (left), [23](#org3e13732) (center), and [25](#orgde7111c) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org29348fc) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgb2afa25).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgac7893d) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgac7893d) displays the same three curves
...
Figure [160](#org6c8e7bc) illustrates the approach for estimating &alpha; by
...
figure [163](#orga9e06fc) displays a histogram of the resulting estimates.  The
...
[163](#orga9e06fc), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org47ec369).
...
Table [19](#org5651205) shows first four selected models for the best subset and
...
<table id="org5651205" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org25a8261) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org25a8261) displays the same ridge
...
[182](#orgdb9a76f) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org68ee009), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org68ee009), as we
...
Figure [186](#orgbc0d4ac) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org8fc4479) displays the choice of &lambda; that results from
...
Figure [190](#org4c8fba3) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org9b95d0c), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org9b95d0c), the left-hand panel has
...
Figure [195](#org9e73cdc) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org1e10401) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org82c83bc) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org4ceed63) further illustrates the risk of carelessly applying
...
Figure [203](#orge53b9ff) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#orga13af36) is a plot of `wage` against
...
The left-hand panel of figure [227](#org671bfb1) shows a fit of step functions
to the `Wage` data from figure [225](#orga13af36).  We also fit the logistic
...
Figure [234](#orgcfa5ca3) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org01e4551) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#orgcfa5ca3).")
