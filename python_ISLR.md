...
1.  [Introduction](#orgbc68815)
2.  [Statistical Learning](#orgf464fd8)
    1.  [What is Statistical Learning?](#orge035e16)
    2.  [Assessing Model Accuracy](#org3f1c854)
    3.  [Lab: Introduction to Python](#orga95b276)
        1.  [Basic Commands](#orge9a6791)
        2.  [Graphics](#orge7f1b9c)
        3.  [Indexing Data](#org2de1cac)
        4.  [Loading Data](#org921bd11)
        5.  [Additional Graphical and Numerical Summaries](#org561c5f8)
3.  [Linear Regression](#org00b692c)
    1.  [Simple Linear Regression](#org68ff986)
    2.  [Multiple Linear Regression](#orgb80490c)
    3.  [Other Considerations in the Regression Model](#org5f2d745)
    4.  [The Marketing Plan](#orgc271926)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org3328404)
    6.  [Lab: Linear Regression](#org9c22bad)
        1.  [Libraries](#orga07d00d)
        2.  [Simple Linear Regression](#orga45af96)
        3.  [Multiple Linear Regression](#orge2a6d90)
        4.  [Interaction Terms](#orgcadabbc)
        5.  [Non-linear Transformations of the Predictors](#org4fd55dd)
        6.  [Qualitative Predictors](#org95cfe3a)
        7.  [Calling `R` from `Python`](#orge2b3ec5)
4.  [Classification](#org3a1be70)
    1.  [An Overview of Classification](#orge60f7cd)
    2.  [Why Not Linear Regression?](#orge9ff0d2)
    3.  [Logistic Regression](#org48f1eba)
    4.  [Linear Discriminant Analysis](#org3fabc2e)
    5.  [A Comparison of Classification Methods](#orgc6badbb)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgec4c76c)
        1.  [The Stock Market Data](#org64553ee)
        2.  [Logistc Regression](#org49d4e8e)
        3.  [Linear Discriminant Analysis](#org22c175a)
        4.  [Quadratic Discriminant Analysis](#org354429b)
        5.  [K-Nearest Neightbors](#org317c261)
        6.  [An Application to Caravan Insurance Data](#org9c8adf1)
5.  [Resampling Methods](#orge86ea3b)
    1.  [Cross-Validation](#orga6e6797)
    2.  [The Bootstrap](#org7066882)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgebe005a)
        1.  [The Validation Set Approach](#org9299b48)
        2.  [Leave-One-Out Cross-Validation](#org7445181)
        3.  [k-Fold Cross-Validation](#org445c876)
        4.  [The Bootstrap](#org0e37842)
6.  [Linear Model Selection and Regularization](#org08f96c5)
    1.  [Subset Selection](#orgef4e64c)
    2.  [Shrinkage Methods](#org347d1f0)
    3.  [Dimension Reduction Methods](#orgfb0594d)
    4.  [Considerations in High Dimensions](#org16b2f36)
    5.  [Lab 1: Subset Selection Methods](#org0c0b633)
        1.  [Best Subset Selection](#org271b00c)
        2.  [Forward and Backward Stepwise Selection](#org6a3f6e8)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org7115824)
    6.  [Lab 2: Ridge Regression and the Lasso](#orgeb21003)
        1.  [Ridge Regression](#orgbfe3eaf)
        2.  [The Lasso](#org9e63618)
    7.  [Lab 3: PCR and PLS Regression](#orgec3d89c)
        1.  [Principal Components Regression](#orgce6a7a7)
        2.  [Partial Least Squares](#org1209537)
7.  [Moving Beyond Linearity](#orgf79ab2e)
    1.  [Polynomial Regression](#org143ba41)
    2.  [Step Functions](#org04ee6e8)
    3.  [Basis Functions](#org1f84f90)
    4.  [Regression Splines](#org8f22cb1)
    5.  [Lab: Non-linear Modeling](#org681cd47)
        1.  [Polynomial Regression and Step Functions](#org1ec0cad)
8.  [Tree-Based Models](#org7eadee3)
    1.  [The Basics of Decision Trees](#orgf052393)
        1.  [Regression Trees](#orgab0fc18)
        2.  [Classification Trees](#org3dedb74)
        3.  [Trees versus Linear Models](#org2c306ac)
    2.  [Bagging, Random Forests, Boosting](#org3be8cf4)
    3.  [Lab: Decision Trees](#org049ab7c)
        1.  [Fitting Classification Trees](#org3c47c47)
        2.  [Fitting Regression Trees](#org030240c)
        3.  [Bagging and Random Forests](#org6963ad4)
        4.  [Boosting](#org1317d04)
9.  [Support Vector Machines](#org1b27b85)
    1.  [Maximal Margin Classifier](#orgd7eb15f)
        1.  [What is a Hyperplane?](#org62fffef)
        2.  [Classification Using a Separating Hyperplane](#org102252c)
        3.  [The Maximal Margin Classifier](#orgc20aea0)
        4.  [Construction of the Maximal Margin Classifier](#org278e147)
        5.  [The Non-separable Case](#orgb0cbb31)
    2.  [Support Vector Classifiers](#orga7b8dc8)
        1.  [Overview of the Support Vector Classifier](#org7b1ddc4)
        2.  [Details of the Support Vector Classifier](#orge1cc527)
    3.  [Support Vector Machines](#org35179e6)
        1.  [Classification with Non-linear Decision Boundaries](#org3e27ac6)
        2.  [The Support Vector Machine](#org09e8cba)
        3.  [An Application to the Heart Disease Data](#org282799d)
...
Figure [2](#org89b3af4) shows graphs of Wage versus three variables. 
...
Figure [4](#orge75d4d3) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org7e3a4bd) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org185e864) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orga393c58) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org2794179) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orga393c58).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org513e5a9) provides an illustration of the trade-off between
...
Figure [17](#org943562a) provides a simple illustration of the clustering problem.
...
Figure [21](#org1dfc55b) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org1dfc55b), we see considerable
...
Figure [23](#org1a75bd2) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org1dfc55b) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orgfe49427) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org1dfc55b), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org0c6e3eb) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org1dfc55b) - [25](#orgfe49427).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgb03bc8f) provides an example using a simulated data set in
...
Figure [31](#org7ea6f6c) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgb03bc8f).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgb03bc8f), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgb03bc8f).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org5fd5e77) we have plotted the KNN test and training errors as
...
Figure [48](#orgb98a411) displays the simple linear regression fit to the
...
In figure [50](#org5555f9a), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org6650ae1) displays *population regression
...
right-hand panel of figure [52](#org6650ae1) we have generated five different
...
For `Advertising` data, table [1](#org2e11033) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org2e11033" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org18f1299), we report more information about the least squares model.  

<table id="org18f1299" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orga508d3f)  shows results of two simple linear
...
<table id="orga508d3f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org680516d) illustrates an example of the least squares fit to a
...
Table [4](#orgc1de590) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgc1de590" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org53c912d) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgc1de590). 

<table id="org53c912d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgf52aeea" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgc1de590).</caption>
...
Figure [61](#org69422c1) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org685b160) records `balance`
...
Table [7](#orgd14af4e) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgd14af4e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org6a47f2b) we see that the estimated `balance` for the
...
<table id="org6a47f2b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org2caabe9) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org7c694e2), the left panel shows least squares lines when
...
<table id="org2caabe9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org92602a9) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgac685c4) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgac685c4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org8007188) displays a residual plot from the
...
of figure[73](#org8007188) displays the residual plot results from the model
...
Figure [75](#orgdcedc5b) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org1fb9909), the magnitude of the
...
[79](#org23e2f16) illustrates a typical outlier.  The red solid line is the
...
[79](#org23e2f16), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org360cc10) has
...
[81](#org360cc10) are the same as the data displayed in figure
[79](#org23e2f16), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org23e2f16) and
[81](#org360cc10), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org360cc10), for a data set with two
...
point. The right-panel of figure [81](#org360cc10) provides a plot of
...
Figure [83](#orgd88788c) illustrates the concept of collinearity.
...
Figure [86](#orga9ff9ef) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orga9ff9ef) displays contour
...
Table [11](#orge67ced7) compares the coefficient estimates obtained from two
...
<table id="orge67ced7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org21ae848) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org9317dcf) provides an example of KNN regression with data
...
Figure [93](#org594bbd7) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org594bbd7)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org9317dcf) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgd003076) examines the relative performances of least squares
...
Figure [97](#org09f3774) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgd003076), except that we have added additional *noise*
...
In figure [110](#orgd6dd806), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org2d7a328) we show probability of default as a function of
...
Table [12](#orgc7b2829) shows the coefficient estimates and related
...
<table id="orgc7b2829" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgadc1fc8) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org6919628) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgadc1fc8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org6919628" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org20dfc78) shows average default rates
...
[14](#org6919628).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org31be6f8), two normal density functions
...
figure [121](#orgbb02188).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgbb02188).  In this situation, the base
...
Figure [123](#org850887a) shows an example of three equally sized Gaussian
...
[15](#org67c029d), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org4d5d994) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org67c029d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org4d5d994" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org1502356) illustrates the trade-off that results from
...
Figure [128](#orgeb92c4c) displays the ROC curve for the LDA classifier on
...
Table [17](#org7599f5a) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org7599f5a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org07d6ffa) lists many of the popular performance measures that
are used in this context.

<table id="org07d6ffa" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org7599f5a).</caption>
...
Figure [132](#org9e67a85) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgc628fdd) illustrates the performances of the four
...
Figure [143](#org7d42b91) displays the *validation set approach*, a simple
...
In figure [145](#org1d15b13), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org591a55d) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org7e6fc1b) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org7e6fc1b) shows nine different 10-fold
...
Figure [151](#org2047708) illustrates the *k*-fold CV approach.
...
In figure [153](#org4352659), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org1dfc55b),
[23](#org1a75bd2), and [25](#orgfe49427) of chapter [2](#orgbe8a0d1).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org1dfc55b) (left), [23](#org1a75bd2) (center), and [25](#orgfe49427) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org0ee5335) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgb03bc8f).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org7fe6fad) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org7fe6fad) displays the same three curves
...
Figure [160](#orgf2192e4) illustrates the approach for estimating &alpha; by
...
figure [163](#org96ad3cb) displays a histogram of the resulting estimates.  The
...
[163](#org96ad3cb), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org33c50de).
...
Table [19](#org7e110e3) shows first four selected models for the best subset and
...
<table id="org7e110e3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org4ba329d) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org4ba329d) displays the same ridge
...
[182](#orgc44063d) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org49dac22), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org49dac22), as we
...
Figure [186](#org9a91cae) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgb1dbbc8) displays the choice of &lambda; that results from
...
Figure [190](#org4744e86) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org734acd6), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org734acd6), the left-hand panel has
...
Figure [195](#orgf366aee) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgb46ba17) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orgac2323a) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgdee149e) further illustrates the risk of carelessly applying
...
Figure [203](#org42b5ed3) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org49139f8) is a plot of `wage` against
...
The left-hand panel of figure [227](#org316f417) shows a fit of step functions
to the `Wage` data from figure [225](#org49139f8).  We also fit the logistic
...
Figure [234](#orgee998dc) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org6146607) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#orgee998dc).")

Figure [238](#org9216d98) shows a five-region example of prediction via
...
Figure [240](#org1ec7ed0) is an example of when a linear model or a tree
...
Figure [242](#org1a459d0) is a graphical representation of *variable
...
Figure [247](#org2244328) shows a hyperplane in two-dimensional space.
...
Figure [249](#orgb18621a) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#orgf5a19ea), we see that three training observations are
...
[251](#orgf5a19ea), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#orgd0cc4f4) shows an example where we cannot *exactly* separate the two
...
In figures [255](#orgb899144), addition of a single observation in the right hand panel
...
Figure [257](#org97bea0f) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#org72207a6) illustrates the width of margin for different values of
...
In figure [261](#org96103b5) consider the data shown in the left panel.  It is clear
...
In figure [263](#org62e0ddc), the left-hand panel displays ROC curves for training set
