...
1.  [Introduction](#org8920985)
2.  [Statistical Learning](#org6110a2b)
    1.  [What is Statistical Learning?](#org71de362)
    2.  [Assessing Model Accuracy](#org105b2ab)
    3.  [Lab: Introduction to Python](#orge6aac6d)
        1.  [Basic Commands](#org9c0fb56)
        2.  [Graphics](#org220417e)
        3.  [Indexing Data](#orgd72754a)
        4.  [Loading Data](#orgad51d2b)
        5.  [Additional Graphical and Numerical Summaries](#orge120925)
3.  [Linear Regression](#orgad2e204)
    1.  [Simple Linear Regression](#org945648d)
    2.  [Multiple Linear Regression](#org5cd1b5f)
    3.  [Other Considerations in the Regression Model](#orgf7aeb8d)
    4.  [The Marketing Plan](#org273daa4)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org918fba1)
    6.  [Lab: Linear Regression](#orgbd6fda5)
        1.  [Libraries](#orgbe20425)
        2.  [Simple Linear Regression](#org58d39eb)
        3.  [Multiple Linear Regression](#org87fa864)
        4.  [Interaction Terms](#org8962877)
        5.  [Non-linear Transformations of the Predictors](#org3da67f3)
        6.  [Qualitative Predictors](#org11c6250)
        7.  [Calling `R` from `Python`](#org3023e1b)
4.  [Classification](#org5e05d5b)
    1.  [An Overview of Classification](#orgcefdcbd)
    2.  [Why Not Linear Regression?](#org03c93ce)
    3.  [Logistic Regression](#org3af07e0)
    4.  [Linear Discriminant Analysis](#org10a9d79)
    5.  [A Comparison of Classification Methods](#orgbdf0c80)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgac7c247)
        1.  [The Stock Market Data](#orgc50b4b7)
        2.  [Logistc Regression](#orgf1b56f0)
        3.  [Linear Discriminant Analysis](#orgf3a442a)
        4.  [Quadratic Discriminant Analysis](#org2178807)
        5.  [K-Nearest Neightbors](#org7e5d317)
        6.  [An Application to Caravan Insurance Data](#orgd5a7a76)
5.  [Resampling Methods](#org3bbb838)
    1.  [Cross-Validation](#orga619f3e)
    2.  [The Bootstrap](#orgcfe055c)
    3.  [Lab: Cross-Validation and the Bootstrap](#org070cad6)
        1.  [The Validation Set Approach](#org658aba9)
        2.  [Leave-One-Out Cross-Validation](#org073d0b5)
        3.  [k-Fold Cross-Validation](#orgbce6267)
        4.  [The Bootstrap](#org486107f)
6.  [Linear Model Selection and Regularization](#orgb269e31)
    1.  [Subset Selection](#orgb0340a2)
    2.  [Shrinkage Methods](#orgf322aed)
    3.  [Dimension Reduction Methods](#orge5dd17b)
...
Figure [2](#org066e400) shows graphs of Wage versus three variables. 
...
Figure [4](#org89772b6) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org7a53683) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org1658ebe) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org47b58df) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgbf8fbe7) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org47b58df).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org0b14ba9) provides an illustration of the trade-off between
...
Figure [17](#org91ad835) provides a simple illustration of the clustering problem.
...
Figure [21](#org84b6709) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org84b6709), we see considerable
...
Figure [23](#org40b19eb) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org84b6709) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org589e0dc) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org84b6709), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgcaa5672) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org84b6709) - [25](#org589e0dc).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org66298f5) provides an example using a simulated data set in
...
Figure [31](#orgfe9d143) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org66298f5).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org66298f5), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org66298f5).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org3301fc7) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org66298f5) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org6202bbf) displays the simple linear regression fit to the
...
In figure [50](#org0348a80), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org7b3e560) displays *population regression
...
right-hand panel of figure [52](#org7b3e560) we have generated five different
...
For `Advertising` data, table [1](#org3fd82ae) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org3fd82ae" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgdaf0be8), we report more information about the least squares model.  

<table id="orgdaf0be8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org47bc1d9)  shows results of two simple linear
...
<table id="org47bc1d9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org93cb35a) illustrates an example of the least squares fit to a
...
Table [4](#org8c63de2) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org8c63de2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org4d2cb13) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org8c63de2). 

<table id="org4d2cb13" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgb786b6e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org8c63de2).</caption>
...
Figure [61](#org02dda29) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org92249db) records `balance`
...
Table [7](#orgd6d1c91) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgd6d1c91" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org9bc96d0) we see that the estimated `balance` for the
...
<table id="org9bc96d0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org3593d7a) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgb2659f1), the left panel shows least squares lines when
...
<table id="org3593d7a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org465a007) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org47d5fc4) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org47d5fc4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgb98ec5f) displays a residual plot from the
...
of figure[73](#orgb98ec5f) displays the residual plot results from the model
...
Figure [75](#orgfeda115) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org3f77408), the magnitude of the
...
[79](#org6453224) illustrates a typical outlier.  The red solid line is the
...
[79](#org6453224), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org662b99b) has
...
[81](#org662b99b) are the same as the data displayed in figure
[79](#org6453224), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org6453224) and
[81](#org662b99b), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org662b99b), for a data set with two
...
point. The right-panel of figure [81](#org662b99b) provides a plot of
...
Figure [83](#org7f344e0) illustrates the concept of collinearity.
...
Figure [86](#orgafed486) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgafed486) displays contour
...
Table [11](#orga26ce43) compares the coefficient estimates obtained from two
...
<table id="orga26ce43" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org7d758d2) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orgb202765) provides an example of KNN regression with data
...
Figure [93](#org53b2785) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org53b2785)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orgb202765) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org651bd7e) examines the relative performances of least squares
...
Figure [97](#org053373a) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org651bd7e), except that we have added additional *noise*
...
In figure [110](#orgf90e7a5), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org6324068) we show probability of default as a function of
...
Table [12](#org92eeb8c) shows the coefficient estimates and related
...
<table id="org92eeb8c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org8440ef6) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org759c256) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org8440ef6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org759c256" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org672b8c2) shows average default rates
...
[14](#org759c256).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgdbd02c8), two normal density functions
...
figure [121](#org5fe0666).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org5fe0666).  In this situation, the base
...
Figure [123](#org5669225) shows an example of three equally sized Gaussian
...
[15](#org50437b7), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgdf41843) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org50437b7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgdf41843" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgc3006e4) illustrates the trade-off that results from
...
Figure [128](#orga209e94) displays the ROC curve for the LDA classifier on
...
Table [17](#orgf81079f) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orgf81079f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orge572f3f) lists many of the popular performance measures that
are used in this context.

<table id="orge572f3f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orgf81079f).</caption>
...
Figure [132](#orge67cf39) illustrates the performances of LDA and QDA in two
...
Figure [134](#org60d759c) illustrates the performances of the four
...
Figure [143](#orgba05950) displays the *validation set approach*, a simple
...
In figure [145](#orgb94f62c), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org605bccf) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orga4340b4) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orga4340b4) shows nine different 10-fold
...
Figure [151](#org8c0d4a5) illustrates the *k*-fold CV approach.
...
In figure [153](#orgaa4ca28), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org84b6709),
[23](#org40b19eb), and [25](#org589e0dc) of chapter [2](#orgd21766f).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org84b6709) (left), [23](#org40b19eb) (center), and [25](#org589e0dc) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org012c03b) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org66298f5).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org6f1adce) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org6f1adce) displays the same three curves
...
Figure [160](#org93c26bc) illustrates the approach for estimating &alpha; by
...
figure [163](#org0795f2f) displays a histogram of the resulting estimates.  The
...
[163](#org0795f2f), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orgd5f3150).
...
Table [19](#org2b34073) shows first four selected models for the best subset and
...
<table id="org2b34073" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#orgbe88a72) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#orgbe88a72) displays the same ridge
...
[182](#org88831ca) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org0d83a0d), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org0d83a0d), as we
...
Figure [186](#orgbfdf90d) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org6492d7c) displays the choice of &lambda; that results from
...
Figure [190](#org7f0bff5) shows daily changes in 10-year Treasury note yield (`10
