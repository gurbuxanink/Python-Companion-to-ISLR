...
1.  [Introduction](#org5799edd)
2.  [Statistical Learning](#org4ebf71b)
    1.  [What is Statistical Learning?](#orgb5c1d54)
    2.  [Assessing Model Accuracy](#org588080b)
    3.  [Lab: Introduction to Python](#orgc058f11)
        1.  [Basic Commands](#orgc17860a)
        2.  [Graphics](#org4c22fec)
        3.  [Indexing Data](#org07b94c3)
        4.  [Loading Data](#orga0bac71)
        5.  [Additional Graphical and Numerical Summaries](#org53d6b1c)
3.  [Linear Regression](#orgdb629d2)
    1.  [Simple Linear Regression](#org0de0b3e)
    2.  [Multiple Linear Regression](#orgcec2176)
    3.  [Other Considerations in the Regression Model](#org6d7a0fd)
    4.  [The Marketing Plan](#org92846d2)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orga791bd4)
    6.  [Lab: Linear Regression](#org42f6559)
        1.  [Libraries](#orgc50be05)
        2.  [Simple Linear Regression](#org9822a8c)
        3.  [Multiple Linear Regression](#org2bb4cc2)
        4.  [Interaction Terms](#org018f92c)
        5.  [Non-linear Transformations of the Predictors](#org4056ed8)
        6.  [Qualitative Predictors](#org0e72dd8)
        7.  [Calling `R` from `Python`](#org5994263)
4.  [Classification](#org43f7cad)
    1.  [An Overview of Classification](#orgb5071ea)
    2.  [Why Not Linear Regression?](#orgc9dd7fe)
    3.  [Logistic Regression](#org5175dc5)
    4.  [Linear Discriminant Analysis](#org2b4dad1)
    5.  [A Comparison of Classification Methods](#orgab06031)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgdc8949c)
        1.  [The Stock Market Data](#org7b5cda3)
        2.  [Logistc Regression](#org3cb0632)
        3.  [Linear Discriminant Analysis](#org4066010)
        4.  [Quadratic Discriminant Analysis](#org997275b)
        5.  [K-Nearest Neightbors](#org6841051)
        6.  [An Application to Caravan Insurance Data](#org5afc3fb)
5.  [Resampling Methods](#orga18d992)
    1.  [Cross-Validation](#org9c61d5c)
    2.  [The Bootstrap](#org578ce37)
    3.  [Lab: Cross-Validation and the Bootstrap](#org18005ff)
        1.  [The Validation Set Approach](#org6d735ba)
        2.  [Leave-One-Out Cross-Validation](#org32e452a)
        3.  [k-Fold Cross-Validation](#org920bb6c)
        4.  [The Bootstrap](#org5a918e6)
6.  [Linear Model Selection and Regularization](#org8ac99bf)
    1.  [Subset Selection](#orgf4d55d8)
    2.  [Shrinkage Methods](#org2421e9b)
    3.  [Dimension Reduction Methods](#org09dd169)
    4.  [Considerations in High Dimensions](#orgfa2c315)
    5.  [Lab 1: Subset Selection Methods](#org770cbf8)
        1.  [Best Subset Selection](#org6c0bd20)
        2.  [Forward and Backward Stepwise Selection](#org09b2e2b)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org5a320ab)
    6.  [Lab 2: Ridge Regression and the Lasso](#orga437776)
        1.  [Ridge Regression](#org3397e0f)
        2.  [The Lasso](#org632c2e2)
    7.  [Lab 3: PCR and PLS Regression](#orge3dc8c5)
        1.  [Principal Components Regression](#org274fed7)
        2.  [Partial Least Squares](#org37d6497)
7.  [Moving Beyond Linearity](#org2f6a63e)
    1.  [Polynomial Regression](#org4323144)
    2.  [Step Functions](#orgc651a96)
    3.  [Basis Functions](#org05ad21e)
    4.  [Regression Splines](#org1fc83de)
    5.  [Lab: Non-linear Modeling](#org19fef03)
        1.  [Polynomial Regression and Step Functions](#org2b419bb)
8.  [Tree-Based Models](#org7245270)
    1.  [The Basics of Decision Trees](#orgfd70c0b)
        1.  [Regression Trees](#orgb6e9f22)
        2.  [Classification Trees](#org3fa8c15)
        3.  [Trees versus Linear Models](#org6c14996)
    2.  [Bagging, Random Forests, Boosting](#org7cdf04b)
    3.  [Lab: Decision Trees](#orgf8897ef)
        1.  [Fitting Classification Trees](#orgfda8edb)
        2.  [Fitting Regression Trees](#orge80c71a)
        3.  [Bagging and Random Forests](#org7e003d3)
        4.  [Boosting](#orgd83dd6f)
9.  [Support Vector Machines](#orgf9b8b44)
    1.  [Maximal Margin Classifier](#orgbd6d36b)
        1.  [What is a Hyperplane?](#orge71e393)
        2.  [Classification Using a Separating Hyperplane](#orgd26cb60)
        3.  [The Maximal Margin Classifier](#org83df376)
        4.  [Construction of the Maximal Margin Classifier](#orgacd4ed1)
        5.  [The Non-separable Case](#org7323390)
    2.  [Support Vector Classifiers](#orgdb33771)
        1.  [Overview of the Support Vector Classifier](#org5efe122)
        2.  [Details of the Support Vector Classifier](#org993d475)
    3.  [Support Vector Machines](#org4328a0c)
        1.  [Classification with Non-linear Decision Boundaries](#org833740d)
        2.  [The Support Vector Machine](#org7064c35)
        3.  [An Application to the Heart Disease Data](#org591da74)
    4.  [SVMs with More than Two Classes](#orga7ba658)
        1.  [One-Versus-One Classification](#org6f96eee)
        2.  [One-Versus-All Classification](#org5facd74)
    5.  [Relationship with Logistic Regression](#org5eec916)
    6.  [Lab: Support Vector Machines](#org8e912c9)
        1.  [Support Vector Classifier](#org7759ca1)
        2.  [Support Vector Machine](#org70f7218)
        3.  [ROC Curves](#orgf1c3c0c)
        4.  [SVM with Multiple Classes](#orga4f8ccb)
...
Figure [2](#org1719816) shows graphs of Wage versus three variables. 
...
Figure [4](#org01a0350) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgc594910) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org127f7ee) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orgc00f632) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org68d134d) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orgc00f632).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org491bf24) provides an illustration of the trade-off between
...
Figure [17](#orge704e01) provides a simple illustration of the clustering problem.
...
Figure [21](#orgf05409c) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgf05409c), we see considerable
...
Figure [23](#org9f454b0) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgf05409c) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org62b5c5f) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgf05409c), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orge40959e) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgf05409c) - [25](#org62b5c5f).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgaa0bad8) provides an example using a simulated data set in
...
Figure [31](#org4a1286a) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgaa0bad8).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgaa0bad8), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgaa0bad8).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgc7018fc) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orgaa0bad8) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgf28f666) displays the simple linear regression fit to the
...
In figure [50](#org47e6c04), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orge658e18) displays *population regression
...
right-hand panel of figure [52](#orge658e18) we have generated five different
...
For `Advertising` data, table [1](#orgf926064) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgf926064" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgc72055c), we report more information about the least squares model.  

<table id="orgc72055c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org06b1044)  shows results of two simple linear
...
<table id="org06b1044" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org8496b55) illustrates an example of the least squares fit to a
...
Table [4](#orgdb43437) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgdb43437" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org0d6ebbe) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgdb43437). 

<table id="org0d6ebbe" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org355c0b2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgdb43437).</caption>
...
Figure [61](#orgb10982f) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org0d4f7d7) records `balance`
...
Table [7](#org7791c23) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org7791c23" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org48518ec) we see that the estimated `balance` for the
...
<table id="org48518ec" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org1f482be) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org026bdde), the left panel shows least squares lines when
...
<table id="org1f482be" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org203949f) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org6a607e7) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org6a607e7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orged8bbc3) displays a residual plot from the
...
of figure[73](#orged8bbc3) displays the residual plot results from the model
...
Figure [75](#orge46e52c) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org05e0492), the magnitude of the
...
[79](#orgd7fd645) illustrates a typical outlier.  The red solid line is the
...
[79](#orgd7fd645), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org7c3b4d4) has
...
[81](#org7c3b4d4) are the same as the data displayed in figure
[79](#orgd7fd645), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgd7fd645) and
[81](#org7c3b4d4), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org7c3b4d4), for a data set with two
...
point. The right-panel of figure [81](#org7c3b4d4) provides a plot of
...
Figure [83](#org5f85aff) illustrates the concept of collinearity.
...
Figure [86](#orgaae10fd) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgaae10fd) displays contour
...
Table [11](#org6e3b027) compares the coefficient estimates obtained from two
...
<table id="org6e3b027" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org3a217b5) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org80e8a1b) provides an example of KNN regression with data
...
Figure [93](#orgef05ab5) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgef05ab5)
...
Figure [97](#orgdde46fe) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgfda9b47), except that we have added additional *noise*
...
In figure [110](#orgfab0636), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgb49f659) we show probability of default as a function of
...
Table [12](#orgcbeb8f3) shows the coefficient estimates and related
...
<table id="orgcbeb8f3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgca824ea) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org7878b20) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgca824ea" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org7878b20" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org60a0640) shows average default rates
...
[14](#org7878b20).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org5f909fd), two normal density functions
...
figure [121](#orgca70e9b).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgca70e9b).  In this situation, the base
...
Figure [123](#org0b50c82) shows an example of three equally sized Gaussian
...
[15](#orgb45f4cf), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org70e1adf) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgb45f4cf" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org70e1adf" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgfdf3704) illustrates the trade-off that results from
...
Figure [128](#orgc2d5e7a) displays the ROC curve for the LDA classifier on
...
Table [17](#org10c69bb) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org10c69bb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org4919173) lists many of the popular performance measures that
are used in this context.

<table id="org4919173" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org10c69bb).</caption>
...
Figure [132](#org88ded4f) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgd566bce) illustrates the performances of the four
...
Figure [143](#org6728770) displays the *validation set approach*, a simple
...
In figure [145](#org99f73ae), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org1600837) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org78d7bf8) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org78d7bf8) shows nine different 10-fold
...
Figure [151](#orgd925907) illustrates the *k*-fold CV approach.
...
In figure [153](#org5ad565b), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgf05409c),
[23](#org9f454b0), and [25](#org62b5c5f) of chapter [2](#orgc46746e).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgf05409c) (left), [23](#org9f454b0) (center), and [25](#org62b5c5f) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orgf0f8abc) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgaa0bad8).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgd860349) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgd860349) displays the same three curves
...
Figure [160](#org522f78f) illustrates the approach for estimating &alpha; by
...
figure [163](#orgedf33cd) displays a histogram of the resulting estimates.  The
...
[163](#orgedf33cd), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org94c08b0).
...
Table [19](#org8c4a8dd) shows first four selected models for the best subset and
...
<table id="org8c4a8dd" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org511a806) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org511a806) displays the same ridge
...
[182](#org657f8ea) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org76d4f20), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org76d4f20), as we
...
Figure [186](#orgbc03ef9) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgf088f53) displays the choice of &lambda; that results from
...
Figure [190](#orgbb2c1a8) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org366d04e), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org366d04e), the left-hand panel has
...
Figure [195](#org6305f54) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orga3e63f9) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org98c9f21) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orga05fb6f) further illustrates the risk of carelessly applying
...
Figure [203](#org1a1d6cd) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org154bd53) is a plot of `wage` against
...
The left-hand panel of figure [227](#orge4faafc) shows a fit of step functions
to the `Wage` data from figure [225](#org154bd53).  We also fit the logistic
...
Figure [234](#orga0d1574) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org5d58c90) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#orga0d1574).")

Figure [238](#org1dbe279) shows a five-region example of prediction via
...
Figure [240](#org0a94e53) is an example of when a linear model or a tree
...
Figure [242](#orgc1d2914) is a graphical representation of *variable
...
Figure [247](#org99da100) shows a hyperplane in two-dimensional space.
...
Figure [249](#org6e4724d) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#orga01ffae), we see that three training observations are
...
[251](#orga01ffae), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#orgad3231e) shows an example where we cannot *exactly* separate the two
...
In figures [255](#org3651dd3), addition of a single observation in the right hand panel
...
Figure [257](#orge0545e6) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#orgc7af575) illustrates the width of margin for different values of
...
In figure [261](#orgae4a783) consider the data shown in the left panel.  It is clear
...
In figure [263](#org9313f75), the left-hand panel shows an example of SVM with a
polynomial kernel applied the non-linear data from figure [261](#orgae4a783).  The fit
...
![img](figures/fig9_9.png "Left: An SVM with a polynomial kernel of degree 3 is applied to the non-linear data from figure [261](#orgae4a783), resulting in a more appropriate decision rule.  Right: An SVM with a radial kernel is applied.  In this example, radial kernel is the most capable of capturing the decision boundary.")
...
In figure [265](#orgf4e04a4), the left-hand panel displays ROC curves for training set
...
Figure [267](#org753353c) compares ROC curves on test observations.  Using default
