...
1.  [Introduction](#org0b3fe18)
2.  [Statistical Learning](#org221c8c5)
...
Figure [2](#orgd168d61) shows graphs of Wage versus three variables. 
...
Figure [4](#org742f5d1) shows boxplots of previous days' percentage changes in S&P
...
Figure [6](#org2d52310) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [8](#org9fbf494) is a plot of `Income` versus `Years of Education` from the
...
Figure [10](#orga8d1ca1) is a plot of `Income` versus `Years of Education` and
...
Figure [12](#org842c5c2) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [10](#orga8d1ca1).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [14](#orgcb87767) provides an illustration of the trade-off between
