...
1.  [Introduction](#orga8a75f3)
2.  [Statistical Learning](#org103c33d)
    1.  [What is Statistical Learning?](#orga4d57e5)
    2.  [Assessing Model Accuracy](#org1680c8a)
    3.  [Lab: Introduction to Python](#orgd42ec87)
        1.  [Basic Commands](#org5da4210)
        2.  [Graphics](#org341baa7)
        3.  [Indexing Data](#orgb8e906f)
        4.  [Loading Data](#org7eca150)
        5.  [Additional Graphical and Numerical Summaries](#orgf2cad6a)
3.  [Linear Regression](#org46a684a)
    1.  [Simple Linear Regression](#org09886da)
    2.  [Multiple Linear Regression](#org35e668c)
    3.  [Other Considerations in the Regression Model](#org931a8f7)
    4.  [The Marketing Plan](#org5179a90)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orge06da8a)
    6.  [Lab: Linear Regression](#org7fa28da)
        1.  [Libraries](#org74315c9)
        2.  [Simple Linear Regression](#org5b8f8b4)
        3.  [Multiple Linear Regression](#org7556d01)
        4.  [Interaction Terms](#orgd80b5f8)
        5.  [Non-linear Transformations of the Predictors](#org5d1274e)
        6.  [Qualitative Predictors](#orgb202f4f)
        7.  [Calling `R` from `Python`](#org12f0288)
4.  [Classification](#org999b2e4)
    1.  [An Overview of Classification](#orgadc8205)
    2.  [Why Not Linear Regression?](#org48c863c)
    3.  [Logistic Regression](#orge40b67b)
    4.  [Linear Discriminant Analysis](#org631ef2f)
    5.  [A Comparison of Classification Methods](#orgff839f3)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org52498f9)
        1.  [The Stock Market Data](#orgb7828db)
        2.  [Logistc Regression](#org0e0680e)
        3.  [Linear Discriminant Analysis](#org4ad2795)
        4.  [Quadratic Discriminant Analysis](#orgd7ae7d0)
        5.  [K-Nearest Neightbors](#org985beeb)
        6.  [An Application to Caravan Insurance Data](#org229ff6a)
5.  [Resampling Methods](#orgd8c06fa)
    1.  [Cross-Validation](#org45e6959)
    2.  [The Bootstrap](#orgeead023)
    3.  [Lab: Cross-Validation and the Bootstrap](#org36a1c18)
        1.  [The Validation Set Approach](#org702be1a)
        2.  [Leave-One-Out Cross-Validation](#orgc39a5d2)
        3.  [k-Fold Cross-Validation](#org4a44432)
        4.  [The Bootstrap](#org85b0d9d)
6.  [Linear Model Selection and Regularization](#org4fadd60)
    1.  [Subset Selection](#org75523db)
    2.  [Shrinkage Methods](#orgf129ea7)
    3.  [Dimension Reduction Methods](#org504caab)
...
Figure [2](#orgfe337c6) shows graphs of Wage versus three variables. 
...
Figure [4](#orgd6b9983) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgd82d464) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org28c7a98) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org94d8912) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orge20fed2) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org94d8912).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orgc39da79) provides an illustration of the trade-off between
...
Figure [17](#orge5176af) provides a simple illustration of the clustering problem.
...
Figure [21](#orga8413fc) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orga8413fc), we see considerable
...
Figure [23](#orgd42261c) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orga8413fc) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org33be67a) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orga8413fc), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org933d0e1) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orga8413fc) - [25](#org33be67a).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org509c895) provides an example using a simulated data set in
...
Figure [31](#org1025aa4) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org509c895).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org509c895), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org509c895).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org4f31c39) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org509c895) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org173e14d) displays the simple linear regression fit to the
...
In figure [50](#org59b21d7), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org7eb334d) displays *population regression
...
right-hand panel of figure [52](#org7eb334d) we have generated five different
...
For `Advertising` data, table [1](#orga547190) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orga547190" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org587513f), we report more information about the least squares model.  

<table id="org587513f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgb2c1609)  shows results of two simple linear
...
<table id="orgb2c1609" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#orgc01e868) illustrates an example of the least squares fit to a
...
Table [4](#org26afd1e) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org26afd1e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org21b63b0) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org26afd1e). 

<table id="org21b63b0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org0e066d0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org26afd1e).</caption>
...
Figure [61](#org5ae3353) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org1b32a07) records `balance`
...
Table [7](#org703982a) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org703982a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orge17ae56) we see that the estimated `balance` for the
...
<table id="orge17ae56" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orgf178f8a) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org720c981), the left panel shows least squares lines when
...
<table id="orgf178f8a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgca2d126) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orga737a9c) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orga737a9c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgdbe1f75) displays a residual plot from the
...
of figure[73](#orgdbe1f75) displays the residual plot results from the model
...
Figure [75](#org5fee531) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgbbf060b), the magnitude of the
...
[79](#org0f25b8f) illustrates a typical outlier.  The red solid line is the
...
[79](#org0f25b8f), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgb2a5296) has
...
[81](#orgb2a5296) are the same as the data displayed in figure
[79](#org0f25b8f), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org0f25b8f) and
[81](#orgb2a5296), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgb2a5296), for a data set with two
...
point. The right-panel of figure [81](#orgb2a5296) provides a plot of
...
Figure [83](#orgd7fd2b0) illustrates the concept of collinearity.
...
Figure [86](#org941bb14) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org941bb14) displays contour
...
Table [11](#orgdfb884c) compares the coefficient estimates obtained from two
...
<table id="orgdfb884c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org977af60) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org6624802) provides an example of KNN regression with data
...
Figure [93](#orgfc3cfc4) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgfc3cfc4)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org6624802) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org7cba2b9) examines the relative performances of least squares
...
Figure [97](#org2715993) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org7cba2b9), except that we have added additional *noise*
...
In figure [110](#orgc40a74c), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org57c9548) we show probability of default as a function of
...
Table [12](#org7f9a0a1) shows the coefficient estimates and related
...
<table id="org7f9a0a1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org257b88c) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgdcd31b9) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org257b88c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgdcd31b9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orge0f3385) shows average default rates
...
[14](#orgdcd31b9).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org54e14d4), two normal density functions
...
figure [121](#orgacfb417).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgacfb417).  In this situation, the base
...
Figure [123](#orgcb9fe29) shows an example of three equally sized Gaussian
...
[15](#org038da74), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orge7449a5) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org038da74" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orge7449a5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgfacfbc4) illustrates the trade-off that results from
...
Figure [128](#orga602db1) displays the ROC curve for the LDA classifier on
...
Table [17](#orgfd20389) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orgfd20389" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgb1fd4de) lists many of the popular performance measures that
are used in this context.

<table id="orgb1fd4de" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orgfd20389).</caption>
...
Figure [132](#orgc9da1fe) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgc82e7b0) illustrates the performances of the four
...
Figure [143](#org37d7c6a) displays the *validation set approach*, a simple
...
In figure [145](#org6f5e6b4), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org07ce51e) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orga3bab8f) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orga3bab8f) shows nine different 10-fold
...
Figure [151](#org4a689f9) illustrates the *k*-fold CV approach.
...
In figure [153](#orgbbf9efb), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orga8413fc),
[23](#orgd42261c), and [25](#org33be67a) of chapter [2](#orgbe41150).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orga8413fc) (left), [23](#orgd42261c) (center), and [25](#org33be67a) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orgc0f6e79) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org509c895).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgf105a31) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgf105a31) displays the same three curves
...
Figure [160](#org488c9b7) illustrates the approach for estimating &alpha; by
...
figure [163](#org70af270) displays a histogram of the resulting estimates.  The
...
[163](#org70af270), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org40e09c3).
...
Table [19](#org0c847de) shows first four selected models for the best subset and
...
<table id="org0c847de" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org8893d6d) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org8893d6d) displays the same ridge
...
[182](#orgb44ba4e) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org5e4d413), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org5e4d413), as we
...
Figure [186](#org4872887) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org9d3484f) displays the choice of &lambda; that results from
...
Figure [190](#orgee6fb06) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org8adf78f), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org8adf78f), the left-hand panel has
...
Figure [195](#org29423d9) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org53c86f0) displays `10 YR` and `2 YR` versus second principal
