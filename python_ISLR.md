...
1.  [Introduction](#orge56042a)
2.  [Statistical Learning](#orgced82cc)
    1.  [What is Statistical Learning?](#org4da8802)
    2.  [Assessing Model Accuracy](#org92fb908)
    3.  [Lab: Introduction to Python](#org5385ea3)
        1.  [Basic Commands](#org5a6af60)
        2.  [Graphics](#org0088535)
        3.  [Indexing Data](#org41ac42c)
        4.  [Loading Data](#orgda5cdb5)
        5.  [Additional Graphical and Numerical Summaries](#org73b07bc)
3.  [Linear Regression](#org5c8b143)
    1.  [Simple Linear Regression](#org3adcc8d)
    2.  [Multiple Linear Regression](#orgdff595f)
    3.  [Other Considerations in the Regression Model](#orgdb2b9ba)
    4.  [The Marketing Plan](#org6966de8)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org57a7747)
    6.  [Lab: Linear Regression](#org60517c2)
        1.  [Libraries](#orgec85ef5)
        2.  [Simple Linear Regression](#org468cdfd)
        3.  [Multiple Linear Regression](#org84eee72)
        4.  [Interaction Terms](#org752b9e0)
        5.  [Non-linear Transformations of the Predictors](#org1efbd5f)
        6.  [Qualitative Predictors](#org2fe6a01)
        7.  [Calling `R` from `Python`](#org33c348b)
4.  [Classification](#org733e5bb)
    1.  [An Overview of Classification](#org6716f87)
    2.  [Why Not Linear Regression?](#org6fafbda)
    3.  [Logistic Regression](#org239b381)
    4.  [Linear Discriminant Analysis](#orga85ba0f)
    5.  [A Comparison of Classification Methods](#org4614897)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org0a67940)
        1.  [The Stock Market Data](#org3473cdf)
        2.  [Logistc Regression](#orgda30d66)
        3.  [Linear Discriminant Analysis](#org90f5969)
        4.  [Quadratic Discriminant Analysis](#orge26ee3c)
        5.  [K-Nearest Neightbors](#org309677b)
        6.  [An Application to Caravan Insurance Data](#org51a58e4)
5.  [Resampling Methods](#org0fceabf)
    1.  [Cross-Validation](#org78ec1f8)
    2.  [The Bootstrap](#orgad03c8f)
    3.  [Lab: Cross-Validation and the Bootstrap](#org3d6bfd3)
        1.  [The Validation Set Approach](#org3a1bd10)
        2.  [Leave-One-Out Cross-Validation](#orgcf26b48)
        3.  [k-Fold Cross-Validation](#org415b4fb)
        4.  [The Bootstrap](#orgd7717cc)
6.  [Linear Model Selection and Regularization](#orge643c43)
    1.  [Subset Selection](#orgb085f2e)
    2.  [Shrinkage Methods](#orgff3a2f7)
    3.  [Dimension Reduction Methods](#org21b1f2e)
    4.  [Considerations in High Dimensions](#orgf7bd4ae)
    5.  [Lab 1: Subset Selection Methods](#org5887cee)
        1.  [Best Subset Selection](#orga095251)
        2.  [Forward and Backward Stepwise Selection](#org69fe800)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#orgb644979)
    6.  [Lab 2: Ridge Regression and the Lasso](#org2c0042f)
        1.  [Ridge Regression](#org52ccded)
        2.  [The Lasso](#orgb69bd1b)
    7.  [Lab 3: PCR and PLS Regression](#orge3f2a31)
        1.  [Principal Components Regression](#orgf400cf6)
        2.  [Partial Least Squares](#orgfa8b105)
7.  [Moving Beyond Linearity](#org1f6a38f)
    1.  [Polynomial Regression](#orgf3ec5e0)
    2.  [Step Functions](#org6a258f2)
    3.  [Basis Functions](#org037c659)
    4.  [Regression Splines](#org05fc2cb)
    5.  [Lab: Non-linear Modeling](#org21eb285)
        1.  [Polynomial Regression and Step Functions](#org4045da6)
8.  [Tree-Based Models](#orgc509efe)
    1.  [The Basics of Decision Trees](#org4ee6f1e)
        1.  [Regression Trees](#org3258ecb)
        2.  [Classification Trees](#orgc13e20d)
        3.  [Trees versus Linear Models](#orgde2470c)
    2.  [Bagging, Random Forests, Boosting](#org664e418)
    3.  [Lab: Decision Trees](#org722a157)
        1.  [Fitting Classification Trees](#org24a565d)
        2.  [Fitting Regression Trees](#org1e7fa3a)
        3.  [Bagging and Random Forests](#orgfc0c099)
        4.  [Boosting](#org937abf2)
9.  [Support Vector Machines](#org7f1d580)
    1.  [Maximal Margin Classifier](#org35d9e02)
        1.  [What is a Hyperplane?](#orgd8ff0f2)
        2.  [Classification Using a Separating Hyperplane](#org1945511)
        3.  [The Maximal Margin Classifier](#org24b2be5)
        4.  [Construction of the Maximal Margin Classifier](#orgaca2459)
        5.  [The Non-separable Case](#org907e9fc)
    2.  [Support Vector Classifiers](#org6c82530)
        1.  [Overview of the Support Vector Classifier](#org4b432dd)
        2.  [Details of the Support Vector Classifier](#org6a7da1e)
    3.  [Support Vector Machines](#org73c28d4)
        1.  [Classification with Non-linear Decision Boundaries](#org1131feb)
        2.  [The Support Vector Machine](#orgce4256d)
        3.  [An Application to the Heart Disease Data](#orgc900de0)
    4.  [SVMs with More than Two Classes](#org3029667)
        1.  [One-Versus-One Classification](#orgb9c3865)
        2.  [One-Versus-All Classification](#org3eb7165)
    5.  [Relationship with Logistic Regression](#orgc389df4)
...
Figure [2](#orgde42c16) shows graphs of Wage versus three variables. 
...
Figure [4](#orgee61f4b) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org6ccbbb4) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgc6ee27d) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org2cc151a) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgf40c1e0) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org2cc151a).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orgec6e22c) provides an illustration of the trade-off between
...
Figure [17](#org6849cc1) provides a simple illustration of the clustering problem.
...
Figure [21](#org937ac94) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org937ac94), we see considerable
...
Figure [23](#org88a3e1d) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org937ac94) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org7a77a28) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org937ac94), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org8e9a5a3) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org937ac94) - [25](#org7a77a28).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org64fb637) provides an example using a simulated data set in
...
Figure [31](#org8476975) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org64fb637).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org64fb637), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org64fb637).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgbaaac3e) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org64fb637) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org900b364) displays the simple linear regression fit to the
...
In figure [50](#orga72db8e), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org78ef2be) displays *population regression
...
right-hand panel of figure [52](#org78ef2be) we have generated five different
...
For `Advertising` data, table [1](#org08c4e1c) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org08c4e1c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgbc4a197), we report more information about the least squares model.  

<table id="orgbc4a197" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org6a57904)  shows results of two simple linear
...
<table id="org6a57904" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org508dad1) illustrates an example of the least squares fit to a
...
Table [4](#org174729f) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org174729f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgd87a19a) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org174729f). 

<table id="orgd87a19a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org4ee666d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org174729f).</caption>
...
Figure [61](#org1eacb88) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org45a1dab) records `balance`
...
Table [7](#orgc775ea7) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgc775ea7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org9591414) we see that the estimated `balance` for the
...
<table id="org9591414" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orgdb6ae99) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgdfc1af3), the left panel shows least squares lines when
...
<table id="orgdb6ae99" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgeb355e0) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org0d63c3f) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org0d63c3f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org0a064f6) displays a residual plot from the
...
of figure[73](#org0a064f6) displays the residual plot results from the model
...
Figure [75](#orgce9a292) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org76d091b), the magnitude of the
...
[79](#org405389d) illustrates a typical outlier.  The red solid line is the
...
[79](#org405389d), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgd3e92d3) has
...
[81](#orgd3e92d3) are the same as the data displayed in figure
[79](#org405389d), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org405389d) and
[81](#orgd3e92d3), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgd3e92d3), for a data set with two
...
point. The right-panel of figure [81](#orgd3e92d3) provides a plot of
...
Figure [83](#orgaba2913) illustrates the concept of collinearity.
...
Figure [86](#org5055df5) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org5055df5) displays contour
...
Table [11](#org9467874) compares the coefficient estimates obtained from two
...
<table id="org9467874" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#orgec0bd9e) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orgbd342ac) provides an example of KNN regression with data
...
Figure [93](#org3d779f1) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org3d779f1)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orgbd342ac) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org3a2c713) examines the relative performances of least squares
...
Figure [97](#org38d7a94) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org3a2c713), except that we have added additional *noise*
...
In figure [110](#orgbde0709), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org858be71) we show probability of default as a function of
...
Table [12](#orgd69dd85) shows the coefficient estimates and related
...
<table id="orgd69dd85" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org8c56c12) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgad6a252) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org8c56c12" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgad6a252" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org7746b95) shows average default rates
...
[14](#orgad6a252).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgfa1d1a9), two normal density functions
...
figure [121](#orgad4eb4e).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgad4eb4e).  In this situation, the base
...
Figure [123](#org5b49dd0) shows an example of three equally sized Gaussian
...
[15](#org20ffc9a), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgfbb39b6) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org20ffc9a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgfbb39b6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orge7d2cc4) illustrates the trade-off that results from
...
Figure [128](#org7aa192d) displays the ROC curve for the LDA classifier on
...
Table [17](#org3995aa1) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org3995aa1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org22039fa) lists many of the popular performance measures that
are used in this context.

<table id="org22039fa" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org3995aa1).</caption>
...
Figure [132](#org89fc2b1) illustrates the performances of LDA and QDA in two
...
Figure [134](#org2be3bdd) illustrates the performances of the four
...
Figure [143](#orgba4fcce) displays the *validation set approach*, a simple
...
In figure [145](#orgdba6640), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org19ce7f5) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org0fd33e5) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org0fd33e5) shows nine different 10-fold
...
Figure [151](#org19321c4) illustrates the *k*-fold CV approach.
...
In figure [153](#orgb083a15), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org937ac94),
[23](#org88a3e1d), and [25](#org7a77a28) of chapter [2](#org217e5b0).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org937ac94) (left), [23](#org88a3e1d) (center), and [25](#org7a77a28) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org6913bf7) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org64fb637).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org6b35f21) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org6b35f21) displays the same three curves
...
Figure [160](#orgfc07eb9) illustrates the approach for estimating &alpha; by
...
figure [163](#orgdaf5944) displays a histogram of the resulting estimates.  The
...
[163](#orgdaf5944), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org1efb65b).
...
Table [19](#org708acdb) shows first four selected models for the best subset and
...
<table id="org708acdb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org55befb5) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org55befb5) displays the same ridge
...
[182](#org394bf90) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgbe680bd), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgbe680bd), as we
...
Figure [186](#org131f080) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org4fdf9b3) displays the choice of &lambda; that results from
...
Figure [190](#orgeb80260) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org152f8d9), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org152f8d9), the left-hand panel has
...
Figure [195](#org68c1f3f) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org7900458) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org570f9ba) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgd5a911a) further illustrates the risk of carelessly applying
...
Figure [203](#org5e03e5c) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org32dd26f) is a plot of `wage` against
...
The left-hand panel of figure [227](#org1fbf6a6) shows a fit of step functions
to the `Wage` data from figure [225](#org32dd26f).  We also fit the logistic
...
Figure [234](#org0915a42) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org97febc4) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org0915a42).")

Figure [238](#org5f8b8b9) shows a five-region example of prediction via
...
Figure [240](#orgb0903ae) is an example of when a linear model or a tree
...
Figure [242](#orgbfa19f4) is a graphical representation of *variable
...
Figure [247](#org06fff45) shows a hyperplane in two-dimensional space.
...
Figure [249](#orgbc4758c) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#org561a7a9), we see that three training observations are
...
[251](#org561a7a9), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#org0d1ed10) shows an example where we cannot *exactly* separate the two
...
In figures [255](#orgfc7d2f9), addition of a single observation in the right hand panel
...
Figure [257](#org4dc8728) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#orgdece14f) illustrates the width of margin for different values of
...
In figure [261](#orgab32054) consider the data shown in the left panel.  It is clear
...
In figure [263](#org41148b1), the left-hand panel shows an example of SVM with a
polynomial kernel applied the non-linear data from figure [261](#orgab32054).  The fit
...
In figure [265](#org5328f77), the left-hand panel displays ROC curves for training set
...
Figure [267](#org871da3e) compares ROC curves on test observations.  Using default
