...
1.  [Introduction](#orge3d29c4)
2.  [Statistical Learning](#org2d19884)
    1.  [What is Statistical Learning?](#orgdb1b1dd)
    2.  [Assessing Model Accuracy](#org1e831dd)
    3.  [Lab: Introduction to Python](#orge557dd4)
        1.  [Basic Commands](#org0f92457)
        2.  [Graphics](#org6651b55)
        3.  [Indexing Data](#orgd185dfc)
        4.  [Loading Data](#orgb837544)
        5.  [Additional Graphical and Numerical Summaries](#org394a963)
3.  [Linear Regression](#org6a96a81)
    1.  [Simple Linear Regression](#orgdcbb5a4)
    2.  [Multiple Linear Regression](#orgea00688)
    3.  [Other Considerations in the Regression Model](#org08e16fd)
    4.  [The Marketing Plan](#orgaf64898)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org508c529)
    6.  [Lab: Linear Regression](#orgb1a3bfe)
        1.  [Libraries](#orgbcfd778)
        2.  [Simple Linear Regression](#org9cf88f3)
        3.  [Multiple Linear Regression](#org3d602f6)
        4.  [Interaction Terms](#org5f12e11)
        5.  [Non-linear Transformations of the Predictors](#orgdbfa544)
        6.  [Qualitative Predictors](#orgcdbbedb)
        7.  [Calling `R` from `Python`](#org4d92d10)
4.  [Classification](#orgd9e529d)
    1.  [An Overview of Classification](#orgc0ff46f)
    2.  [Why Not Linear Regression?](#orgc752aba)
    3.  [Logistic Regression](#org764429c)
    4.  [Linear Discriminant Analysis](#orgfc0cebc)
    5.  [A Comparison of Classification Methods](#org31c190a)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org4e97054)
        1.  [The Stock Market Data](#orgc763418)
        2.  [Logistc Regression](#orgf488f1d)
        3.  [Linear Discriminant Analysis](#org79d991c)
        4.  [Quadratic Discriminant Analysis](#org737f331)
        5.  [K-Nearest Neightbors](#org402c07e)
        6.  [An Application to Caravan Insurance Data](#org2efb657)
5.  [Resampling Methods](#org360dba1)
    1.  [Cross-Validation](#org34a33a7)
    2.  [The Bootstrap](#orgb1d1cc9)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgdb65cf8)
        1.  [The Validation Set Approach](#orgac1a72e)
        2.  [Leave-One-Out Cross-Validation](#org40cf972)
        3.  [k-Fold Cross-Validation](#org0440acc)
        4.  [The Bootstrap](#org727791d)
6.  [Linear Model Selection and Regularization](#org7910724)
    1.  [Subset Selection](#org02c71bd)
    2.  [Shrinkage Methods](#org1caee4c)
    3.  [Dimension Reduction Methods](#org4d9f15e)
    4.  [Considerations in High Dimensions](#org6c7cb58)
    5.  [Lab 1: Subset Selection Methods](#orgd58c44e)
        1.  [Best Subset Selection](#orgb32d0a2)
        2.  [Forward and Backward Stepwise Selection](#org04ac0ac)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org358923b)
    6.  [Lab 2: Ridge Regression and the Lasso](#orgb2fa422)
        1.  [Ridge Regression](#org36b3dfe)
        2.  [The Lasso](#org70e9ff7)
    7.  [Lab 3: PCR and PLS Regression](#org5b65b83)
        1.  [Principal Components Regression](#orge6ec3e9)
        2.  [Partial Least Squares](#orge2733d7)
7.  [Moving Beyond Linearity](#org01f58fa)
    1.  [Polynomial Regression](#org8a947a9)
    2.  [Step Functions](#org40134d8)
    3.  [Basis Functions](#org64b2f7e)
    4.  [Regression Splines](#org5f2e57f)
    5.  [Lab: Non-linear Modeling](#org47d9ff4)
        1.  [Polynomial Regression and Step Functions](#orgf145026)
8.  [Tree-Based Models](#orgfa5a6db)
    1.  [The Basics of Decision Trees](#org01f4376)
        1.  [Regression Trees](#orgad62098)
        2.  [Classification Trees](#orga1ed2c5)
        3.  [Trees versus Linear Models](#org316e3b8)
    2.  [Bagging, Random Forests, Boosting](#org1b12e98)
    3.  [Lab: Decision Trees](#org4f10276)
        1.  [Fitting Classification Trees](#org3f30af9)
        2.  [Fitting Regression Trees](#orgbd1ee6c)
        3.  [Bagging and Random Forests](#org4c098c9)
        4.  [Boosting](#org237c7a4)
9.  [Support Vector Machines](#org3cd7edd)
    1.  [Maximal Margin Classifier](#orgfc9a201)
        1.  [What is a Hyperplane?](#org16c0e62)
        2.  [Classification Using a Separating Hyperplane](#orgbb03dc8)
        3.  [The Maximal Margin Classifier](#org8c60fa9)
        4.  [Construction of the Maximal Margin Classifier](#org8400711)
        5.  [The Non-separable Case](#org0e87889)
    2.  [Support Vector Classifiers](#org81cc561)
        1.  [Overview of the Support Vector Classifier](#org7559a9d)
        2.  [Details of the Support Vector Classifier](#org4c3398d)
    3.  [Support Vector Machines](#org1294b31)
        1.  [Classification with Non-linear Decision Boundaries](#org43b2608)
        2.  [The Support Vector Machine](#org012ab95)
        3.  [An Application to the Heart Disease Data](#org1794962)
...
Figure [2](#org4de9f27) shows graphs of Wage versus three variables. 
...
Figure [4](#orgf06ec9c) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgb0aaf3f) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgce0b611) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org03b3f40) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org84268ba) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org03b3f40).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orgb5619d0) provides an illustration of the trade-off between
...
Figure [17](#org1891fbc) provides a simple illustration of the clustering problem.
...
Figure [21](#orgd01a3a8) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgd01a3a8), we see considerable
...
Figure [23](#orge394ba2) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgd01a3a8) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org509a6e5) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgd01a3a8), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgac16a3a) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgd01a3a8) - [25](#org509a6e5).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org951adba) provides an example using a simulated data set in
...
Figure [31](#org1478b87) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org951adba).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org951adba), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org951adba).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org4c6b164) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org951adba) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org728f3ca) displays the simple linear regression fit to the
...
In figure [50](#org2439f2c), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgd79be10) displays *population regression
...
right-hand panel of figure [52](#orgd79be10) we have generated five different
...
For `Advertising` data, table [1](#org8e6bf16) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org8e6bf16" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org8bf44b6), we report more information about the least squares model.  

<table id="org8bf44b6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgf4860a2)  shows results of two simple linear
...
<table id="orgf4860a2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org403f59a) illustrates an example of the least squares fit to a
...
Table [4](#orgebdd90c) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgebdd90c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgc96274f) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgebdd90c). 

<table id="orgc96274f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org9bee576" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgebdd90c).</caption>
...
Figure [61](#orgff4d457) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org5cbbf6e) records `balance`
...
Table [7](#org5549bad) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org5549bad" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org3bbe8bc) we see that the estimated `balance` for the
...
<table id="org3bbe8bc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orgde65c8e) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgcefc847), the left panel shows least squares lines when
...
<table id="orgde65c8e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org4054ca2) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org7f88a9f) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org7f88a9f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orge4f36f9) displays a residual plot from the
...
of figure[73](#orge4f36f9) displays the residual plot results from the model
...
Figure [75](#orge6ef8bc) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org59dc213), the magnitude of the
...
[79](#org5eb6349) illustrates a typical outlier.  The red solid line is the
...
[79](#org5eb6349), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgbbd0b2e) has
...
[81](#orgbbd0b2e) are the same as the data displayed in figure
[79](#org5eb6349), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org5eb6349) and
[81](#orgbbd0b2e), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgbbd0b2e), for a data set with two
...
point. The right-panel of figure [81](#orgbbd0b2e) provides a plot of
...
Figure [83](#org04669b8) illustrates the concept of collinearity.
...
Figure [86](#org9e2e815) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org9e2e815) displays contour
...
Table [11](#orgaeb6184) compares the coefficient estimates obtained from two
...
<table id="orgaeb6184" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#orgbe6ce4c) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org8389215) provides an example of KNN regression with data
...
Figure [93](#orge809055) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orge809055)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org8389215) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org04a6ce9) examines the relative performances of least squares
...
Figure [97](#orgfbdbd8b) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org04a6ce9), except that we have added additional *noise*
...
In figure [110](#org14ff7dc), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgc2dc1af) we show probability of default as a function of
...
Table [12](#org50b81df) shows the coefficient estimates and related
...
<table id="org50b81df" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org69b2fce) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgdb15c3f) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org69b2fce" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgdb15c3f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org3a752b2) shows average default rates
...
[14](#orgdb15c3f).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org8a551c8), two normal density functions
...
figure [121](#org6d6e8cd).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org6d6e8cd).  In this situation, the base
...
Figure [123](#orgb984b3a) shows an example of three equally sized Gaussian
...
[15](#orga37c66c), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org261e615) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orga37c66c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org261e615" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org1700d9f) illustrates the trade-off that results from
...
Figure [128](#org986b333) displays the ROC curve for the LDA classifier on
...
Table [17](#org2dfe95a) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org2dfe95a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org96ba90d) lists many of the popular performance measures that
are used in this context.

<table id="org96ba90d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org2dfe95a).</caption>
...
Figure [132](#org400bfac) illustrates the performances of LDA and QDA in two
...
Figure [134](#org8b1bfc7) illustrates the performances of the four
...
Figure [143](#org00dbffe) displays the *validation set approach*, a simple
...
In figure [145](#org470fc03), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orgaba4053) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orgf0247ee) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orgf0247ee) shows nine different 10-fold
...
Figure [151](#orgae73b6d) illustrates the *k*-fold CV approach.
...
In figure [153](#org7b1930b), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgd01a3a8),
[23](#orge394ba2), and [25](#org509a6e5) of chapter [2](#org198dc78).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgd01a3a8) (left), [23](#orge394ba2) (center), and [25](#org509a6e5) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org015b058) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org951adba).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org49da003) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org49da003) displays the same three curves
...
Figure [160](#orgf3c0a75) illustrates the approach for estimating &alpha; by
...
figure [163](#orga4b5acb) displays a histogram of the resulting estimates.  The
...
[163](#orga4b5acb), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org0e69e14).
...
Table [19](#org2c11df1) shows first four selected models for the best subset and
...
<table id="org2c11df1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#orgd7438a7) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#orgd7438a7) displays the same ridge
...
[182](#orgdd0a75f) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgf1cf182), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgf1cf182), as we
...
Figure [186](#org60a48ed) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgd6299f6) displays the choice of &lambda; that results from
...
Figure [190](#org96e8297) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org24e8bac), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org24e8bac), the left-hand panel has
...
Figure [195](#org0f5448f) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org1109b9c) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orgf12b7e3) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org681a0d8) further illustrates the risk of carelessly applying
...
Figure [203](#org2c84d72) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org46fcd2a) is a plot of `wage` against
...
The left-hand panel of figure [227](#orgaf141cb) shows a fit of step functions
to the `Wage` data from figure [225](#org46fcd2a).  We also fit the logistic
...
Figure [234](#org6c6501b) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org36e0866) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org6c6501b).")

Figure [238](#org12f6f80) shows a five-region example of prediction via
...
Figure [240](#orgfcf93b8) is an example of when a linear model or a tree
...
Figure [242](#orgb85cfa5) is a graphical representation of *variable
...
Figure [247](#org507ed8a) shows a hyperplane in two-dimensional space.
...
Figure [249](#org7fa9dc2) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#org07e8b16), we see that three training observations are
...
[251](#org07e8b16), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#org6a20476) shows an example where we cannot *exactly* separate the two
...
In figures [255](#org341b4a4), addition of a single observation in the right hand panel
...
Figure [257](#org0e08b08) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#org7e610c0) illustrates the width of margin for different values of
...
In figure [261](#org556d6d5) consider the data shown in the left panel.  It is clear
...
In figure [263](#org1e4bf95), the left-hand panel displays ROC curves for training set
...
Figure [265](#orgbc33211) compares ROC curves on test observations.  Using default
