...
1.  [Introduction](#orgfaf58a5)
2.  [Statistical Learning](#org50332c9)
    1.  [What is Statistical Learning?](#orgb342fcb)
    2.  [Assessing Model Accuracy](#orge459832)
    3.  [Lab: Introduction to Python](#orgb4bc542)
        1.  [Basic Commands](#orgb82bf17)
        2.  [Graphics](#orge6d81b2)
        3.  [Indexing Data](#orgc46ef10)
        4.  [Loading Data](#org74b380a)
        5.  [Additional Graphical and Numerical Summaries](#orgb488fe9)
3.  [Linear Regression](#org9fb0c0f)
    1.  [Simple Linear Regression](#org46c2735)
    2.  [Multiple Linear Regression](#org8170d5a)
    3.  [Other Considerations in the Regression Model](#orgf437f1e)
    4.  [The Marketing Plan](#org97fafa9)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org864760e)
    6.  [Lab: Linear Regression](#orge7805d0)
        1.  [Libraries](#org35793e4)
        2.  [Simple Linear Regression](#org11a1d15)
        3.  [Multiple Linear Regression](#org68001e1)
        4.  [Interaction Terms](#orga6bf210)
        5.  [Non-linear Transformations of the Predictors](#orgb8b5cc2)
        6.  [Qualitative Predictors](#orgcce8ac0)
        7.  [Calling `R` from `Python`](#orgc9ce9c2)
4.  [Classification](#org346f8ab)
    1.  [An Overview of Classification](#org6cf869e)
    2.  [Why Not Linear Regression?](#org5d7d5aa)
    3.  [Logistic Regression](#org2e1206f)
    4.  [Linear Discriminant Analysis](#org32c3a09)
    5.  [A Comparison of Classification Methods](#org9fcf16e)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org844c0c5)
        1.  [The Stock Market Data](#orgd5ee59e)
        2.  [Logistc Regression](#org540d7ca)
        3.  [Linear Discriminant Analysis](#org7a1bb7d)
        4.  [Quadratic Discriminant Analysis](#org620aedd)
        5.  [K-Nearest Neightbors](#org98d2fcc)
        6.  [An Application to Caravan Insurance Data](#orgd356269)
5.  [Resampling Methods](#orge214cad)
    1.  [Cross-Validation](#org62be54e)
    2.  [The Bootstrap](#org2a763e7)
    3.  [Lab: Cross-Validation and the Bootstrap](#org6e0609b)
        1.  [The Validation Set Approach](#org3dfb4a4)
        2.  [Leave-One-Out Cross-Validation](#org63099d6)
        3.  [k-Fold Cross-Validation](#org4b7ac7b)
        4.  [The Bootstrap](#orgd7f1e8b)
6.  [Linear Model Selection and Regularization](#orgeb8e0a8)
    1.  [Subset Selection](#org1ba89ac)
    2.  [Shrinkage Methods](#org967f90a)
    3.  [Dimension Reduction Methods](#org49d2491)
...
Figure [2](#org6a62810) shows graphs of Wage versus three variables. 
...
Figure [4](#org1b1fe3f) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgab10e0c) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org39cc516) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orgf72ebdf) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org468bc79) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orgf72ebdf).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org1040a8b) provides an illustration of the trade-off between
...
Figure [17](#org7d1c98f) provides a simple illustration of the clustering problem.
...
Figure [21](#org045c17c) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org045c17c), we see considerable
...
Figure [23](#orgec3b039) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org045c17c) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org21ba894) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org045c17c), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org0092887) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org045c17c) - [25](#org21ba894).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org810a4c6) provides an example using a simulated data set in
...
Figure [31](#org5aed609) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org810a4c6).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org810a4c6), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org810a4c6).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org8fdab19) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org810a4c6) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org2c01277) displays the simple linear regression fit to the
...
In figure [50](#org3175954), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orge5854e7) displays *population regression
...
right-hand panel of figure [52](#orge5854e7) we have generated five different
...
For `Advertising` data, table [1](#orgecffe76) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgecffe76" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org3e797a5), we report more information about the least squares model.  

<table id="org3e797a5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgd34ad66)  shows results of two simple linear
...
<table id="orgd34ad66" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org7cb56f1) illustrates an example of the least squares fit to a
...
Table [4](#orge640411) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orge640411" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org545affe) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orge640411). 

<table id="org545affe" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org551ebbc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orge640411).</caption>
...
Figure [61](#orgdcf3cbe) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org2633158) records `balance`
...
Table [7](#org09894cb) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org09894cb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgaac6871) we see that the estimated `balance` for the
...
<table id="orgaac6871" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org827d6ce) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org7c8b9f9), the left panel shows least squares lines when
...
<table id="org827d6ce" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orge7ee722) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgc461d35) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgc461d35" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org753e1d3) displays a residual plot from the
...
of figure[73](#org753e1d3) displays the residual plot results from the model
...
Figure [75](#orgb929275) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org442a6fe), the magnitude of the
...
[79](#org29cd540) illustrates a typical outlier.  The red solid line is the
...
[79](#org29cd540), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgc825081) has
...
[81](#orgc825081) are the same as the data displayed in figure
[79](#org29cd540), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org29cd540) and
[81](#orgc825081), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgc825081), for a data set with two
...
point. The right-panel of figure [81](#orgc825081) provides a plot of
...
Figure [83](#org97d2763) illustrates the concept of collinearity.
...
Figure [86](#orgcdb64f7) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgcdb64f7) displays contour
...
Table [11](#orgba3ba53) compares the coefficient estimates obtained from two
...
<table id="orgba3ba53" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org3784fd9) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orgab0c1f1) provides an example of KNN regression with data
...
Figure [93](#orgf7e23d9) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgf7e23d9)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orgab0c1f1) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgd6998a3) examines the relative performances of least squares
...
Figure [97](#org1ec6c91) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgd6998a3), except that we have added additional *noise*
...
In figure [110](#orge9699ad), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgc3ff021) we show probability of default as a function of
...
Table [12](#org3506562) shows the coefficient estimates and related
...
<table id="org3506562" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgd442696) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org8e6e8d4) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgd442696" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org8e6e8d4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgd3aa5fa) shows average default rates
...
[14](#org8e6e8d4).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org9ee8264), two normal density functions
...
figure [121](#org394f513).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org394f513).  In this situation, the base
...
Figure [123](#orgb1899e3) shows an example of three equally sized Gaussian
...
[15](#org0ace8d7), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org1fa5ac0) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org0ace8d7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org1fa5ac0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orga91f270) illustrates the trade-off that results from
...
Figure [128](#org526af86) displays the ROC curve for the LDA classifier on
...
Table [17](#orge7409e4) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orge7409e4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgb05a0dd) lists many of the popular performance measures that
are used in this context.

<table id="orgb05a0dd" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orge7409e4).</caption>
...
Figure [132](#org7c8bc08) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgf73eeef) illustrates the performances of the four
...
Figure [143](#org2303464) displays the *validation set approach*, a simple
...
In figure [145](#org0fc4a48), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org0cb353e) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orgbb4910d) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orgbb4910d) shows nine different 10-fold
...
Figure [151](#orgeb478c7) illustrates the *k*-fold CV approach.
...
In figure [153](#orgb88a243), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org045c17c),
[23](#orgec3b039), and [25](#org21ba894) of chapter [2](#orgef3750d).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org045c17c) (left), [23](#orgec3b039) (center), and [25](#org21ba894) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org008b9ae) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org810a4c6).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org9550a5e) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org9550a5e) displays the same three curves
...
Figure [160](#orgd3dc05c) illustrates the approach for estimating &alpha; by
...
figure [163](#org8bb6c06) displays a histogram of the resulting estimates.  The
...
[163](#org8bb6c06), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orgf7e287c).
...
Table [19](#orgcaa8997) shows first four selected models for the best subset and
...
<table id="orgcaa8997" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org5192f7f) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org5192f7f) displays the same ridge
...
[182](#orgfe17dbd) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org11b7b2c), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org11b7b2c), as we
...
Figure [186](#org142fe65) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgc184cb6) displays the choice of &lambda; that results from
...
Figure [190](#org4bb7df5) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org33fafb6), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org33fafb6), the left-hand panel has
