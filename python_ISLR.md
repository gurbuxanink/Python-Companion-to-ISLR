...
1.  [Introduction](#org1bb86c0)
2.  [Statistical Learning](#orgc0d9d54)
    1.  [What is Statistical Learning?](#org1f59098)
    2.  [Assessing Model Accuracy](#org193f178)
    3.  [Lab: Introduction to Python](#org28201c0)
        1.  [Basic Commands](#org501fb4b)
        2.  [Graphics](#org47aea8a)
        3.  [Indexing Data](#org64553dd)
        4.  [Loading Data](#org0db4a51)
        5.  [Additional Graphical and Numerical Summaries](#org630a414)
3.  [Linear Regression](#org0109f27)
    1.  [Simple Linear Regression](#orgad65256)
    2.  [Multiple Linear Regression](#orgf806923)
    3.  [Other Considerations in the Regression Model](#orgaae72ba)
    4.  [The Marketing Plan](#org43107b5)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org14edd75)
    6.  [Lab: Linear Regression](#org44544f6)
        1.  [Libraries](#orgf92dabb)
        2.  [Simple Linear Regression](#orgd251d2f)
        3.  [Multiple Linear Regression](#org9508609)
        4.  [Interaction Terms](#orgd6a2d95)
        5.  [Non-linear Transformations of the Predictors](#orgd227322)
        6.  [Qualitative Predictors](#org7a9db0c)
        7.  [Calling `R` from `Python`](#org4038051)
4.  [Classification](#org6b5959f)
    1.  [An Overview of Classification](#org44de899)
    2.  [Why Not Linear Regression?](#org58dc252)
    3.  [Logistic Regression](#orgc1363c8)
    4.  [Linear Discriminant Analysis](#orge0bfae8)
    5.  [A Comparison of Classification Methods](#org8559058)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org4eb1a6b)
        1.  [The Stock Market Data](#orgfcca1ea)
        2.  [Logistc Regression](#orgff3ea99)
        3.  [Linear Discriminant Analysis](#org79aa490)
        4.  [Quadratic Discriminant Analysis](#orgf73008e)
        5.  [K-Nearest Neightbors](#org36ee915)
        6.  [An Application to Caravan Insurance Data](#orgca1939e)
5.  [Resampling Methods](#org65868d5)
    1.  [Cross-Validation](#orgfd537b0)
    2.  [The Bootstrap](#org1266822)
    3.  [Lab: Cross-Validation and the Bootstrap](#org0a7b1e4)
        1.  [The Validation Set Approach](#org8c4e850)
        2.  [Leave-One-Out Cross-Validation](#org3ab4e26)
        3.  [k-Fold Cross-Validation](#org560ccdd)
        4.  [The Bootstrap](#org2fdd1ba)
6.  [Linear Model Selection and Regularization](#orgfbdf6bc)
    1.  [Subset Selection](#orgeac9a89)
    2.  [Shrinkage Methods](#orgd9885ef)
...
Figure [2](#orgce8f14f) shows graphs of Wage versus three variables. 
...
Figure [4](#org2618f92) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org45835ce) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org97ae689) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org592cb67) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgfdebe7c) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org592cb67).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org87f4ca2) provides an illustration of the trade-off between
...
Figure [17](#org33453b4) provides a simple illustration of the clustering problem.
...
Figure [21](#org4fa045b) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org4fa045b), we see considerable
...
Figure [23](#org552a00d) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org4fa045b) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org6c94eae) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org4fa045b), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgc746886) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org4fa045b) - [25](#org6c94eae).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgc5b5af8) provides an example using a simulated data set in
...
Figure [31](#orgf1c7575) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgc5b5af8).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgc5b5af8), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgc5b5af8).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org110e404) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orgc5b5af8) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgfd0233b) displays the simple linear regression fit to the
...
In figure [50](#org5866a8b), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgd01b597) displays *population regression
...
right-hand panel of figure [52](#orgd01b597) we have generated five different
...
For `Advertising` data, table [1](#org9316bb0) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org9316bb0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgefb92cc), we report more information about the least squares model.  

<table id="orgefb92cc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org5e6f1d3)  shows results of two simple linear
...
<table id="org5e6f1d3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org10a5ef3) illustrates an example of the least squares fit to a
...
Table [4](#org7ebac80) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org7ebac80" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgecc2c21) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org7ebac80). 

<table id="orgecc2c21" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org6735266" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org7ebac80).</caption>
...
Figure [61](#org68f8256) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgd3bbe2f) records `balance`
...
Table [7](#org7d08d3a) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org7d08d3a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org86ff90a) we see that the estimated `balance` for the
...
<table id="org86ff90a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org35da084) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgc86b51c), the left panel shows least squares lines when
...
<table id="org35da084" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org9adb2b3) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org52a532b) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org52a532b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgb3e8875) displays a residual plot from the
...
of figure[73](#orgb3e8875) displays the residual plot results from the model
...
Figure [75](#org37acdeb) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org2f292d7), the magnitude of the
...
[79](#org48b483a) illustrates a typical outlier.  The red solid line is the
...
[79](#org48b483a), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org86d0f8f) has
...
[81](#org86d0f8f) are the same as the data displayed in figure
[79](#org48b483a), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org48b483a) and
[81](#org86d0f8f), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org86d0f8f), for a data set with two
...
point. The right-panel of figure [81](#org86d0f8f) provides a plot of
...
Figure [83](#orge9e91c8) illustrates the concept of collinearity.
...
Figure [86](#orgdd0d698) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgdd0d698) displays contour
...
Table [11](#org53ee223) compares the coefficient estimates obtained from two
...
<table id="org53ee223" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#orgb51fd2b) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org1c71b8d) provides an example of KNN regression with data
...
Figure [93](#org1043f2a) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org1043f2a)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org1c71b8d) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orga988a74) examines the relative performances of least squares
...
Figure [97](#org2304d1f) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orga988a74), except that we have added additional *noise*
...
In figure [110](#org93f328a), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgd611c85) we show probability of default as a function of
...
Table [12](#orgd49816a) shows the coefficient estimates and related
...
<table id="orgd49816a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgcbf20dc) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgaaa76cf) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgcbf20dc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgaaa76cf" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgb754d39) shows average default rates
...
[14](#orgaaa76cf).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgfababd5), two normal density functions
...
figure [121](#org1614bb0).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org1614bb0).  In this situation, the base
...
Figure [123](#org0b5cdaa) shows an example of three equally sized Gaussian
...
[15](#org83f8d88), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgc98d689) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org83f8d88" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgc98d689" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org1ceefbc) illustrates the trade-off that results from
...
Figure [128](#org4970e70) displays the ROC curve for the LDA classifier on
...
Table [17](#org78bc13b) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org78bc13b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org557ce24) lists many of the popular performance measures that
are used in this context.

<table id="org557ce24" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org78bc13b).</caption>
...
Figure [132](#orge3bd448) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgd6aba50) illustrates the performances of the four
...
Figure [143](#orgcc0b698) displays the *validation set approach*, a simple
...
In figure [145](#org80b0ea2), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orgf45d306) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org856df79) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org856df79) shows nine different 10-fold
...
Figure [151](#orgfc4f2ae) illustrates the *k*-fold CV approach.
...
In figure [153](#orgfcb5f58), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org4fa045b),
[23](#org552a00d), and [25](#org6c94eae) of chapter [2](#org65996de).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org4fa045b) (left), [23](#org552a00d) (center), and [25](#org6c94eae) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org3800a76) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgc5b5af8).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org01a069e) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org01a069e) displays the same three curves
...
Figure [160](#orgd0a24d9) illustrates the approach for estimating &alpha; by
...
figure [163](#orga312d45) displays a histogram of the resulting estimates.  The
...
[163](#orga312d45), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org73eb62e).
...
Table [19](#orgccfbf13) shows first four selected models for the best subset and
...
<table id="orgccfbf13" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
