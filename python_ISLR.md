...
1.  [Introduction](#orge4705ae)
2.  [Statistical Learning](#org966c57c)
    1.  [What is Statistical Learning?](#orgb469797)
    2.  [Assessing Model Accuracy](#orgcb97829)
    3.  [Lab: Introduction to Python](#orgb444521)
        1.  [Basic Commands](#orga21fcd7)
        2.  [Graphics](#org4d545cc)
        3.  [Indexing Data](#org2e47310)
        4.  [Loading Data](#org39bd513)
        5.  [Additional Graphical and Numerical Summaries](#org4d19c3c)
3.  [Linear Regression](#org7c6820e)
    1.  [Simple Linear Regression](#orgbf56251)
    2.  [Multiple Linear Regression](#org2847ca5)
    3.  [Other Considerations in the Regression Model](#org75a1dbe)
    4.  [The Marketing Plan](#orgb2e3a40)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orga2d0ef6)
    6.  [Lab: Linear Regression](#org67475da)
        1.  [Libraries](#orgee70de8)
        2.  [Simple Linear Regression](#orga7e9643)
        3.  [Multiple Linear Regression](#org6cff09d)
        4.  [Interaction Terms](#orgab35576)
        5.  [Non-linear Transformations of the Predictors](#org92cea1c)
        6.  [Qualitative Predictors](#org0a97a78)
        7.  [Calling `R` from `Python`](#org8814ed2)
4.  [Classification](#org953e2a9)
    1.  [An Overview of Classification](#org6813837)
    2.  [Why Not Linear Regression?](#orgaf09b96)
    3.  [Logistic Regression](#org4ef0bdd)
    4.  [Linear Discriminant Analysis](#org447be91)
    5.  [A Comparison of Classification Methods](#org40b4b7e)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org8e0c94e)
        1.  [The Stock Market Data](#org0f0692c)
        2.  [Logistc Regression](#orgf4c896e)
        3.  [Linear Discriminant Analysis](#orgbc1d0f3)
        4.  [Quadratic Discriminant Analysis](#org3e52895)
        5.  [K-Nearest Neightbors](#org7736fb5)
        6.  [An Application to Caravan Insurance Data](#orgf30f3c5)
5.  [Resampling Methods](#orgec7478f)
    1.  [Cross-Validation](#orgcb13e18)
    2.  [The Bootstrap](#org170bb6e)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgbb7fbc2)
        1.  [The Validation Set Approach](#org134c740)
        2.  [Leave-One-Out Cross-Validation](#orga4a7cbd)
        3.  [k-Fold Cross-Validation](#org6c05765)
        4.  [The Bootstrap](#org802651a)
6.  [Linear Model Selection and Regularization](#orgaf46d91)
    1.  [Subset Selection](#org384689e)
    2.  [Shrinkage Methods](#org959587e)
    3.  [Dimension Reduction Methods](#org5567bfe)
    4.  [Considerations in High Dimensions](#org270eef7)
    5.  [Lab 1: Subset Selection Methods](#orgfaccce3)
        1.  [Best Subset Selection](#org7aa3e8f)
        2.  [Forward and Backward Stepwise Selection](#org1d14b68)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org3f569e7)
    6.  [Lab 2: Ridge Regression and the Lasso](#orga6478ba)
        1.  [Ridge Regression](#org8f3ae5c)
        2.  [The Lasso](#orgad27e80)
    7.  [Lab 3: PCR and PLS Regression](#orgbe37ed4)
        1.  [Principal Components Regression](#orgce486de)
        2.  [Partial Least Squares](#org705eaeb)
7.  [Moving Beyond Linearity](#org32ec5b4)
    1.  [Polynomial Regression](#orgf64e736)
    2.  [Step Functions](#org895bd97)
    3.  [Basis Functions](#orgb93ac46)
    4.  [Regression Splines](#org1e5c904)
    5.  [Lab: Non-linear Modeling](#orgdf52659)
        1.  [Polynomial Regression and Step Functions](#org0b75f24)
8.  [Tree-Based Models](#org2ca6c6f)
    1.  [The Basics of Decision Trees](#org90411c0)
        1.  [Regression Trees](#org2d54871)
    2.  [Bagging, Random Forests, Boosting](#org6a067f6)
    3.  [Lab: Decision Trees](#orgd5a9150)
        1.  [Fitting Classification Trees](#orgf6acb32)
        2.  [Fitting Regression Trees](#org0097581)
        3.  [Bagging and Random Forests](#orge50d2cd)
...
Figure [2](#org555a2c9) shows graphs of Wage versus three variables. 
...
Figure [4](#org87ea9fd) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orga04a771) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgcce0617) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orgf771b1b) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org6a70c52) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orgf771b1b).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orga4f343c) provides an illustration of the trade-off between
...
Figure [17](#org564f516) provides a simple illustration of the clustering problem.
...
Figure [21](#org250425a) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org250425a), we see considerable
...
Figure [23](#org469a170) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org250425a) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org77916b7) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org250425a), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org0ebfe76) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org250425a) - [25](#org77916b7).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org7163c8f) provides an example using a simulated data set in
...
Figure [31](#org957a849) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org7163c8f).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org7163c8f), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org7163c8f).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgda4c6e4) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org7163c8f) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org849ba5f) displays the simple linear regression fit to the
...
In figure [50](#org40becf1), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org6c7d046) displays *population regression
...
right-hand panel of figure [52](#org6c7d046) we have generated five different
...
For `Advertising` data, table [1](#orgb611cd4) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgb611cd4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org4400f31), we report more information about the least squares model.  

<table id="org4400f31" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgb2a4775)  shows results of two simple linear
...
<table id="orgb2a4775" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#orgcb65a0f) illustrates an example of the least squares fit to a
...
Table [4](#org2bebf22) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org2bebf22" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org8f3deba) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org2bebf22). 

<table id="org8f3deba" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org49e5b87" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org2bebf22).</caption>
...
Figure [61](#org1722975) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgce6bd9c) records `balance`
...
Table [7](#org5791e4d) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org5791e4d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org74351df) we see that the estimated `balance` for the
...
<table id="org74351df" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org7bbe3ad) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orga75a73f), the left panel shows least squares lines when
...
<table id="org7bbe3ad" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org8048ea4) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org7477b68) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org7477b68" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org10eb6c2) displays a residual plot from the
...
of figure[73](#org10eb6c2) displays the residual plot results from the model
...
Figure [75](#org9c8387e) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org10979de), the magnitude of the
...
[79](#orge988f0e) illustrates a typical outlier.  The red solid line is the
...
[79](#orge988f0e), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgf7fe9b4) has
...
[81](#orgf7fe9b4) are the same as the data displayed in figure
[79](#orge988f0e), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orge988f0e) and
[81](#orgf7fe9b4), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgf7fe9b4), for a data set with two
...
point. The right-panel of figure [81](#orgf7fe9b4) provides a plot of
...
Figure [83](#org9a15969) illustrates the concept of collinearity.
...
Figure [86](#org56a07aa) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org56a07aa) displays contour
...
Table [11](#org0e49fb7) compares the coefficient estimates obtained from two
...
<table id="org0e49fb7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org04cfd71) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org1519efe) provides an example of KNN regression with data
...
Figure [93](#orgea21ec8) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgea21ec8)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org1519efe) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgc426669) examines the relative performances of least squares
...
Figure [97](#orgecf6955) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgc426669), except that we have added additional *noise*
...
In figure [110](#org50a673e), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org2498f7e) we show probability of default as a function of
...
Table [12](#org1418100) shows the coefficient estimates and related
...
<table id="org1418100" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org31809d5) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgaf36695) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org31809d5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgaf36695" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org44ebf15) shows average default rates
...
[14](#orgaf36695).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org89cc53b), two normal density functions
...
figure [121](#org28c0461).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org28c0461).  In this situation, the base
...
Figure [123](#orgba7c5b8) shows an example of three equally sized Gaussian
...
[15](#orgfd6f5ce), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org257035f) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgfd6f5ce" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org257035f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org89a7562) illustrates the trade-off that results from
...
Figure [128](#org0155ddb) displays the ROC curve for the LDA classifier on
...
Table [17](#org420e233) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org420e233" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org13259e0) lists many of the popular performance measures that
are used in this context.

<table id="org13259e0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org420e233).</caption>
...
Figure [132](#org8f54b4a) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgf04c177) illustrates the performances of the four
...
Figure [143](#orge7316cb) displays the *validation set approach*, a simple
...
In figure [145](#org7f61554), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orga576152) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org4205796) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org4205796) shows nine different 10-fold
...
Figure [151](#org8f1c469) illustrates the *k*-fold CV approach.
...
In figure [153](#org82458c0), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org250425a),
[23](#org469a170), and [25](#org77916b7) of chapter [2](#org1fd1aed).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org250425a) (left), [23](#org469a170) (center), and [25](#org77916b7) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org99db7dd) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org7163c8f).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org5e868b8) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org5e868b8) displays the same three curves
...
Figure [160](#org508b45e) illustrates the approach for estimating &alpha; by
...
figure [163](#orga9569db) displays a histogram of the resulting estimates.  The
...
[163](#orga9569db), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orge883581).
...
Table [19](#org5de7e1c) shows first four selected models for the best subset and
...
<table id="org5de7e1c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#orgf4687a4) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#orgf4687a4) displays the same ridge
...
[182](#org4c8a38a) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org5abc45c), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org5abc45c), as we
...
Figure [186](#orgeb5477f) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orga0fc8ae) displays the choice of &lambda; that results from
...
Figure [190](#org56489fb) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org2690224), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org2690224), the left-hand panel has
...
Figure [195](#org4184953) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org186ed49) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orgfb6b8e3) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org2fdde63) further illustrates the risk of carelessly applying
...
Figure [203](#org40f9eff) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org09ba5af) is a plot of `wage` against
...
The left-hand panel of figure [227](#org242955f) shows a fit of step functions
to the `Wage` data from figure [225](#org09ba5af).  We also fit the logistic
...
Figure [234](#org46409db) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org54b2e55) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org46409db).")

Figure [238](#org31daf36) shows a five-region example of prediction via
