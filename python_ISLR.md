...
1.  [Introduction](#org46870fc)
2.  [Statistical Learning](#org0f159a0)
    1.  [What is Statistical Learning?](#org98bf794)
    2.  [Assessing Model Accuracy](#org28b5a19)
    3.  [Lab: Introduction to Python](#org1d1d4e9)
        1.  [Basic Commands](#orgf256f05)
        2.  [Graphics](#orgcd2a923)
        3.  [Indexing Data](#orgb8193f9)
        4.  [Loading Data](#org6da12fb)
        5.  [Additional Graphical and Numerical Summaries](#org5c92ce2)
3.  [Linear Regression](#orge364b65)
    1.  [Simple Linear Regression](#org477d552)
    2.  [Multiple Linear Regression](#orgd396277)
    3.  [Other Considerations in the Regression Model](#org6e0dcb9)
    4.  [The Marketing Plan](#orgd963200)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org6b66248)
    6.  [Lab: Linear Regression](#orga3c3976)
        1.  [Libraries](#orgadaa3a5)
        2.  [Simple Linear Regression](#org4e77cdc)
        3.  [Multiple Linear Regression](#orgbbb5769)
        4.  [Interaction Terms](#orga45ebc2)
        5.  [Non-linear Transformations of the Predictors](#org5953330)
        6.  [Qualitative Predictors](#orgf969412)
        7.  [Calling `R` from `Python`](#orgbcf3c7f)
4.  [Classification](#org2127aca)
    1.  [An Overview of Classification](#org1645845)
    2.  [Why Not Linear Regression?](#org08a72b1)
    3.  [Logistic Regression](#org0c66396)
    4.  [Linear Discriminant Analysis](#org6084afa)
    5.  [A Comparison of Classification Methods](#orga395f9c)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgf7f05ee)
        1.  [The Stock Market Data](#orgc9bfe40)
        2.  [Logistc Regression](#orgda3e51c)
        3.  [Linear Discriminant Analysis](#orged5b84b)
        4.  [Quadratic Discriminant Analysis](#org5ef4b35)
        5.  [K-Nearest Neightbors](#org18cfbb7)
        6.  [An Application to Caravan Insurance Data](#orgc27d6ee)
5.  [Resampling Methods](#org95a2344)
    1.  [Cross-Validation](#orgc37c460)
    2.  [The Bootstrap](#org039142e)
    3.  [Lab: Cross-Validation and the Bootstrap](#orge0f32e2)
        1.  [The Validation Set Approach](#org6b32bec)
        2.  [Leave-One-Out Cross-Validation](#org4e2740e)
        3.  [k-Fold Cross-Validation](#orgc884a26)
        4.  [The Bootstrap](#org252def9)
6.  [Linear Model Selection and Regularization](#orgf8af96b)
    1.  [Subset Selection](#org9a9c525)
    2.  [Shrinkage Methods](#orgb5d10fd)
    3.  [Dimension Reduction Methods](#orgc1ace56)
    4.  [Considerations in High Dimensions](#org0697f12)
    5.  [Lab 1: Subset Selection Methods](#org44f6c03)
        1.  [Best Subset Selection](#org82f0bee)
        2.  [Forward and Backward Stepwise Selection](#orgf69c9e7)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#orge995d4b)
    6.  [Lab 2: Ridge Regression and the Lasso](#org140ea78)
...
Figure [2](#org4d077a8) shows graphs of Wage versus three variables. 
...
Figure [4](#org20490a9) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org424ca8e) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgb12ecdc) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org6582493) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orge33d1a0) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org6582493).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orged3999b) provides an illustration of the trade-off between
...
Figure [17](#orgeecb3d8) provides a simple illustration of the clustering problem.
...
Figure [21](#org6fe7dd1) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org6fe7dd1), we see considerable
...
Figure [23](#org0b438f7) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org6fe7dd1) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orga135499) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org6fe7dd1), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgcaf7f98) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org6fe7dd1) - [25](#orga135499).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orge15f1e1) provides an example using a simulated data set in
...
Figure [31](#org8f52aad) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orge15f1e1).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orge15f1e1), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orge15f1e1).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orge6d0809) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orge15f1e1) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgfd63d36) displays the simple linear regression fit to the
...
In figure [50](#org60c104e), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org9a952cf) displays *population regression
...
right-hand panel of figure [52](#org9a952cf) we have generated five different
...
For `Advertising` data, table [1](#orgedfcb10) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgedfcb10" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org7218923), we report more information about the least squares model.  

<table id="org7218923" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org9437d7a)  shows results of two simple linear
...
<table id="org9437d7a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#orgcb7fc75) illustrates an example of the least squares fit to a
...
Table [4](#orge226fdf) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orge226fdf" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org66873c4) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orge226fdf). 

<table id="org66873c4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org9e5ce19" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orge226fdf).</caption>
...
Figure [61](#org12f329a) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org0a90fa3) records `balance`
...
Table [7](#orgd3bd883) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgd3bd883" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgc2c251c) we see that the estimated `balance` for the
...
<table id="orgc2c251c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orga3489b2) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org828dacc), the left panel shows least squares lines when
...
<table id="orga3489b2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org64d9020) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org0c037ff) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org0c037ff" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org380e48c) displays a residual plot from the
...
of figure[73](#org380e48c) displays the residual plot results from the model
...
Figure [75](#org8dafc11) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org3387ffd), the magnitude of the
...
[79](#org3821b18) illustrates a typical outlier.  The red solid line is the
...
[79](#org3821b18), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org23a85d7) has
...
[81](#org23a85d7) are the same as the data displayed in figure
[79](#org3821b18), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org3821b18) and
[81](#org23a85d7), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org23a85d7), for a data set with two
...
point. The right-panel of figure [81](#org23a85d7) provides a plot of
...
Figure [83](#org09d0ccb) illustrates the concept of collinearity.
...
Figure [86](#org4d007da) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org4d007da) displays contour
...
Table [11](#org5ab27da) compares the coefficient estimates obtained from two
...
<table id="org5ab27da" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org4a83054) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org20320fd) provides an example of KNN regression with data
...
Figure [93](#orgd565cae) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgd565cae)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org20320fd) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org9883eff) examines the relative performances of least squares
...
Figure [97](#orgd25f803) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org9883eff), except that we have added additional *noise*
...
In figure [110](#org0f2df66), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org5c84791) we show probability of default as a function of
...
Table [12](#org96a33d8) shows the coefficient estimates and related
...
<table id="org96a33d8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgcb62b2f) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgb863370) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgcb62b2f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgb863370" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgc2b785f) shows average default rates
...
[14](#orgb863370).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org2459ee0), two normal density functions
...
figure [121](#org152395b).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org152395b).  In this situation, the base
...
Figure [123](#org55f7554) shows an example of three equally sized Gaussian
...
[15](#org7f4dc3a), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org58850c2) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org7f4dc3a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org58850c2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org5ecd8d8) illustrates the trade-off that results from
...
Figure [128](#orge031fb5) displays the ROC curve for the LDA classifier on
...
Table [17](#orgd949a5e) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orgd949a5e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org0bf6487) lists many of the popular performance measures that
are used in this context.

<table id="org0bf6487" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orgd949a5e).</caption>
...
Figure [132](#orgb9d8bc4) illustrates the performances of LDA and QDA in two
...
Figure [134](#org51dfda0) illustrates the performances of the four
...
Figure [143](#org321a9ce) displays the *validation set approach*, a simple
...
In figure [145](#org8610b54), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org1b428d0) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org8beec76) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org8beec76) shows nine different 10-fold
...
Figure [151](#orgf0f8a69) illustrates the *k*-fold CV approach.
...
In figure [153](#orgc877f13), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org6fe7dd1),
[23](#org0b438f7), and [25](#orga135499) of chapter [2](#org349800f).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org6fe7dd1) (left), [23](#org0b438f7) (center), and [25](#orga135499) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org815d43f) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orge15f1e1).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orge8d23b9) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orge8d23b9) displays the same three curves
...
Figure [160](#org2832625) illustrates the approach for estimating &alpha; by
...
figure [163](#orga145f70) displays a histogram of the resulting estimates.  The
...
[163](#orga145f70), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org3aef57c).
...
Table [19](#org65b5885) shows first four selected models for the best subset and
...
<table id="org65b5885" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#orgfa2e215) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#orgfa2e215) displays the same ridge
...
[182](#orgf55191f) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgd08c5af), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgd08c5af), as we
...
Figure [186](#org4cbe7fd) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org1ea0521) displays the choice of &lambda; that results from
...
Figure [190](#org2d475f1) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgfb1c2a3), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgfb1c2a3), the left-hand panel has
...
Figure [195](#org1ca4eb9) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orga17463a) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org97cd978) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org2f1f10a) further illustrates the risk of carelessly applying
...
Figure [203](#org41982cf) illustrates the performance of the lasso in a simple
