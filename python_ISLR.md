...
1.  [Introduction](#org3cb3f5c)
2.  [Statistical Learning](#org8f883e9)
    1.  [What is Statistical Learning?](#orgff31ed5)
    2.  [Assessing Model Accuracy](#orgdf60f1c)
    3.  [Lab: Introduction to Python](#org9f8b06a)
        1.  [Basic Commands](#org24d4e7f)
        2.  [Graphics](#orgf72fbaf)
        3.  [Indexing Data](#org5dbae8d)
        4.  [Loading Data](#org046d11e)
        5.  [Additional Graphical and Numerical Summaries](#org99a67b2)
3.  [Linear Regression](#orgce3bb60)
    1.  [Simple Linear Regression](#orgd2faecc)
    2.  [Multiple Linear Regression](#orgb027aba)
    3.  [Other Considerations in the Regression Model](#org2643ba0)
    4.  [The Marketing Plan](#orgf66f9c8)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org8575228)
    6.  [Lab: Linear Regression](#orga581997)
        1.  [Libraries](#orgc796048)
        2.  [Simple Linear Regression](#orgbad8a20)
        3.  [Multiple Linear Regression](#orgfb3556f)
        4.  [Interaction Terms](#orgfd04e70)
        5.  [Non-linear Transformations of the Predictors](#org1a57a7d)
        6.  [Qualitative Predictors](#orga1b6447)
        7.  [Calling `R` from `Python`](#org3fb5bff)
4.  [Classification](#orgfee51a7)
    1.  [An Overview of Classification](#org1c56d44)
    2.  [Why Not Linear Regression?](#org5343039)
    3.  [Logistic Regression](#org620d009)
    4.  [Linear Discriminant Analysis](#org3910dd1)
    5.  [A Comparison of Classification Methods](#org462f725)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org7d929aa)
        1.  [The Stock Market Data](#orgfe9a4e0)
        2.  [Logistc Regression](#org107e552)
        3.  [Linear Discriminant Analysis](#org1951121)
        4.  [Quadratic Discriminant Analysis](#org1fb0121)
        5.  [K-Nearest Neightbors](#orgc1d82ab)
        6.  [An Application to Caravan Insurance Data](#org7098f89)
5.  [Resampling Methods](#org2626d69)
    1.  [Cross-Validation](#org3a2d0ab)
    2.  [The Bootstrap](#org3c5b5b3)
    3.  [Lab: Cross-Validation and the Bootstrap](#org48d79f4)
        1.  [The Validation Set Approach](#org67743d6)
        2.  [Leave-One-Out Cross-Validation](#orge6a9b26)
        3.  [k-Fold Cross-Validation](#org82f5215)
        4.  [The Bootstrap](#orgb84da5f)
6.  [Linear Model Selection and Regularization](#orgd8a94fe)
    1.  [Subset Selection](#orgd380a39)
    2.  [Shrinkage Methods](#org335b67d)
    3.  [Dimension Reduction Methods](#orge8e2cf1)
    4.  [Considerations in High Dimensions](#org659cba2)
    5.  [Lab 1: Subset Selection Methods](#org122804e)
        1.  [Best Subset Selection](#org83154af)
        2.  [Forward and Backward Stepwise Selection](#orge2eb4e1)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org65158e4)
    6.  [Lab 2: Ridge Regression and the Lasso](#org1643c28)
        1.  [Ridge Regression](#org07c504d)
        2.  [The Lasso](#org9e1ec46)
    7.  [Lab 3: PCR and PLS Regression](#org80f1312)
        1.  [Principal Components Regression](#orge9846b8)
        2.  [Partial Least Squares](#org045a73b)
7.  [Moving Beyond Linearity](#orgd533334)
    1.  [Polynomial Regression](#org765b69e)
    2.  [Step Functions](#orgc8063a2)
    3.  [Basis Functions](#orgb051691)
    4.  [Regression Splines](#org887cd9f)
    5.  [Lab: Non-linear Modeling](#org40f6655)
        1.  [Polynomial Regression and Step Functions](#org0ab2b77)
8.  [Tree-Based Models](#org9e717a4)
    1.  [The Basics of Decision Trees](#org0929cd3)
        1.  [Regression Trees](#org7e96f13)
        2.  [Classification Trees](#orgf0bbf16)
        3.  [Trees versus Linear Models](#org937b2b8)
    2.  [Bagging, Random Forests, Boosting](#org6825142)
    3.  [Lab: Decision Trees](#orgb1f72df)
        1.  [Fitting Classification Trees](#orgb78b82e)
        2.  [Fitting Regression Trees](#orgd04a43d)
        3.  [Bagging and Random Forests](#org1a669c0)
        4.  [Boosting](#org285e8c8)
9.  [Support Vector Machines](#org6f45932)
    1.  [Maximal Margin Classifier](#orgdb0b02f)
        1.  [What is a Hyperplane?](#org381d749)
        2.  [Classification Using a Separating Hyperplane](#org24e9f17)
        3.  [The Maximal Margin Classifier](#org1705a05)
        4.  [Construction of the Maximal Margin Classifier](#org8c81500)
        5.  [The Non-separable Case](#orgc86b0b7)
    2.  [Support Vector Classifiers](#org654694b)
        1.  [Overview of the Support Vector Classifier](#orgbfcc47a)
        2.  [Details of the Support Vector Classifier](#org72ee523)
...
Figure [2](#orgc230a60) shows graphs of Wage versus three variables. 
...
Figure [4](#orgeea341d) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orge602e2a) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org1b46f87) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org07eea17) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgd987953) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org07eea17).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org08cb4fe) provides an illustration of the trade-off between
...
Figure [17](#orgfd6df0f) provides a simple illustration of the clustering problem.
...
Figure [21](#org8059d2b) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org8059d2b), we see considerable
...
Figure [23](#org40a3461) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org8059d2b) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orgd9a39a2) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org8059d2b), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org2194c5d) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org8059d2b) - [25](#orgd9a39a2).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orged73016) provides an example using a simulated data set in
...
Figure [31](#org4272766) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orged73016).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orged73016), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orged73016).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org383ea50) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orged73016) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org1f17d33) displays the simple linear regression fit to the
...
In figure [50](#org073b185), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgb4e3c8d) displays *population regression
...
right-hand panel of figure [52](#orgb4e3c8d) we have generated five different
...
For `Advertising` data, table [1](#org4eb1416) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org4eb1416" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org3f32457), we report more information about the least squares model.  

<table id="org3f32457" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org8674072)  shows results of two simple linear
...
<table id="org8674072" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org859d5d8) illustrates an example of the least squares fit to a
...
Table [4](#orgf1887ce) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgf1887ce" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org51b54f3) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgf1887ce). 

<table id="org51b54f3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgd2d38a1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgf1887ce).</caption>
...
Figure [61](#orgb367664) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgeefbe77) records `balance`
...
Table [7](#org11501c1) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org11501c1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgcc0fae3) we see that the estimated `balance` for the
...
<table id="orgcc0fae3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org3a7397c) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org3d48307), the left panel shows least squares lines when
...
<table id="org3a7397c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org3e736cb) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org7283e77) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org7283e77" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org4d0cb1c) displays a residual plot from the
...
of figure[73](#org4d0cb1c) displays the residual plot results from the model
...
Figure [75](#orgfe83ac3) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgec8b4fe), the magnitude of the
...
[79](#org3e5d61c) illustrates a typical outlier.  The red solid line is the
...
[79](#org3e5d61c), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgc5cd5ff) has
...
[81](#orgc5cd5ff) are the same as the data displayed in figure
[79](#org3e5d61c), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org3e5d61c) and
[81](#orgc5cd5ff), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgc5cd5ff), for a data set with two
...
point. The right-panel of figure [81](#orgc5cd5ff) provides a plot of
...
Figure [83](#orgf2eb489) illustrates the concept of collinearity.
...
Figure [86](#orgb72cc17) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgb72cc17) displays contour
...
Table [11](#org2f3b5ae) compares the coefficient estimates obtained from two
...
<table id="org2f3b5ae" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org7ead92f) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orgccadad1) provides an example of KNN regression with data
...
Figure [93](#orgbd03597) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgbd03597)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orgccadad1) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgbf67169) examines the relative performances of least squares
...
Figure [97](#orgf6cd0fa) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgbf67169), except that we have added additional *noise*
...
In figure [110](#org2322d7f), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgbb07dd2) we show probability of default as a function of
...
Table [12](#org587c222) shows the coefficient estimates and related
...
<table id="org587c222" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org028e41d) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org7f93a3a) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org028e41d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org7f93a3a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org4c14bb6) shows average default rates
...
[14](#org7f93a3a).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgb307dc4), two normal density functions
...
figure [121](#org3c89e9a).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org3c89e9a).  In this situation, the base
...
Figure [123](#org4ecb930) shows an example of three equally sized Gaussian
...
[15](#orgc783425), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org353b7bb) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgc783425" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org353b7bb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org30f4122) illustrates the trade-off that results from
...
Figure [128](#org73a7e1e) displays the ROC curve for the LDA classifier on
...
Table [17](#org5494d2f) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org5494d2f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgaebf7ae) lists many of the popular performance measures that
are used in this context.

<table id="orgaebf7ae" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org5494d2f).</caption>
...
Figure [132](#org7f48f00) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgde61104) illustrates the performances of the four
...
Figure [143](#orgfcc3350) displays the *validation set approach*, a simple
...
In figure [145](#org98b738e), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org1bf31be) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orgf3a990b) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orgf3a990b) shows nine different 10-fold
...
Figure [151](#orga4ec11c) illustrates the *k*-fold CV approach.
...
In figure [153](#orgfac5d6d), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org8059d2b),
[23](#org40a3461), and [25](#orgd9a39a2) of chapter [2](#orgb735126).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org8059d2b) (left), [23](#org40a3461) (center), and [25](#orgd9a39a2) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org241d6b8) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orged73016).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org7d32975) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org7d32975) displays the same three curves
...
Figure [160](#org4747920) illustrates the approach for estimating &alpha; by
...
figure [163](#orge8a9c94) displays a histogram of the resulting estimates.  The
...
[163](#orge8a9c94), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org319b42c).
...
Table [19](#org8f7bdd3) shows first four selected models for the best subset and
...
<table id="org8f7bdd3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org8ea153e) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org8ea153e) displays the same ridge
...
[182](#orgd446436) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgac88c8f), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgac88c8f), as we
...
Figure [186](#org3d5e09d) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org45a1ce0) displays the choice of &lambda; that results from
...
Figure [190](#org0f0429e) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org62b14df), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org62b14df), the left-hand panel has
...
Figure [195](#org0f7c7ab) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgfc3edad) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org1fb3932) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgdbd96bb) further illustrates the risk of carelessly applying
...
Figure [203](#org8f1e9b9) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#orgaebc2aa) is a plot of `wage` against
...
The left-hand panel of figure [227](#orgfb9ecd7) shows a fit of step functions
to the `Wage` data from figure [225](#orgaebc2aa).  We also fit the logistic
...
Figure [234](#org3987a8d) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org7c758cb) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org3987a8d).")

Figure [238](#orgb60cf22) shows a five-region example of prediction via
...
Figure [240](#org3e56cc8) is an example of when a linear model or a tree
...
Figure [242](#orgc1432cc) is a graphical representation of *variable
...
Figure [247](#orgc597621) shows a hyperplane in two-dimensional space.
...
Figure [249](#org568a94a) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#org4ffae41), we see that three training observations are
...
[251](#org4ffae41), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#orgb061df8) shows an example where we cannot *exactly* separate the two
...
In figures [255](#org90a8087), addition of a single observation in the right hand panel
