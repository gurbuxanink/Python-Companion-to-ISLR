...
1.  [Introduction](#org2a612eb)
2.  [Statistical Learning](#org0bbf64d)
    1.  [What is Statistical Learning?](#org909069b)
    2.  [Assessing Model Accuracy](#orgc974c68)
    3.  [Lab: Introduction to Python](#org20f1310)
        1.  [Basic Commands](#orgf3c808f)
        2.  [Graphics](#org8671674)
        3.  [Indexing Data](#orgf492794)
        4.  [Loading Data](#orga99a6c4)
        5.  [Additional Graphical and Numerical Summaries](#org22dbb8e)
3.  [Linear Regression](#org6a9dc41)
    1.  [Simple Linear Regression](#org42dd0ac)
    2.  [Multiple Linear Regression](#org82b2200)
    3.  [Other Considerations in the Regression Model](#orgf8d0013)
    4.  [The Marketing Plan](#org59a01bb)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org6e2090b)
    6.  [Lab: Linear Regression](#org74d2689)
        1.  [Libraries](#org741aa17)
        2.  [Simple Linear Regression](#org8576222)
        3.  [Multiple Linear Regression](#org24e89a1)
        4.  [Interaction Terms](#org45daa65)
        5.  [Non-linear Transformations of the Predictors](#org620b4bb)
        6.  [Qualitative Predictors](#orgfe42425)
        7.  [Calling `R` from `Python`](#orgaf99281)
4.  [Classification](#org668cae7)
    1.  [An Overview of Classification](#orgec12dac)
    2.  [Why Not Linear Regression?](#org552568c)
    3.  [Logistic Regression](#orgc8b7b94)
    4.  [Linear Discriminant Analysis](#org38ff480)
    5.  [A Comparison of Classification Methods](#org7f5318d)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org4a44d42)
        1.  [The Stock Market Data](#orgb40b018)
        2.  [Logistc Regression](#org23335e3)
        3.  [Linear Discriminant Analysis](#org3298fec)
        4.  [Quadratic Discriminant Analysis](#org7e1e78f)
        5.  [K-Nearest Neightbors](#org77abae1)
        6.  [An Application to Caravan Insurance Data](#orgc705cb4)
5.  [Resampling Methods](#org65c80d3)
    1.  [Cross-Validation](#orgd089807)
    2.  [The Bootstrap](#org24b26c5)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgdad7904)
        1.  [The Validation Set Approach](#org7dab2d1)
        2.  [Leave-One-Out Cross-Validation](#org9faf095)
        3.  [k-Fold Cross-Validation](#orge54db5f)
        4.  [The Bootstrap](#orge8abc3b)
6.  [Linear Model Selection and Regularization](#org26aaf51)
    1.  [Subset Selection](#org6180c43)
    2.  [Shrinkage Methods](#orge8db856)
    3.  [Dimension Reduction Methods](#org421ecc6)
    4.  [Considerations in High Dimensions](#org82135b3)
    5.  [Lab 1: Subset Selection Methods](#orgd6579d0)
        1.  [Best Subset Selection](#org9794c72)
        2.  [Forward and Backward Stepwise Selection](#org8033ee2)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#orgbeef645)
    6.  [Lab 2: Ridge Regression and the Lasso](#org17cd851)
        1.  [Ridge Regression](#org4c36c26)
        2.  [The Lasso](#org89eff0e)
    7.  [Lab 3: PCR and PLS Regression](#orgacd8f29)
        1.  [Principal Components Regression](#org78cfbd6)
        2.  [Partial Least Squares](#orgab35622)
7.  [Moving Beyond Linearity](#org80a3d1b)
    1.  [Polynomial Regression](#org4033a44)
    2.  [Step Functions](#org77b569f)
    3.  [Basis Functions](#org0387446)
    4.  [Regression Splines](#orgd615646)
    5.  [Lab: Non-linear Modeling](#orgdf474a9)
        1.  [Polynomial Regression and Step Functions](#orgcac57a9)
8.  [Tree-Based Models](#org1294dc1)
    1.  [The Basics of Decision Trees](#orgc54708f)
        1.  [Regression Trees](#org241fbaa)
        2.  [Classification Trees](#org194957d)
        3.  [Trees versus Linear Models](#org218330c)
    2.  [Bagging, Random Forests, Boosting](#org3f7ebba)
    3.  [Lab: Decision Trees](#org2ec273f)
        1.  [Fitting Classification Trees](#org41d90e3)
        2.  [Fitting Regression Trees](#orgd05b345)
        3.  [Bagging and Random Forests](#org8813ea3)
...
Figure [2](#org7422ff4) shows graphs of Wage versus three variables. 
...
Figure [4](#orgcd04306) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org4b64f0a) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org2456ce0) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orgd7cefbc) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org8af9f1f) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orgd7cefbc).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org1a88e74) provides an illustration of the trade-off between
...
Figure [17](#org692a4a9) provides a simple illustration of the clustering problem.
...
Figure [21](#orga06a0fa) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orga06a0fa), we see considerable
...
Figure [23](#orga972e9b) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orga06a0fa) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org9c99431) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orga06a0fa), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgf601935) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orga06a0fa) - [25](#org9c99431).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org67997a0) provides an example using a simulated data set in
...
Figure [31](#orgc11324d) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org67997a0).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org67997a0), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org67997a0).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org208d2fb) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org67997a0) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org2e86d3a) displays the simple linear regression fit to the
...
In figure [50](#org1b34a67), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org01cabc2) displays *population regression
...
right-hand panel of figure [52](#org01cabc2) we have generated five different
...
For `Advertising` data, table [1](#orgb4e438f) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgb4e438f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org0b41850), we report more information about the least squares model.  

<table id="org0b41850" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orge89a5c4)  shows results of two simple linear
...
<table id="orge89a5c4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org9307a1d) illustrates an example of the least squares fit to a
...
Table [4](#org7b745d8) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org7b745d8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org6c1281e) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org7b745d8). 

<table id="org6c1281e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgdfcceb1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org7b745d8).</caption>
...
Figure [61](#org6f57634) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org19208ec) records `balance`
...
Table [7](#org43605d1) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org43605d1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgd78cbbb) we see that the estimated `balance` for the
...
<table id="orgd78cbbb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org5dc9c22) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org771ae5c), the left panel shows least squares lines when
...
<table id="org5dc9c22" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgc35622c) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org63dd18b) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org63dd18b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org61f8e9f) displays a residual plot from the
...
of figure[73](#org61f8e9f) displays the residual plot results from the model
...
Figure [75](#org11ec542) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org00ea1e8), the magnitude of the
...
[79](#org988097e) illustrates a typical outlier.  The red solid line is the
...
[79](#org988097e), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org2299999) has
...
[81](#org2299999) are the same as the data displayed in figure
[79](#org988097e), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org988097e) and
[81](#org2299999), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org2299999), for a data set with two
...
point. The right-panel of figure [81](#org2299999) provides a plot of
...
Figure [83](#orgb80f7a4) illustrates the concept of collinearity.
...
Figure [86](#org7c1d6ab) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org7c1d6ab) displays contour
...
Table [11](#org3767c0d) compares the coefficient estimates obtained from two
...
<table id="org3767c0d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org6cc1198) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orge915bc7) provides an example of KNN regression with data
...
Figure [93](#org554b3a2) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org554b3a2)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orge915bc7) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgb0f7f92) examines the relative performances of least squares
...
Figure [97](#orgac840b1) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgb0f7f92), except that we have added additional *noise*
...
In figure [110](#org29df1d6), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org24ad1e8) we show probability of default as a function of
...
Table [12](#org31df216) shows the coefficient estimates and related
...
<table id="org31df216" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org7067b5a) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org2a6d201) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org7067b5a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org2a6d201" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org7622bc9) shows average default rates
...
[14](#org2a6d201).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org78312db), two normal density functions
...
figure [121](#org31591be).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org31591be).  In this situation, the base
...
Figure [123](#orgbb2d167) shows an example of three equally sized Gaussian
...
[15](#orgb0c90ac), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org83d3543) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgb0c90ac" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org83d3543" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org8189cef) illustrates the trade-off that results from
...
Figure [128](#org110ef6d) displays the ROC curve for the LDA classifier on
...
Table [17](#org3f78438) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org3f78438" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org8f1df05) lists many of the popular performance measures that
are used in this context.

<table id="org8f1df05" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org3f78438).</caption>
...
Figure [132](#orgaa6078e) illustrates the performances of LDA and QDA in two
...
Figure [134](#org5a92bc2) illustrates the performances of the four
...
Figure [143](#org760e9bb) displays the *validation set approach*, a simple
...
In figure [145](#orgb20fd3c), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orga89776c) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org050f7b6) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org050f7b6) shows nine different 10-fold
...
Figure [151](#orgc1b1a9b) illustrates the *k*-fold CV approach.
...
In figure [153](#org9f0c470), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orga06a0fa),
[23](#orga972e9b), and [25](#org9c99431) of chapter [2](#orgafbef78).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orga06a0fa) (left), [23](#orga972e9b) (center), and [25](#org9c99431) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org0434b5b) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org67997a0).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org3578e16) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org3578e16) displays the same three curves
...
Figure [160](#orgbf97dec) illustrates the approach for estimating &alpha; by
...
figure [163](#org6aadf7e) displays a histogram of the resulting estimates.  The
...
[163](#org6aadf7e), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orgece99b1).
...
Table [19](#org20dc638) shows first four selected models for the best subset and
...
<table id="org20dc638" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#orgd635e21) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#orgd635e21) displays the same ridge
...
[182](#org323a794) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org705827d), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org705827d), as we
...
Figure [186](#org27599df) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org0ff808a) displays the choice of &lambda; that results from
...
Figure [190](#org4e54dae) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org35f6916), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org35f6916), the left-hand panel has
...
Figure [195](#org57c942a) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orge31e767) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org2ebe225) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgdbe9dc7) further illustrates the risk of carelessly applying
...
Figure [203](#orgf28bf22) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org5ef248f) is a plot of `wage` against
...
The left-hand panel of figure [227](#org00059c7) shows a fit of step functions
to the `Wage` data from figure [225](#org5ef248f).  We also fit the logistic
...
Figure [234](#org21c874f) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#orgd319c07) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org21c874f).")

Figure [238](#orgf4d0c89) shows a five-region example of prediction via
...
Figure [240](#org41b0b60) is an example of when a linear model or a tree
...
Figure [242](#orga7046f9) is a graphical representation of *variable
