...
-   [1. Introduction](#org39e34df)
-   [2. Statistical Learning](#orgec07cdc)
    -   [2.1. What is Statistical Learning?](#org6f14f2e)
    -   [2.2. Assessing Model Accuracy](#org882e843)
    -   [2.3. Lab: Introduction to Python](#org0498f20)
        -   [2.3.1. Basic Commands](#org374b02c)
        -   [2.3.2. Graphics](#orgcadd26e)
        -   [2.3.3. Indexing Data](#orgb4cee99)
        -   [2.3.4. Loading Data](#orga28033e)
        -   [2.3.5. Additional Graphical and Numerical
            Summaries](#org0539c95)
-   [3. Linear Regression](#org7149a5a)
    -   [3.1. Simple Linear Regression](#org49b4830)
    -   [3.2. Multiple Linear Regression](#orgc70c0c4)
    -   [3.3. Other Considerations in the Regression Model](#org904ba24)
    -   [3.4. The Marketing Plan](#org76e1fd1)
    -   [3.5. Comparison of Linear Regression with K-Nearest
        Neighbors](#org50098cd)
    -   [3.6. Lab: Linear Regression](#orgad2259f)
        -   [3.6.1. Libraries](#org7f0b434)
        -   [3.6.2. Simple Linear Regression](#org13fa9fe)
        -   [3.6.3. Multiple Linear Regression](#org6d2c36c)
        -   [3.6.4. Interaction Terms](#org10b5f72)
        -   [3.6.5. Non-linear Transformations of the
            Predictors](#orgdb7fe74)
        -   [3.6.6. Qualitative Predictors](#orga29aecf)
        -   [3.6.7. Calling `R` from `Python`](#org17cde5c)
-   [4. Classification](#org20f22bc)
    -   [4.1. An Overview of Classification](#org17234a8)
    -   [4.2. Why Not Linear Regression?](#org0eec010)
    -   [4.3. Logistic Regression](#org91ba31c)
    -   [4.4. Linear Discriminant Analysis](#org94c4ad8)
    -   [4.5. A Comparison of Classification Methods](#orgb5e2a37)
    -   [4.6. Lab: Logistic Regression, LDA, QDA, and KNN](#orgaa1e634)
        -   [4.6.1. The Stock Market Data](#orgb881c9a)
        -   [4.6.2. Logistc Regression](#org563b93e)
        -   [4.6.3. Linear Discriminant Analysis](#org9c57cf7)
        -   [4.6.4. Quadratic Discriminant Analysis](#org7ffaec6)
        -   [4.6.5. K-Nearest Neightbors](#orgdd59f91)
        -   [4.6.6. An Application to Caravan Insurance
            Data](#orgdb3adc2)
-   [5. Resampling Methods](#orgbb11817)
    -   [5.1. Cross-Validation](#org7982039)
    -   [5.2. The Bootstrap](#orgeee480d)
:::
:::

::: {#outline-container-org39e34df .outline-2}
[1]{.section-number-2} Introduction {#org39e34df}
-----------------------------------

::: {#text-1 .outline-text-2}
Figure [1](#orgbb969e4) shows graphs of Wage versus three variables.
...
Figure [2](#orgd83c5b7) shows boxplots of previous days\' percentage
...
::: {#outline-container-orgec07cdc .outline-2}
[2]{.section-number-2} Statistical Learning {#orgec07cdc}
-------------------------------------------
...
::: {#outline-container-org6f14f2e .outline-3}
### [2.1]{.section-number-3} What is Statistical Learning? {#org6f14f2e}

::: {#text-2-1 .outline-text-3}
Figure [3](#org2435686) shows scatter plots of `sales` versus `TV`,
...
Figure [4](#org7076f98) is a plot of `Income` versus
...
Figure [5](#orgd0898bb) is a plot of `Income` versus
...
Figure [6](#orgf66af18) shows an example of the parametric approach
...
`Income` data from figure [5](#orgd0898bb). The observations are shown
in red, and the blue plane indicates the least squares fit to the data.
:::

Figure [7](#org0efa80e) provides an illustration of the trade-off
...
Figure [8](#orgd980ac2) provides a simple illustration of the clustering
problem.
...
::: {#outline-container-org882e843 .outline-3}
### [2.2]{.section-number-3} Assessing Model Accuracy {#org882e843}

::: {#text-2-2 .outline-text-3}
Figure [9](#orgaac4d71) illustrates the tradeoff between training MSE
...
When we repeat the simulations for figure [9](#orgaac4d71), we see
...
Figure [10](#orgcac171e) provides another example in which the true
\\(f\\) is approximately linear.

::: {#orgcac171e .figure}
![fig2\_10.png](figures/fig2_10.png)

[Figure 10: ]{.figure-number}Details are as in figure [9](#orgaac4d71)
...
Figure [11](#orgd97141b) displays an example in which \\(f\\) is highly
...
[Figure 11: ]{.figure-number}Details are as in figure [9](#orgaac4d71),
using a different \\(f\\) that is far from linear. In this setting,
linear regression provides a very poor fit to the data.
:::

Figure [12](#org62205ab) displays the relationship between bias,
...
the three data sets in figures [9](#orgaac4d71) - [11](#orgd97141b). The
vertical dotted line indicates the flexibility level corresponding to
the smallest test MSE.
:::

Figure [13](#org4720eb9) provides an example using a simulated data set
...
Figure [14](#orgeaaf8d9) displays the KNN decision boundary, using
\\(K=10\\), when applied to the simulated data set from figure
[13](#org4720eb9). Even though the true distribution is not known by the
...
boundary on the data from figure [13](#org4720eb9), using \\(K = 10\\).
...
figure [13](#org4720eb9). With \\(K=1\\), the decision boundary is
overly flexible, while with \\(K=100\\) it is not sufficiently flexible.
The Bayes decision boundary is shown as dashed line.
:::

In figure [16](#org92e16be) we have plotted the KNN test and training
...
data from figure [13](#org4720eb9) as the level of flexibility (assessed
...
::: {#outline-container-org0498f20 .outline-3}
### [2.3]{.section-number-3} Lab: Introduction to Python {#org0498f20}

::: {#text-2-3 .outline-text-3}
:::

::: {#outline-container-org374b02c .outline-4}
#### [2.3.1]{.section-number-4} Basic Commands {#org374b02c}
...
::: {#outline-container-orgcadd26e .outline-4}
#### [2.3.2]{.section-number-4} Graphics {#orgcadd26e}
...
::: {#outline-container-orgb4cee99 .outline-4}
#### [2.3.3]{.section-number-4} Indexing Data {#orgb4cee99}
...
::: {#outline-container-orga28033e .outline-4}
#### [2.3.4]{.section-number-4} Loading Data {#orga28033e}
...
::: {#outline-container-org0539c95 .outline-4}
#### [2.3.5]{.section-number-4} Additional Graphical and Numerical Summaries {#org0539c95}
...
::: {#outline-container-org7149a5a .outline-2}
[3]{.section-number-2} Linear Regression {#org7149a5a}
----------------------------------------

::: {#text-3 .outline-text-2}
:::

::: {#outline-container-org49b4830 .outline-3}
### [3.1]{.section-number-3} Simple Linear Regression {#org49b4830}

::: {#text-3-1 .outline-text-3}
Figure [17](#orgfe74807) displays the simple linear regression fit to
...
In figure [18](#org83bf02e), we have computed RSS for a number of values
...
The left-hand panel of figure [19](#org2ae10f6) displays *population
...
figure [19](#org2ae10f6) we have generated five different data sets from
...
For `Advertising` data, table [1](#orgfb932b8) provides details of the
...
Next, in table [2](#org5b68649), we report more information about the
least squares model.
...
::: {#outline-container-orgc70c0c4 .outline-3}
### [3.2]{.section-number-3} Multiple Linear Regression {#orgc70c0c4}

::: {#text-3-2 .outline-text-3}
Table [3](#org0202622) shows results of two simple linear regressions,
...
Figure [20](#org675792b) illustrates an example of the least squares fit
...
Table [4](#org4b1cf5b) displays multiple regression coefficient
...
Table [5](#orgc3d6fa4) shows the correlation matrix for the three
predictor variables and response variable in table [4](#org4b1cf5b).
  ...
  about this model was displayed in table [4](#org4b1cf5b).

Figure [21](#org587104c) displays a three-dimensional plot of `TV` and
`radio` versus `sales`.
...
::: {#outline-container-org904ba24 .outline-3}
### [3.3]{.section-number-3} Other Considerations in the Regression Model {#org904ba24}

::: {#text-3-3 .outline-text-3}
`Credit` data set displayed in figure [22](#org6324a96) records
...
Table [7](#org7d8ed20) displays the coefficient estimates and other
...
From table [8](#orged26260) we see that the estimated `balance` for the
...
Table [9](#orga6c5179) shows results of regressing `sales` and `TV` and
`radio` when an interaction term is included. Coefficient of interaction
term `TV:radio` is highly significant.

In figure [23](#orgcf1e633), the left panel shows least squares lines
...
Figure [24](#org904506f) shows a scatter plot of `mpg` (gas mileage in
...
Table [10](#orgcc903a0) shows regression results of a quadratic fit to
...
The left panel of figure [25](#org7b7600b) displays a residual plot from
...
contrast, the right hand panel of figure[25](#org7b7600b) displays the
...
Figure [26](#org41cd538) provides an illustration of correlations among
...
In the left-hand panel of figure [27](#orga825b88), the magnitude of the
...
[28](#org35edb56) illustrates a typical outlier. The red solid line is
...
of figure [28](#org35edb56), the outlier is clearly visible. In
...
Observation 41 in the left-hand panel in figure [29](#org768f66f) has
...
[29](#org768f66f) are the same as the data displayed in figure
[28](#org35edb56), except for the addition of a single high leverage
...
of figures [28](#org35edb56) and [29](#org768f66f), we observe that
...
of figure [29](#org768f66f), for a data set with two predictors
...
of figure [29](#org768f66f) provides a plot of studentized residuals
...
Figure [30](#org6e90f49) illustrates the concept of collinearity.
...
Figure [31](#org4c60c66) illustrates some of the difficulties that can
...
In contrast, the right hand panel of figure [31](#org4c60c66) displays
...
Table [11](#orgf3cd3d5) compares the coefficient estimates obtained from
...
::: {#outline-container-org76e1fd1 .outline-3}
### [3.4]{.section-number-3} The Marketing Plan {#org76e1fd1}
:::

::: {#outline-container-org50098cd .outline-3}
### [3.5]{.section-number-3} Comparison of Linear Regression with K-Nearest Neighbors {#org50098cd}

::: {#text-3-5 .outline-text-3}
Figure [32](#org339c097) illustrates two KNN fits on a data set with
...
Figure [33](#orge93942b) provides an example of KNN regression with data
...
Figure [34](#org9ee89be) represents the linear regression fit to the
same data. It is almost perfect. The right hand panel of figure
[34](#org9ee89be) reveals that linear regression outperforms KNN for
...
[33](#orge93942b) is investigated further. Left: The blue dashed line is
...
Figure [35](#orgcf23719) examines the relative performances of least
...
Figure [36](#org7be0a2f) considers the same strongly non-linear
situation as in the lower panel of figure [35](#orgcf23719), except that
...
variable, as in the lower panel in figure [35](#orgcf23719), and does
...
::: {#outline-container-orgad2259f .outline-3}
### [3.6]{.section-number-3} Lab: Linear Regression {#orgad2259f}

::: {#text-3-6 .outline-text-3}
:::

::: {#outline-container-org7f0b434 .outline-4}
#### [3.6.1]{.section-number-4} Libraries {#org7f0b434}
...
::: {#outline-container-org13fa9fe .outline-4}
#### [3.6.2]{.section-number-4} Simple Linear Regression {#org13fa9fe}
...
::: {#outline-container-org6d2c36c .outline-4}
#### [3.6.3]{.section-number-4} Multiple Linear Regression {#org6d2c36c}
...
::: {#outline-container-org10b5f72 .outline-4}
#### [3.6.4]{.section-number-4} Interaction Terms {#org10b5f72}
...
::: {#outline-container-orgdb7fe74 .outline-4}
#### [3.6.5]{.section-number-4} Non-linear Transformations of the Predictors {#orgdb7fe74}
...
::: {#outline-container-orga29aecf .outline-4}
#### [3.6.6]{.section-number-4} Qualitative Predictors {#orga29aecf}
...
::: {#outline-container-org17cde5c .outline-4}
#### [3.6.7]{.section-number-4} Calling `R` from `Python` {#org17cde5c}
...
::: {#outline-container-org20f22bc .outline-2}
[4]{.section-number-2} Classification {#org20f22bc}
-------------------------------------

::: {#text-4 .outline-text-2}
:::

::: {#outline-container-org17234a8 .outline-3}
### [4.1]{.section-number-3} An Overview of Classification {#org17234a8}

::: {#text-4-1 .outline-text-3}
In figure [37](#org9e64c89), we have plotted annual `income` and monthly
...
::: {#outline-container-org0eec010 .outline-3}
### [4.2]{.section-number-3} Why Not Linear Regression? {#org0eec010}
:::

::: {#outline-container-org91ba31c .outline-3}
### [4.3]{.section-number-3} Logistic Regression {#org91ba31c}

::: {#text-4-3 .outline-text-3}
Using `Default` data set, in figure [38](#orgfb4a13d) we show
...
Table [12](#org351f87f) shows the coefficient estimates and related
...
Table [13](#orga41c99f) shows the results of logistic model where
`default` is a function of the qualitative variable `student`.

Table [14](#orga42d3ed) shows the coefficient estimates for a logistic
...
The left hand panel of figure [39](#orgbc59fb0) shows average default
...
student in table [14](#orga42d3ed). But the horizontal lines near the
...
::: {#outline-container-org94c4ad8 .outline-3}
### [4.4]{.section-number-3} Linear Discriminant Analysis {#org94c4ad8}

::: {#text-4-4 .outline-text-3}
In the left panel of figure [40](#org0124554), two normal density
...
shown in figure [41](#org6ed9c95). In the upper panel, the height of the
...
in the right-hand panel of figure [41](#org6ed9c95). In this situation,
...
Figure [42](#org52b1c64) shows an example of three equally sized
...
[15](#org79a54ee), is a convenient way to display prediction of default
in comparison to true default. Table [16](#orga0a9a43) shows the error
...
Figure [43](#org4d0e470) illustrates the trade-off that results from
...
Figure [44](#org5da5301) displays the ROC curve for the LDA classifier
...
Table [17](#orgd1260dc) shows the possible results when applying a
...
Table [18](#orgc2c170b) lists many of the popular performance measures
...
Figure [45](#org1c62fa4) illustrates the performances of LDA and QDA in
...
::: {#outline-container-orgb5e2a37 .outline-3}
### [4.5]{.section-number-3} A Comparison of Classification Methods {#orgb5e2a37}

::: {#text-4-5 .outline-text-3}
Figure [46](#org830c8e5) illustrates the performances of the four
...
::: {#outline-container-orgaa1e634 .outline-3}
### [4.6]{.section-number-3} Lab: Logistic Regression, LDA, QDA, and KNN {#orgaa1e634}

::: {#text-4-6 .outline-text-3}
:::

::: {#outline-container-orgb881c9a .outline-4}
#### [4.6.1]{.section-number-4} The Stock Market Data {#orgb881c9a}
...
::: {#outline-container-org563b93e .outline-4}
#### [4.6.2]{.section-number-4} Logistc Regression {#org563b93e}
...
::: {#outline-container-org9c57cf7 .outline-4}
#### [4.6.3]{.section-number-4} Linear Discriminant Analysis {#org9c57cf7}
...
::: {#outline-container-org7ffaec6 .outline-4}
#### [4.6.4]{.section-number-4} Quadratic Discriminant Analysis {#org7ffaec6}
...
::: {#outline-container-orgdd59f91 .outline-4}
#### [4.6.5]{.section-number-4} K-Nearest Neightbors {#orgdd59f91}
...
::: {#outline-container-orgdb3adc2 .outline-4}
#### [4.6.6]{.section-number-4} An Application to Caravan Insurance Data {#orgdb3adc2}
...
::: {#outline-container-orgbb11817 .outline-2}
[5]{.section-number-2} Resampling Methods {#orgbb11817}
-----------------------------------------

::: {#text-5 .outline-text-2}
:::

::: {#outline-container-org7982039 .outline-3}
### [5.1]{.section-number-3} Cross-Validation {#org7982039}

::: {#text-5-1 .outline-text-3}
Figure [47](#org1515ff1) displays the *validation set approach*, a
simple stategy to estimate the test error associated with fitting a
particular statistical learning method on a set of observations.

::: {#org1515ff1 .figure}
![fig5\_1.png](figures/fig5_1.png)

[Figure 47: ]{.figure-number}A schematic display of the validation set
approach. A set of \\(n\\) observations are randomly split into a
training set (shown in blue, containing observations 7, 22, and 13,
among others) and a validation set (shown in red, and containing
observation 91, among others). The statistical learning method is fit on
the training set, and its performance is evaluated on the validation
set.
:::

In figure [48](#orge407d5e), the left-hand panel shows validation sample
MSE as a function of polynomial order for which a regression model was
fit on training sample. The two samples are obtained by randomly
splitting `Auto` data set into two data sets of 196 observations each.
The right-hand panel shows the results of repeating this exercise 10
times, each time with a different random split of the observations into
training and validation sets. The model with a quadratic term has a
lower MSE compared to the model with only a linear term. There is not
much benefit from adding cubic or higher order polynomial terms in the
regression model.

::: {#orge407d5e .figure}
![fig5\_2.png](figures/fig5_2.png)

[Figure 48: ]{.figure-number}The validation set approach was used in the
`Auto` data set in order to estimate the test error that results from
predicting `mpg` using polynomial functions of `horsepower`. Left:
Validation error estimates for a single split into training and
validation data sets. Right: The validatioin method was repeated ten
times, each time using a different random split of the observations into
a training set and a validation set. This illustrates the variability of
of the estimated test MSE that results from this approach.
:::

Figure [49](#org356f3df) displas the Leave One Out Cross Validation
(LOOCV) approach.

::: {#org356f3df .figure}
![fig5\_3.png](figures/fig5_3.png)

[Figure 49: ]{.figure-number}A schematic display of LOOCV. A set of
\\(n\\) data points is repeatedly split into a training set (shown in
blue) containing all but one observation, and a validation set that
contains only that observation (shown in red). The test error is then
estimated by averaging the n resulting MSE\'s. The first training set
contains all but observation 1, the second training set contains all but
observation 2, and so on.
:::

The left-hand panel of figure [50](#orgddeb158) shows test set MSE as a
function of polynomial degree when LOOCV is used on the `Auto` data set.
We fit linear regression models to predict `mpg` using polynomial
functions of `horsepower`. The right-hand panel of figure
[50](#orgddeb158) shows nine different 10-fold CV estimates for the
`Auto` data set, each resulting from a different random split of the
observations into ten folds.

::: {#orgddeb158 .figure}
![fig5\_4.png](figures/fig5_4.png)

[Figure 50: ]{.figure-number}Cross-validation was used in the `Auto`
data set in order to estimate the test error that results from
predicting `mpg` using polynomial functions of `horsepower`. Left: The
LOOCV error curve. Right: 10-fold CV was run nin separate times, each
with a different random split of the data into ten parts. The figure
shows the nine slightly different CV error curves.
:::

Figure [51](#org93ad549) illustrates the *k*-fold CV approach.

::: {#org93ad549 .figure}
![fig5\_5.png](figures/fig5_5.png)

[Figure 51: ]{.figure-number}A schematic display of 5-fold CV. A set of
\\(n\\) observations is randomly split into five non-overlapping groups.
Each of these fifths acts as a validation set (shown in red), and the
remainder as a training set (shown in blue). The test error is estimated
by averaging the five resulting MSE estimates.
:::

In figure [52](#org8e28ba2), we plot the cross-validation estimates and
true test error rates that result from fitting least squares polynomials
to the simulated data sets illustrated in figures [9](#orgaac4d71),
[10](#orgcac171e), and [11](#orgd97141b) of chapter [2](#orge46d814). In
all three plots, the two cross validation errors are very similar.

::: {#org8e28ba2 .figure}
![fig5\_6.png](figures/fig5_6.png)

[Figure 52: ]{.figure-number}True and estimated test MSE for the
simulated data sets in Figures [9](#orgaac4d71) (left),
[10](#orgcac171e) (center), and [11](#orgd97141b) (right). The true test
MSE is shown in blue, the LOOCV estimate is shown in black dashed line,
and the 10-fold CV estimate is shown in red dotted line.
:::

Figure [53](#orga8c92cb) shows Bayesian decision boundary (blue dashed
line) and logistic regression decision boundary (black line) for 1- to
4-degree polynomials on \\(X\_1\\) and \\(X\_2\\).

::: {#orga8c92cb .figure}
![fig5\_7.png](figures/fig5_7.png)

[Figure 53: ]{.figure-number}Logistic regression fits on the
two-dimensional classification data displayed in figure
[13](#org4720eb9). The Bayes decision boundary is represented using a
blue dashed line. Estimated decision boundaries from linear, quadratic,
cubic, and quartic (degrees 1-4) logistic regressions are displayed in
black.
:::

The left-hand panel of figure [54](#org1480e6e) displays in black
10-fold CV error rates that result from fitting ten logistic regression
models to the data, using polynomial functions of the predictors up to
tenth order. The true test errors are shown in red, and the training
errors are shown in blue. The training error tends to decrease as the
flexibility of the fit increases. The test error is higher than training
error. The 10-fold CV error rate is a close approximation to the test
error rate.

The right-hand panel of figure [54](#org1480e6e) displays the same three
curves using the KNN approach for classification, as a function of the
value of *K* (the number of neighbors used in the KNN classifier).
Again, the training error rate declines as the method becomes more
flexible, and so we see that the training error rate cannot be used to
select the optimal value of *K*.

::: {#org1480e6e .figure}
![fig5\_8.png](figures/fig5_8.png)

[Figure 54: ]{.figure-number}Test error (red), training error(blue), and
10-fold CV error (black) on the two-dimensional classification data
displayed in [53](#orga8c92cb). Left: Logistic regression using
polynomial functions of the predictors. The order of the polynomials
used is displayed on the x-axis. Right: The KNN classifier with
different values of K, the number of neighbors used in the KNN
classifier.
:::
:::
:::

::: {#outline-container-orgeee480d .outline-3}
### [5.2]{.section-number-3} The Bootstrap {#orgeee480d}
:::
:::
