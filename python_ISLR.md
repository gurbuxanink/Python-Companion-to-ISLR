...
1.  [Introduction](#orgad7e5ea)
2.  [Statistical Learning](#orgbca1c27)
    1.  [What is Statistical Learning?](#orgf497303)
    2.  [Assessing Model Accuracy](#orgd5462e0)
    3.  [Lab: Introduction to Python](#org8257353)
        1.  [Basic Commands](#org6ce2a2d)
        2.  [Graphics](#org10e97fe)
        3.  [Indexing Data](#org4b2c335)
        4.  [Loading Data](#orgd016f3b)
        5.  [Additional Graphical and Numerical Summaries](#org1e08c12)
3.  [Linear Regression](#org5c28445)
    1.  [Simple Linear Regression](#org6a52919)
    2.  [Multiple Linear Regression](#org1344461)
    3.  [Other Considerations in the Regression Model](#orgde7e514)
    4.  [The Marketing Plan](#org7094e66)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orgd4747c6)
    6.  [Lab: Linear Regression](#org4220fc4)
        1.  [Libraries](#orgbbdcc36)
        2.  [Simple Linear Regression](#org257c807)
        3.  [Multiple Linear Regression](#org92f713f)
        4.  [Interaction Terms](#org66ba2e9)
        5.  [Non-linear Transformations of the Predictors](#org5f7e804)
        6.  [Qualitative Predictors](#org55aeb22)
        7.  [Calling `R` from `Python`](#org62e07a4)
4.  [Classification](#org1f15bbf)
    1.  [An Overview of Classification](#org2d36f79)
    2.  [Why Not Linear Regression?](#orgc4e8be1)
    3.  [Logistic Regression](#org245b42f)
    4.  [Linear Discriminant Analysis](#org8543182)
    5.  [A Comparison of Classification Methods](#orge883a04)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org42f833a)
        1.  [The Stock Market Data](#orgae2e751)
        2.  [Logistc Regression](#org4f9cb66)
        3.  [Linear Discriminant Analysis](#org3f438c5)
        4.  [Quadratic Discriminant Analysis](#org742f7fb)
        5.  [K-Nearest Neightbors](#orgb762cd4)
        6.  [An Application to Caravan Insurance Data](#org8c801ee)
5.  [Resampling Methods](#org730390e)
    1.  [Cross-Validation](#orgaa77a16)
    2.  [The Bootstrap](#org6845a91)
    3.  [Lab: Cross-Validation and the Bootstrap](#org43e3641)
        1.  [The Validation Set Approach](#org3667d30)
        2.  [Leave-One-Out Cross-Validation](#org5432c51)
        3.  [k-Fold Cross-Validation](#org5737905)
        4.  [The Bootstrap](#orge155876)
6.  [Linear Model Selection and Regularization](#org68def52)
    1.  [Subset Selection](#orgead922c)
    2.  [Shrinkage Methods](#org474d3ce)
    3.  [Dimension Reduction Methods](#orgc16749a)
    4.  [Considerations in High Dimensions](#org2dacb31)
    5.  [Lab 1: Subset Selection Methods](#org7a1fc6d)
        1.  [Best Subset Selection](#orgda863d5)
        2.  [Forward and Backward Stepwise Selection](#org6a3c37e)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org4729f62)
    6.  [Lab 2: Ridge Regression and the Lasso](#org33baa68)
        1.  [Ridge Regression](#org50dff54)
        2.  [The Lasso](#org28d2919)
    7.  [Lab 3: PCR and PLS Regression](#org5f942ec)
        1.  [Principal Components Regression](#org3a8b1d2)
        2.  [Partial Least Squares](#orgab53e6e)
7.  [Moving Beyond Linearity](#orgdde90c8)
    1.  [Polynomial Regression](#orgaa95d30)
    2.  [Step Functions](#org65f6a7c)
    3.  [Basis Functions](#org8c4c9dc)
    4.  [Regression Splines](#orga3dadaa)
    5.  [Lab: Non-linear Modeling](#orgeb4cfa6)
        1.  [Polynomial Regression and Step Functions](#org32bdb96)
8.  [Tree-Based Models](#org1fa006e)
    1.  [The Basics of Decision Trees](#org6ffd2e6)
        1.  [Regression Trees](#org4d05484)
...
Figure [2](#orgb4569cf) shows graphs of Wage versus three variables. 
...
Figure [4](#org10e0579) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org72e8904) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org787fd26) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org17d5dbc) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org3ecb756) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org17d5dbc).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org794a084) provides an illustration of the trade-off between
...
Figure [17](#org9be82a2) provides a simple illustration of the clustering problem.
...
Figure [21](#orgae3fcae) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgae3fcae), we see considerable
...
Figure [23](#org969956a) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgae3fcae) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org5efbdc4) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgae3fcae), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgcd9ad14) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgae3fcae) - [25](#org5efbdc4).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org7e7c670) provides an example using a simulated data set in
...
Figure [31](#org8738f0d) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org7e7c670).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org7e7c670), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org7e7c670).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgbfcb0c6) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org7e7c670) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org269a4dc) displays the simple linear regression fit to the
...
In figure [50](#orgcfeb6e7), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgd132d5d) displays *population regression
...
right-hand panel of figure [52](#orgd132d5d) we have generated five different
...
For `Advertising` data, table [1](#org5205050) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org5205050" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org783fa11), we report more information about the least squares model.  

<table id="org783fa11" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org3f978e8)  shows results of two simple linear
...
<table id="org3f978e8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#orgd9b3ca0) illustrates an example of the least squares fit to a
...
Table [4](#orgd00ee0a) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgd00ee0a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orge7475ad) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgd00ee0a). 

<table id="orge7475ad" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org7864dc8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgd00ee0a).</caption>
...
Figure [61](#org819db2d) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org519e6db) records `balance`
...
Table [7](#org52751a9) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org52751a9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org4651e42) we see that the estimated `balance` for the
...
<table id="org4651e42" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org63f4f1f) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org03d2da8), the left panel shows least squares lines when
...
<table id="org63f4f1f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgf54ae48) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgd9a8873) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgd9a8873" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgb9a9518) displays a residual plot from the
...
of figure[73](#orgb9a9518) displays the residual plot results from the model
...
Figure [75](#org464d954) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org3685e06), the magnitude of the
...
[79](#orge8c6a48) illustrates a typical outlier.  The red solid line is the
...
[79](#orge8c6a48), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgccc8a17) has
...
[81](#orgccc8a17) are the same as the data displayed in figure
[79](#orge8c6a48), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orge8c6a48) and
[81](#orgccc8a17), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgccc8a17), for a data set with two
...
point. The right-panel of figure [81](#orgccc8a17) provides a plot of
...
Figure [83](#org43b1338) illustrates the concept of collinearity.
...
Figure [86](#org7721451) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org7721451) displays contour
...
Table [11](#org2f221b9) compares the coefficient estimates obtained from two
...
<table id="org2f221b9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org5097b47) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org52e218e) provides an example of KNN regression with data
...
Figure [93](#org3eac44a) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org3eac44a)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org52e218e) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org6e4c6c0) examines the relative performances of least squares
...
Figure [97](#org06c29ef) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org6e4c6c0), except that we have added additional *noise*
...
In figure [110](#orgd297b7e), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org761fae5) we show probability of default as a function of
...
Table [12](#org5aab564) shows the coefficient estimates and related
...
<table id="org5aab564" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org4858eb5) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org37211f2) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org4858eb5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org37211f2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orga00ff3e) shows average default rates
...
[14](#org37211f2).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org2464b29), two normal density functions
...
figure [121](#org40f1106).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org40f1106).  In this situation, the base
...
Figure [123](#org2a10daf) shows an example of three equally sized Gaussian
...
[15](#orgf31e2c2), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgc6722d7) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgf31e2c2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgc6722d7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org1687d4b) illustrates the trade-off that results from
...
Figure [128](#org1c753eb) displays the ROC curve for the LDA classifier on
...
Table [17](#org7ad4505) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org7ad4505" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org5a0a8b0) lists many of the popular performance measures that
are used in this context.

<table id="org5a0a8b0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org7ad4505).</caption>
...
Figure [132](#org7844687) illustrates the performances of LDA and QDA in two
...
Figure [134](#org5bb7481) illustrates the performances of the four
...
Figure [143](#orgd7c4284) displays the *validation set approach*, a simple
...
In figure [145](#org67e52d2), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org656e30e) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org6ad7a62) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org6ad7a62) shows nine different 10-fold
...
Figure [151](#org0711f31) illustrates the *k*-fold CV approach.
...
In figure [153](#org9b707e5), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgae3fcae),
[23](#org969956a), and [25](#org5efbdc4) of chapter [2](#orgdaa9a92).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgae3fcae) (left), [23](#org969956a) (center), and [25](#org5efbdc4) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orge803693) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org7e7c670).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org874c4e6) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org874c4e6) displays the same three curves
...
Figure [160](#org6001c0f) illustrates the approach for estimating &alpha; by
...
figure [163](#org33bbc3f) displays a histogram of the resulting estimates.  The
...
[163](#org33bbc3f), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orgc13ccc5).
...
Table [19](#orgc4bb6f7) shows first four selected models for the best subset and
...
<table id="orgc4bb6f7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org62c681d) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org62c681d) displays the same ridge
...
[182](#orge8651c1) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org0350ec7), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org0350ec7), as we
...
Figure [186](#orgba5d7a4) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org326ef13) displays the choice of &lambda; that results from
...
Figure [190](#org316f786) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orga3deb2f), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orga3deb2f), the left-hand panel has
...
Figure [195](#org29fedc0) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org33a6e17) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org6c7f46c) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgd1bef7c) further illustrates the risk of carelessly applying
...
Figure [203](#org4081d50) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#orgf9bcfd1) is a plot of `wage` against
...
The left-hand panel of figure [227](#org886e0e9) shows a fit of step functions
to the `Wage` data from figure [225](#orgf9bcfd1).  We also fit the logistic
...
Figure [234](#org10ecede) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#orgc31a8c3) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org10ecede).")

Figure [238](#orgfa60fb0) shows a five-region example of prediction via
