...
1.  [Introduction](#org2371ad2)
2.  [Statistical Learning](#org46c364d)
    1.  [What is Statistical Learning?](#orgb02b42e)
    2.  [Assessing Model Accuracy](#orgcc8341e)
    3.  [Lab: Introduction to Python](#org32391bb)
        1.  [Basic Commands](#orgf559802)
        2.  [Graphics](#org4c15e14)
        3.  [Indexing Data](#org0095d62)
        4.  [Loading Data](#org26f4e83)
        5.  [Additional Graphical and Numerical Summaries](#orgcde435a)
3.  [Linear Regression](#org2e766b8)
    1.  [Simple Linear Regression](#orgda7c0a9)
    2.  [Multiple Linear Regression](#org0cf18f4)
    3.  [Other Considerations in the Regression Model](#orgee67a18)
    4.  [The Marketing Plan](#org1b57043)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org68be282)
    6.  [Lab: Linear Regression](#org94ea8d3)
        1.  [Libraries](#org695e46a)
        2.  [Simple Linear Regression](#org653e325)
        3.  [Multiple Linear Regression](#org591f457)
        4.  [Interaction Terms](#org8f33074)
        5.  [Non-linear Transformations of the Predictors](#orgfac07c6)
        6.  [Qualitative Predictors](#org642be54)
        7.  [Calling `R` from `Python`](#org3eefc16)
4.  [Classification](#orgd7309ef)
    1.  [An Overview of Classification](#org991435f)
    2.  [Why Not Linear Regression?](#orga2aac3c)
    3.  [Logistic Regression](#org2b8a3f5)
    4.  [Linear Discriminant Analysis](#org22334f6)
    5.  [A Comparison of Classification Methods](#org8d87523)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org15d86c5)
        1.  [The Stock Market Data](#org9c4b059)
        2.  [Logistc Regression](#org155004a)
        3.  [Linear Discriminant Analysis](#org40b4609)
        4.  [Quadratic Discriminant Analysis](#orgc6fab1a)
        5.  [K-Nearest Neightbors](#orgd6e27f9)
        6.  [An Application to Caravan Insurance Data](#org57fdd56)
5.  [Resampling Methods](#orgc024537)
    1.  [Cross-Validation](#org3c15311)
    2.  [The Bootstrap](#org08fe59c)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgfb157c3)
        1.  [The Validation Set Approach](#orga45661a)
        2.  [Leave-One-Out Cross-Validation](#orgad882c4)
        3.  [k-Fold Cross-Validation](#org255ff96)
        4.  [The Bootstrap](#orgd255640)
6.  [Linear Model Selection and Regularization](#orgfb144e0)
    1.  [Subset Selection](#org47c4e2b)
    2.  [Shrinkage Methods](#org0645af6)
    3.  [Dimension Reduction Methods](#orgb56cdc6)
    4.  [Considerations in High Dimensions](#orga33935f)
    5.  [Lab 1: Subset Selection Methods](#orgb73e4e1)
        1.  [Best Subset Selection](#orgeb4b46a)
        2.  [Forward and Backward Stepwise Selection](#org2ea0fb9)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org5b9d4ca)
    6.  [Lab 2: Ridge Regression and the Lasso](#org893d909)
        1.  [Ridge Regression](#orga6e6462)
        2.  [The Lasso](#org09f8644)
    7.  [Lab 3: PCR and PLS Regression](#org22a13fd)
        1.  [Principal Components Regression](#orgf17cf70)
        2.  [Partial Least Squares](#org853b144)
7.  [Moving Beyond Linearity](#org0c7ad82)
    1.  [Polynomial Regression](#org359503a)
    2.  [Step Functions](#orgdf3edae)
    3.  [Basis Functions](#orgd187396)
    4.  [Regression Splines](#orgb6da6e8)
    5.  [Lab: Non-linear Modeling](#org3e29d5c)
        1.  [Polynomial Regression and Step Functions](#org713f73a)
8.  [Tree-Based Models](#orgc85de6b)
    1.  [The Basics of Decision Trees](#orgaf26236)
        1.  [Regression Trees](#org30e6791)
        2.  [Classification Trees](#orgcccb7cb)
        3.  [Trees versus Linear Models](#orgc03d941)
    2.  [Bagging, Random Forests, Boosting](#orgdfc1ba7)
    3.  [Lab: Decision Trees](#org4da85a7)
        1.  [Fitting Classification Trees](#orgf6df73d)
        2.  [Fitting Regression Trees](#org4a14feb)
        3.  [Bagging and Random Forests](#orgfae20a5)
        4.  [Boosting](#org276dca7)
9.  [Support Vector Machines](#org2f1efc5)
    1.  [Maximal Margin Classifier](#orgef0c36f)
        1.  [What is a Hyperplane?](#orge01d980)
        2.  [Classification Using a Separating Hyperplane](#org5b5a5ae)
        3.  [The Maximal Margin Classifier](#orga2e9737)
...
Figure [2](#orgfcc2f69) shows graphs of Wage versus three variables. 
...
Figure [4](#orga4336fb) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgcbf2c0f) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgaddd838) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org0e898c5) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org4c94986) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org0e898c5).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orgb7f6c4a) provides an illustration of the trade-off between
...
Figure [17](#org3d8983c) provides a simple illustration of the clustering problem.
...
Figure [21](#orgcff15b9) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgcff15b9), we see considerable
...
Figure [23](#org386d035) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgcff15b9) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org38771c9) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgcff15b9), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgd040bba) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgcff15b9) - [25](#org38771c9).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgfaf2294) provides an example using a simulated data set in
...
Figure [31](#org171120f) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgfaf2294).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgfaf2294), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgfaf2294).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org3eb2b57) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orgfaf2294) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org3c05233) displays the simple linear regression fit to the
...
In figure [50](#orgd8afffe), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgb1675a4) displays *population regression
...
right-hand panel of figure [52](#orgb1675a4) we have generated five different
...
For `Advertising` data, table [1](#org9a3b296) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org9a3b296" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orge200852), we report more information about the least squares model.  

<table id="orge200852" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org08edfb4)  shows results of two simple linear
...
<table id="org08edfb4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org373c63a) illustrates an example of the least squares fit to a
...
Table [4](#orgd56a8e1) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgd56a8e1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgd88ebfe) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgd56a8e1). 

<table id="orgd88ebfe" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org7a52e06" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgd56a8e1).</caption>
...
Figure [61](#org462c784) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgbdc00c2) records `balance`
...
Table [7](#org3dadf03) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org3dadf03" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgf00dd0a) we see that the estimated `balance` for the
...
<table id="orgf00dd0a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orgdf2e1df) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgf6c673c), the left panel shows least squares lines when
...
<table id="orgdf2e1df" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org9b58fbe) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org828ce9a) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org828ce9a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org36a20f4) displays a residual plot from the
...
of figure[73](#org36a20f4) displays the residual plot results from the model
...
Figure [75](#org424f863) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org0797e19), the magnitude of the
...
[79](#orgd15c381) illustrates a typical outlier.  The red solid line is the
...
[79](#orgd15c381), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgb48ac55) has
...
[81](#orgb48ac55) are the same as the data displayed in figure
[79](#orgd15c381), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgd15c381) and
[81](#orgb48ac55), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgb48ac55), for a data set with two
...
point. The right-panel of figure [81](#orgb48ac55) provides a plot of
...
Figure [83](#orgeaf31cb) illustrates the concept of collinearity.
...
Figure [86](#org608d1f1) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org608d1f1) displays contour
...
Table [11](#orgc9ba3d5) compares the coefficient estimates obtained from two
...
<table id="orgc9ba3d5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org2e7972c) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org373962f) provides an example of KNN regression with data
...
Figure [93](#org15435a8) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org15435a8)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org373962f) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org34a0929) examines the relative performances of least squares
...
Figure [97](#org5e8e597) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org34a0929), except that we have added additional *noise*
...
In figure [110](#org6542b18), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org1ddf6fb) we show probability of default as a function of
...
Table [12](#org18fb587) shows the coefficient estimates and related
...
<table id="org18fb587" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org5eacc78) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgd64982a) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org5eacc78" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgd64982a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org0a2f3db) shows average default rates
...
[14](#orgd64982a).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org4b697db), two normal density functions
...
figure [121](#orgdf83a9c).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgdf83a9c).  In this situation, the base
...
Figure [123](#org9cf96d2) shows an example of three equally sized Gaussian
...
[15](#org4a2cd71), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgdda1c9b) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org4a2cd71" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgdda1c9b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org143f067) illustrates the trade-off that results from
...
Figure [128](#orgf8abef0) displays the ROC curve for the LDA classifier on
...
Table [17](#org30ed351) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org30ed351" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgc785c52) lists many of the popular performance measures that
are used in this context.

<table id="orgc785c52" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org30ed351).</caption>
...
Figure [132](#org84c146e) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgb5755fa) illustrates the performances of the four
...
Figure [143](#orgbb45ccd) displays the *validation set approach*, a simple
...
In figure [145](#org77c8bb4), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orgef79070) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org1975715) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org1975715) shows nine different 10-fold
...
Figure [151](#org651edf7) illustrates the *k*-fold CV approach.
...
In figure [153](#orgc3f7c83), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgcff15b9),
[23](#org386d035), and [25](#org38771c9) of chapter [2](#orgc2612e0).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgcff15b9) (left), [23](#org386d035) (center), and [25](#org38771c9) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org9252ad0) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgfaf2294).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org3668226) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org3668226) displays the same three curves
...
Figure [160](#orgd569993) illustrates the approach for estimating &alpha; by
...
figure [163](#orgada1505) displays a histogram of the resulting estimates.  The
...
[163](#orgada1505), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org2c27148).
...
Table [19](#orgfe2d84d) shows first four selected models for the best subset and
...
<table id="orgfe2d84d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org9ce65dd) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org9ce65dd) displays the same ridge
...
[182](#org6fe9264) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org7a5ae07), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org7a5ae07), as we
...
Figure [186](#org2cd9dcf) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orge9c5f36) displays the choice of &lambda; that results from
...
Figure [190](#org9a8626d) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org18e4e9b), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org18e4e9b), the left-hand panel has
...
Figure [195](#org6f1f857) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org61edf5a) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org4bc757e) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org5b1cc37) further illustrates the risk of carelessly applying
...
Figure [203](#org922b052) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org50c13f8) is a plot of `wage` against
...
The left-hand panel of figure [227](#org7837c08) shows a fit of step functions
to the `Wage` data from figure [225](#org50c13f8).  We also fit the logistic
...
Figure [234](#org0a79b0e) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#orgb01ab7b) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org0a79b0e).")

Figure [238](#org6ce1b66) shows a five-region example of prediction via
...
Figure [240](#orgf212ce4) is an example of when a linear model or a tree
...
Figure [242](#org5f607c5) is a graphical representation of *variable
...
Figure [247](#org31401e7) shows a hyperplane in two-dimensional space.
...
Figure [249](#org58ea5de) shows an example of a separating hyperplane classifier.
