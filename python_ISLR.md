...
1.  [Introduction](#org3a3e8b2)
2.  [Statistical Learning](#org0375953)
    1.  [What is Statistical Learning?](#orgb452917)
    2.  [Assessing Model Accuracy](#org270831c)
    3.  [Lab: Introduction to Python](#org6150d83)
        1.  [Basic Commands](#orgb4a15a5)
        2.  [Graphics](#orga2285cb)
        3.  [Indexing Data](#orge2186e2)
        4.  [Loading Data](#org5b4a080)
        5.  [Additional Graphical and Numerical Summaries](#orgbcbd6d5)
3.  [Linear Regression](#org528f3bd)
    1.  [Simple Linear Regression](#org92868a6)
    2.  [Multiple Linear Regression](#org2383342)
    3.  [Other Considerations in the Regression Model](#org6dd17b1)
    4.  [The Marketing Plan](#org2e4aaf3)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orgbe50148)
    6.  [Lab: Linear Regression](#orgdba11a9)
        1.  [Libraries](#orgee2870e)
        2.  [Simple Linear Regression](#org1c8d447)
        3.  [Multiple Linear Regression](#orgb6e055e)
        4.  [Interaction Terms](#orgf54c839)
        5.  [Non-linear Transformations of the Predictors](#orgd176a45)
        6.  [Qualitative Predictors](#org8ad1641)
        7.  [Calling `R` from `Python`](#org0c42723)
4.  [Classification](#orgdd7b761)
    1.  [An Overview of Classification](#org91e8391)
    2.  [Why Not Linear Regression?](#orge8ffe4c)
    3.  [Logistic Regression](#org325acb3)
    4.  [Linear Discriminant Analysis](#orgf281624)
    5.  [A Comparison of Classification Methods](#org68e0149)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org8312ba6)
        1.  [The Stock Market Data](#org5ce0997)
        2.  [Logistc Regression](#org03aaba5)
        3.  [Linear Discriminant Analysis](#org66525fb)
        4.  [Quadratic Discriminant Analysis](#orgf643942)
        5.  [K-Nearest Neightbors](#org75fdbde)
        6.  [An Application to Caravan Insurance Data](#org9e7d4e2)
5.  [Resampling Methods](#orge9499b9)
    1.  [Cross-Validation](#orge0eb316)
    2.  [The Bootstrap](#org21ea23d)
    3.  [Lab: Cross-Validation and the Bootstrap](#org55d1cc9)
        1.  [The Validation Set Approach](#org63c6cce)
        2.  [Leave-One-Out Cross-Validation](#org1c7406b)
        3.  [k-Fold Cross-Validation](#org95cbe87)
        4.  [The Bootstrap](#org803b756)
6.  [Linear Model Selection and Regularization](#org05e52fd)
    1.  [Subset Selection](#org5fd6a57)
    2.  [Shrinkage Methods](#org3055b75)
    3.  [Dimension Reduction Methods](#org2d3ff69)
    4.  [Considerations in High Dimensions](#org52043fc)
    5.  [Lab 1: Subset Selection Methods](#orgc7c5565)
        1.  [Best Subset Selection](#org067ccad)
        2.  [Forward and Backward Stepwise Selection](#org8ffaedb)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#orgdb96420)
    6.  [Lab 2: Ridge Regression and the Lasso](#orga1927d4)
        1.  [Ridge Regression](#org6d40bf7)
        2.  [The Lasso](#orgc73bc66)
    7.  [Lab 3: PCR and PLS Regression](#orgf62688e)
        1.  [Principal Components Regression](#orgf7b43c6)
        2.  [Partial Least Squares](#org392b35c)
7.  [Moving Beyond Linearity](#org2c8cf78)
    1.  [Polynomial Regression](#org6a5b26c)
    2.  [Step Functions](#orgc26e287)
    3.  [Basis Functions](#org2abf71e)
    4.  [Regression Splines](#org0c10d48)
    5.  [Lab: Non-linear Modeling](#org00dcd4c)
        1.  [Polynomial Regression and Step Functions](#org99aa72a)
8.  [Tree-Based Models](#org4a0789f)
    1.  [The Basics of Decision Trees](#org6ef6c65)
        1.  [Regression Trees](#org589bebe)
        2.  [Classification Trees](#org0736e7e)
        3.  [Trees versus Linear Models](#org98467a2)
    2.  [Bagging, Random Forests, Boosting](#orgf65231c)
    3.  [Lab: Decision Trees](#org0cf9a89)
        1.  [Fitting Classification Trees](#org6d9e13d)
        2.  [Fitting Regression Trees](#org934bdd2)
        3.  [Bagging and Random Forests](#org63d69ff)
        4.  [Boosting](#org45e9fee)
9.  [Support Vector Machines](#orgaaa31c2)
    1.  [Maximal Margin Classifier](#org1b5ae7f)
        1.  [What is a Hyperplane?](#orgd27162a)
        2.  [Classification Using a Separating Hyperplane](#org4cb99ce)
        3.  [The Maximal Margin Classifier](#org3096260)
        4.  [Construction of the Maximal Margin Classifier](#orga25973c)
        5.  [The Non-separable Case](#orgac85d1b)
    2.  [Support Vector Classifiers](#orge265bcd)
        1.  [Overview of the Support Vector Classifier](#orgded0c50)
        2.  [Details of the Support Vector Classifier](#orgc4bf3c9)
    3.  [Support Vector Machines](#org433df2c)
        1.  [Classification with Non-linear Decision Boundaries](#org093a96e)
        2.  [The Support Vector Machine](#orgf44b925)
        3.  [An Application to the Heart Disease Data](#org210fb09)
    4.  [SVMs with More than Two Classes](#org6fc7b5f)
        1.  [One-Versus-One Classification](#org6af8395)
        2.  [One-Versus-All Classification](#org0781c3f)
    5.  [Relationship with Logistic Regression](#orgf020dab)
    6.  [Lab: Support Vector Machines](#org6705905)
        1.  [Support Vector Classifier](#org130d66e)
        2.  [Support Vector Machine](#org7eb4729)
        3.  [ROC Curves](#org22f10e7)
        4.  [SVM with Multiple Classes](#org695c8cd)
        5.  [Application to Gene Expression Data](#org4dae69c)
10. [Unsupervised Learning](#orga3d61bb)
    1.  [The Challenge of Unsupervised Learning](#org0e40a8d)
    2.  [Principal Component Analysis](#org047cd1d)
        1.  [What are Principal Components?](#orgf870e2e)
        2.  [Another Interpretation of Principal Components](#orgc77e20a)
        3.  [More on PCA](#org50072d5)
    3.  [Clustering Methods](#org85623ce)
        1.  [K-Means Clustering](#orga17299e)
        2.  [Hierarchical Clustering](#org9eec97e)
...
Figure [2](#org2a121c5) shows graphs of Wage versus three variables. 
...
Figure [4](#org04cac08) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgfd3f394) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org17b2160) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orgcb5f1bf) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org6cfe713) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orgcb5f1bf).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org9f8aaba) provides an illustration of the trade-off between
...
Figure [17](#orgd5e2dfc) provides a simple illustration of the clustering problem.
...
Figure [21](#org79533d4) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org79533d4), we see considerable
...
Figure [23](#org8bda972) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org79533d4) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org8d94c35) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org79533d4), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org1d7b1b3) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org79533d4) - [25](#org8d94c35).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org31b2c06) provides an example using a simulated data set in
...
Figure [31](#org45a55ad) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org31b2c06).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org31b2c06), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org31b2c06).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org89fd504) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org31b2c06) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org766565c) displays the simple linear regression fit to the
...
In figure [50](#org79aa73f), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org7b63f43) displays *population regression
...
right-hand panel of figure [52](#org7b63f43) we have generated five different
...
For `Advertising` data, table [1](#orgf7ea468) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgf7ea468" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgf8eaf92), we report more information about the least squares model.  

<table id="orgf8eaf92" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org881a05e)  shows results of two simple linear
...
<table id="org881a05e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org2d0697b) illustrates an example of the least squares fit to a
...
Table [4](#org36a8e2f) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org36a8e2f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org9f35873) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org36a8e2f). 

<table id="org9f35873" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org5b12c71" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org36a8e2f).</caption>
...
Figure [61](#org5717f67) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgfa747a7) records `balance`
...
Table [7](#orgafb9a24) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgafb9a24" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org8d767cd) we see that the estimated `balance` for the
...
<table id="org8d767cd" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org78405c6) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgcf2a912), the left panel shows least squares lines when
...
<table id="org78405c6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orga6b653c) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgd3f3eb5) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgd3f3eb5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orge6c26ca) displays a residual plot from the
...
of figure[73](#orge6c26ca) displays the residual plot results from the model
...
Figure [75](#org11bdab4) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org2e42493), the magnitude of the
...
[79](#orgb5fe353) illustrates a typical outlier.  The red solid line is the
...
[79](#orgb5fe353), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orge8d0997) has
...
[81](#orge8d0997) are the same as the data displayed in figure
[79](#orgb5fe353), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgb5fe353) and
[81](#orge8d0997), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orge8d0997), for a data set with two
...
point. The right-panel of figure [81](#orge8d0997) provides a plot of
...
Figure [83](#orgff3bd7e) illustrates the concept of collinearity.
...
Figure [86](#orgce8fd5a) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgce8fd5a) displays contour
...
Table [11](#org10f5129) compares the coefficient estimates obtained from two
...
<table id="org10f5129" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org8b98685) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orga8074f6) provides an example of KNN regression with data
...
Figure [93](#org8ecd321) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org8ecd321)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orga8074f6) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org03bbd48) examines the relative performances of least squares
...
Figure [97](#orgc1727bb) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org03bbd48), except that we have added additional *noise*
...
In figure [110](#orgddab8e6), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgc18f8a0) we show probability of default as a function of
...
Table [12](#org123469a) shows the coefficient estimates and related
...
<table id="org123469a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org307c3d0) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orga3740f0) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org307c3d0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orga3740f0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org50b90f4) shows average default rates
...
[14](#orga3740f0).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org0fe8d1f), two normal density functions
...
figure [121](#orgff293ad).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgff293ad).  In this situation, the base
...
Figure [123](#org197a880) shows an example of three equally sized Gaussian
...
[15](#orge1ee4e6), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgf0d8953) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orge1ee4e6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgf0d8953" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgab1d9d0) illustrates the trade-off that results from
...
Figure [128](#org7656260) displays the ROC curve for the LDA classifier on
...
Table [17](#org2b45645) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org2b45645" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org882d756) lists many of the popular performance measures that
are used in this context.

<table id="org882d756" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org2b45645).</caption>
...
Figure [132](#org72fbca1) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgcc1a483) illustrates the performances of the four
...
Figure [143](#orge4ab717) displays the *validation set approach*, a simple
...
In figure [145](#orgbfa00e4), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orgf0e6df1) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orgd5876a6) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orgd5876a6) shows nine different 10-fold
...
Figure [151](#orgeb15f78) illustrates the *k*-fold CV approach.
...
In figure [153](#org43c0678), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org79533d4),
[23](#org8bda972), and [25](#org8d94c35) of chapter [2](#org77d1041).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org79533d4) (left), [23](#org8bda972) (center), and [25](#org8d94c35) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orge0a6ddb) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org31b2c06).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org823e475) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org823e475) displays the same three curves
...
Figure [160](#orgdd15246) illustrates the approach for estimating &alpha; by
...
figure [163](#org807f3ca) displays a histogram of the resulting estimates.  The
...
[163](#org807f3ca), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org637e1c9).
...
Table [19](#org2ef25db) shows first four selected models for the best subset and
...
<table id="org2ef25db" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org91dab95) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org91dab95) displays the same ridge
...
[182](#orga5ddce1) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org2052b2a), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org2052b2a), as we
...
Figure [186](#orgabb0a43) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org371e968) displays the choice of &lambda; that results from
...
Figure [190](#orge405920) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgd3746cb), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgd3746cb), the left-hand panel has
...
Figure [195](#org0deddbc) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgd098361) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org6579bf4) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgd6b1e66) further illustrates the risk of carelessly applying
...
Figure [203](#orgfb423b3) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org97c5156) is a plot of `wage` against
...
The left-hand panel of figure [227](#org41a21e5) shows a fit of step functions
to the `Wage` data from figure [225](#org97c5156).  We also fit the logistic
...
Figure [234](#org5d3e518) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org6a0f6cf) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org5d3e518).")

Figure [238](#org4344875) shows a five-region example of prediction via
...
Figure [240](#org86859d4) is an example of when a linear model or a tree
...
Figure [242](#org2fd6a73) is a graphical representation of *variable
...
Figure [247](#orgcf2f876) shows a hyperplane in two-dimensional space.
...
Figure [249](#org57b8060) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#org73e2d12), we see that three training observations are
...
[251](#org73e2d12), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#org2ac36ee) shows an example where we cannot *exactly* separate the two
...
In figures [255](#orgec799c9), addition of a single observation in the right hand panel
...
Figure [257](#org7ed0c5f) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#org2e0935e) illustrates the width of margin for different values of
...
In figure [261](#org0c75542) consider the data shown in the left panel.  It is clear
...
In figure [263](#org9ffe096), the left-hand panel shows an example of SVM with a
polynomial kernel applied the non-linear data from figure [261](#org0c75542).  The fit
...
![img](figures/fig9_9.png "Left: An SVM with a polynomial kernel of degree 3 is applied to the non-linear data from figure [261](#org0c75542), resulting in a more appropriate decision rule.  Right: An SVM with a radial kernel is applied.  In this example, radial kernel is the most capable of capturing the decision boundary.")
...
In figure [265](#org76aa31a), the left-hand panel displays ROC curves for training set
...
Figure [267](#orgb078d54) compares ROC curves on test observations.  Using default
...
[20](#orge524964) shows loadings of the first two principal components.
Figure [273](#org15643ae) plots the first two principal components of these
data.  The figure represents both the principal component scores and the loading
vectors in a single *biplot* display.

<table id="orge524964" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 20:</span> The principal component loading factors, &phi;<sub>1</sub> and &phi;<sub>2</sub>, for the `USArrests` data.  These are also displayed in figure [273](#org15643ae).</caption>
...
In figure [275](#orgb079c8b), the left-hand panel is the same as figure
[273](#org15643ae), where each variable was first scaled to have mean zero and standard
...
![img](figures/fig10_3.png "Two principal component biplots for `USArrests` data.  Left: Same as figure [273](#org15643ae), with variables scaled to have unit standard deviations.  Right: Principal components using unscaled data.  `Assault` has by far the largest loading on the first principal component because it has the largest variance among the four variables.  In general, it is recommended to scale variables to have standard deviation one.")

In Figure [277](#org1af9c96), the left-hand panel shows the proportion of
...
Figure [279](#org2185e1e) shows the results obtained from performing *K*-means
...
We begin with the simulated data set shown in figure [285](#org4f3644e),
