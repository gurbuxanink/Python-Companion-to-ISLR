...
1.  [Introduction](#orgb334a03)
2.  [Statistical Learning](#orgaf9b261)
    1.  [What is Statistical Learning?](#orgdeaefe5)
    2.  [Assessing Model Accuracy](#orge52aaec)
    3.  [Lab: Introduction to Python](#orgd53c97c)
        1.  [Basic Commands](#org83c35dd)
        2.  [Graphics](#orgef3ba38)
        3.  [Indexing Data](#org9b56fd3)
        4.  [Loading Data](#org784f183)
        5.  [Additional Graphical and Numerical Summaries](#org6376b81)
3.  [Linear Regression](#orge36cebf)
    1.  [Simple Linear Regression](#org584573c)
    2.  [Multiple Linear Regression](#orgbede33d)
    3.  [Other Considerations in the Regression Model](#orga0fb5e5)
    4.  [The Marketing Plan](#orge031a9d)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org7f80bcf)
    6.  [Lab: Linear Regression](#orgbf5b71a)
        1.  [Libraries](#org67fbb8e)
        2.  [Simple Linear Regression](#org944e8c8)
        3.  [Multiple Linear Regression](#org5842650)
        4.  [Interaction Terms](#orge4acee7)
        5.  [Non-linear Transformations of the Predictors](#org160c56a)
        6.  [Qualitative Predictors](#org047d9a6)
        7.  [Calling `R` from `Python`](#orgc43eaa0)
4.  [Classification](#orgdc96ec1)
    1.  [An Overview of Classification](#org1c77271)
    2.  [Why Not Linear Regression?](#org0718863)
    3.  [Logistic Regression](#org8219bf5)
    4.  [Linear Discriminant Analysis](#orgf2786bb)
    5.  [A Comparison of Classification Methods](#org423c156)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgc939335)
        1.  [The Stock Market Data](#org0e5a8d3)
        2.  [Logistc Regression](#org5aa7c9a)
        3.  [Linear Discriminant Analysis](#orgc13333b)
        4.  [Quadratic Discriminant Analysis](#org6e979df)
        5.  [K-Nearest Neightbors](#org470627c)
        6.  [An Application to Caravan Insurance Data](#org90260b8)
5.  [Resampling Methods](#org7d610c0)
    1.  [Cross-Validation](#orgbc5c59c)
    2.  [The Bootstrap](#orgbc1f56c)
    3.  [Lab: Cross-Validation and the Bootstrap](#org0528001)
        1.  [The Validation Set Approach](#org7635d46)
        2.  [Leave-One-Out Cross-Validation](#orgb822e00)
        3.  [k-Fold Cross-Validation](#orgefddedd)
        4.  [The Bootstrap](#orgedaf315)
6.  [Linear Model Selection and Regularization](#org9943386)
    1.  [Subset Selection](#org037bef5)
    2.  [Shrinkage Methods](#orgd1fc05f)
    3.  [Dimension Reduction Methods](#orgb330ac3)
    4.  [Considerations in High Dimensions](#org3dd9170)
    5.  [Lab 1: Subset Selection Methods](#orgaa0a77e)
        1.  [Best Subset Selection](#orgcd4b685)
        2.  [Forward and Backward Stepwise Selection](#org8f3dad0)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org6dbd3f1)
    6.  [Lab 2: Ridge Regression and the Lasso](#org7f6d103)
        1.  [Ridge Regression](#orgbf9517b)
        2.  [The Lasso](#org71bfc05)
    7.  [Lab 3: PCR and PLS Regression](#org88853ae)
        1.  [Principal Components Regression](#org7c00e57)
        2.  [Partial Least Squares](#org27eb0d0)
7.  [Moving Beyond Linearity](#org48023dc)
    1.  [Polynomial Regression](#orgb65270f)
    2.  [Step Functions](#org0a02048)
    3.  [Basis Functions](#orgc10f095)
    4.  [Regression Splines](#org0314eaa)
    5.  [Lab: Non-linear Modeling](#org21c64a6)
        1.  [Polynomial Regression and Step Functions](#orgb34beda)
8.  [Tree-Based Models](#orgd385d08)
    1.  [The Basics of Decision Trees](#orgacfdc3d)
        1.  [Regression Trees](#org70f1518)
        2.  [Classification Trees](#orgebf0be7)
        3.  [Trees versus Linear Models](#org5048874)
    2.  [Bagging, Random Forests, Boosting](#org4483152)
    3.  [Lab: Decision Trees](#orgbba6755)
        1.  [Fitting Classification Trees](#org91f5dfa)
        2.  [Fitting Regression Trees](#org5210cc4)
        3.  [Bagging and Random Forests](#org0cd2424)
...
Figure [2](#orgb8a13f9) shows graphs of Wage versus three variables. 
...
Figure [4](#org2ae925d) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org00d33f2) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgde588a2) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org2973e1b) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org10414f2) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org2973e1b).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orge6b4c45) provides an illustration of the trade-off between
...
Figure [17](#org9800d09) provides a simple illustration of the clustering problem.
...
Figure [21](#orgbc8940c) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgbc8940c), we see considerable
...
Figure [23](#org79c2d8b) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgbc8940c) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orgd79c0cb) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgbc8940c), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgc723c32) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgbc8940c) - [25](#orgd79c0cb).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org78879d1) provides an example using a simulated data set in
...
Figure [31](#orgf23d7bc) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org78879d1).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org78879d1), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org78879d1).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgff2a039) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org78879d1) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org38a28ad) displays the simple linear regression fit to the
...
In figure [50](#org07784e0), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org6e2be3d) displays *population regression
...
right-hand panel of figure [52](#org6e2be3d) we have generated five different
...
For `Advertising` data, table [1](#orge9e51c3) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orge9e51c3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgd9c54ab), we report more information about the least squares model.  

<table id="orgd9c54ab" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org861f26e)  shows results of two simple linear
...
<table id="org861f26e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org25e3d8d) illustrates an example of the least squares fit to a
...
Table [4](#org4ecf60f) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org4ecf60f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgc821562) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org4ecf60f). 

<table id="orgc821562" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgf915d57" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org4ecf60f).</caption>
...
Figure [61](#org569c019) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgf914405) records `balance`
...
Table [7](#org97b0475) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org97b0475" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgcb4f0a6) we see that the estimated `balance` for the
...
<table id="orgcb4f0a6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orgde6b4c9) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgccfc6ae), the left panel shows least squares lines when
...
<table id="orgde6b4c9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org122fbe2) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgd14cd70) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgd14cd70" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org5410a5e) displays a residual plot from the
...
of figure[73](#org5410a5e) displays the residual plot results from the model
...
Figure [75](#orgd397508) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org982ceb3), the magnitude of the
...
[79](#orgbd0d9c8) illustrates a typical outlier.  The red solid line is the
...
[79](#orgbd0d9c8), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org9b938ab) has
...
[81](#org9b938ab) are the same as the data displayed in figure
[79](#orgbd0d9c8), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgbd0d9c8) and
[81](#org9b938ab), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org9b938ab), for a data set with two
...
point. The right-panel of figure [81](#org9b938ab) provides a plot of
...
Figure [83](#orgb689d95) illustrates the concept of collinearity.
...
Figure [86](#orga2884db) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orga2884db) displays contour
...
Table [11](#orge06e499) compares the coefficient estimates obtained from two
...
<table id="orge06e499" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org297d323) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org76b8e7a) provides an example of KNN regression with data
...
Figure [93](#org5896b7d) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org5896b7d)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org76b8e7a) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org9d7fe4b) examines the relative performances of least squares
...
Figure [97](#orga6a5e5f) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org9d7fe4b), except that we have added additional *noise*
...
In figure [110](#org8a7854d), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org66fc696) we show probability of default as a function of
...
Table [12](#orgb54aa8b) shows the coefficient estimates and related
...
<table id="orgb54aa8b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgeb172ef) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org354bf37) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgeb172ef" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org354bf37" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orga4d981f) shows average default rates
...
[14](#org354bf37).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgcadcf64), two normal density functions
...
figure [121](#orgf671407).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgf671407).  In this situation, the base
...
Figure [123](#org91ca80f) shows an example of three equally sized Gaussian
...
[15](#orgc47d828), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org4ef2ac6) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgc47d828" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org4ef2ac6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgea87673) illustrates the trade-off that results from
...
Figure [128](#org067e887) displays the ROC curve for the LDA classifier on
...
Table [17](#orge155835) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orge155835" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orga0d4f2a) lists many of the popular performance measures that
are used in this context.

<table id="orga0d4f2a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orge155835).</caption>
...
Figure [132](#org735770c) illustrates the performances of LDA and QDA in two
...
Figure [134](#org3921098) illustrates the performances of the four
...
Figure [143](#org49df94c) displays the *validation set approach*, a simple
...
In figure [145](#org96a76ce), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orgace9d96) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org8d04148) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org8d04148) shows nine different 10-fold
...
Figure [151](#org11f0b82) illustrates the *k*-fold CV approach.
...
In figure [153](#org6cc7912), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgbc8940c),
[23](#org79c2d8b), and [25](#orgd79c0cb) of chapter [2](#orgc0de111).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgbc8940c) (left), [23](#org79c2d8b) (center), and [25](#orgd79c0cb) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org729ab31) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org78879d1).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org503bd85) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org503bd85) displays the same three curves
...
Figure [160](#org546c179) illustrates the approach for estimating &alpha; by
...
figure [163](#orgae4b7d7) displays a histogram of the resulting estimates.  The
...
[163](#orgae4b7d7), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org602b674).
...
Table [19](#org34ae067) shows first four selected models for the best subset and
...
<table id="org34ae067" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#orgfed437d) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#orgfed437d) displays the same ridge
...
[182](#org43ce08f) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org58709c9), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org58709c9), as we
...
Figure [186](#org301baa9) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org33cfe3d) displays the choice of &lambda; that results from
...
Figure [190](#org15e9320) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org57083fd), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org57083fd), the left-hand panel has
...
Figure [195](#org5417438) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org339a504) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org9371577) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org046c5ee) further illustrates the risk of carelessly applying
...
Figure [203](#org171b317) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#orgff7413c) is a plot of `wage` against
...
The left-hand panel of figure [227](#orgd7720f4) shows a fit of step functions
to the `Wage` data from figure [225](#orgff7413c).  We also fit the logistic
...
Figure [234](#orgd48eee1) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#orgc7c1dff) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#orgd48eee1).")

Figure [238](#orge39bf5f) shows a five-region example of prediction via
...
Figure [240](#org3fdb7f0) is an example of when a linear model or a tree
