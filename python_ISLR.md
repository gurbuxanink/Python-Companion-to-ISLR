...
1.  [Introduction](#org8682fa8)
2.  [Statistical Learning](#orgd66693b)
...
Figure [2](#org1c9e56b) shows graphs of Wage versus three variables. 
...
Figure [4](#org1ee95f6) shows boxplots of previous days' percentage changes in S&P
...
Figure [6](#orgd5647f1) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [8](#org75863b2) is a plot of `Income` versus `Years of Education` from the
...
Figure [10](#org1233712) is a plot of `Income` versus `Years of Education` and
...
Figure [12](#org5acbee0) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [10](#org1233712).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")
