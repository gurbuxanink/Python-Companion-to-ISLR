...
1.  [Introduction](#orgb65e441)
2.  [Statistical Learning](#org9aba7f2)
    1.  [What is Statistical Learning?](#orgde4d732)
    2.  [Assessing Model Accuracy](#org446f478)
    3.  [Lab: Introduction to Python](#org64def09)
        1.  [Basic Commands](#orgcf4b473)
        2.  [Graphics](#org6701570)
        3.  [Indexing Data](#org0336579)
        4.  [Loading Data](#org5c764ad)
        5.  [Additional Graphical and Numerical Summaries](#org16d4e58)
3.  [Linear Regression](#org75c219f)
    1.  [Simple Linear Regression](#orga473d3d)
...
Figure [2](#org1f1275f) shows graphs of Wage versus three variables. 
...
Figure [4](#orgd4584d9) shows boxplots of previous days' percentage changes in S&P
...
Figure [6](#orgc53132d) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [8](#orgc33a7e9) is a plot of `Income` versus `Years of Education` from the
...
Figure [10](#orgef8f223) is a plot of `Income` versus `Years of Education` and
...
Figure [12](#orge01b92a) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [10](#orgef8f223).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [14](#org340608c) provides an illustration of the trade-off between
...
Figure [16](#org59fad3d) provides a simple illustration of the clustering problem.
...
Figure [20](#orgd706ab8) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [20](#orgd706ab8), we see considerable
...
Figure [22](#org08215f5) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [20](#orgd706ab8) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [24](#org137cd3c) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [20](#orgd706ab8), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [26](#org2108d86) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [20](#orgd706ab8) - [24](#org137cd3c).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [28](#org72e8402) provides an example using a simulated data set in
...
Figure [30](#orge50d740) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [28](#org72e8402).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [28](#org72e8402), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [28](#org72e8402).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [33](#org9c9d1d7) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [28](#org72e8402) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [47](#org17fc840) displays the simple linear regression fit to the
...
In figure [49](#orgaf6f1c2), we have computed RSS for a number of values of
...
The left-hand panel of figure [51](#orgee0c00f) displays *population regression
...
right-hand panel of figure [51](#orgee0c00f) we have generated five different
