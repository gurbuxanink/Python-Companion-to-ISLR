...
1.  [Introduction](#orgbaaaab4)
2.  [Statistical Learning](#orgd55bbef)
    1.  [What is Statistical Learning?](#org73ba7e9)
    2.  [Assessing Model Accuracy](#orgd79a6aa)
    3.  [Lab: Introduction to Python](#orgbc297ed)
        1.  [Basic Commands](#org30df3f4)
        2.  [Graphics](#org5578ad3)
        3.  [Indexing Data](#orgcd0b9c3)
        4.  [Loading Data](#org480334b)
        5.  [Additional Graphical and Numerical Summaries](#orgfaec5f7)
3.  [Linear Regression](#org95f33e4)
    1.  [Simple Linear Regression](#org2227222)
    2.  [Multiple Linear Regression](#org0aae156)
    3.  [Other Considerations in the Regression Model](#orgb45665d)
    4.  [The Marketing Plan](#orgccdcb5c)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org9628bd8)
    6.  [Lab: Linear Regression](#org9fcdf2a)
        1.  [Libraries](#org2331a82)
        2.  [Simple Linear Regression](#org445341e)
        3.  [Multiple Linear Regression](#org0941340)
        4.  [Interaction Terms](#org76b36f6)
        5.  [Non-linear Transformations of the Predictors](#org9c5430b)
        6.  [Qualitative Predictors](#org5cadf5c)
        7.  [Calling `R` from `Python`](#org6f93912)
4.  [Classification](#orga1b84b1)
    1.  [An Overview of Classification](#org81007df)
    2.  [Why Not Linear Regression?](#org4db908b)
    3.  [Logistic Regression](#orgd315cc8)
    4.  [Linear Discriminant Analysis](#org84eff29)
    5.  [A Comparison of Classification Methods](#org7228d4e)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org47ae30d)
        1.  [The Stock Market Data](#org266b427)
        2.  [Logistc Regression](#org8de658c)
        3.  [Linear Discriminant Analysis](#org6cae90e)
        4.  [Quadratic Discriminant Analysis](#orgf592f2c)
        5.  [K-Nearest Neightbors](#org3148a86)
        6.  [An Application to Caravan Insurance Data](#org2714d90)
5.  [Resampling Methods](#org26ad3dd)
    1.  [Cross-Validation](#org90afd80)
    2.  [The Bootstrap](#orgfd7e16f)
    3.  [Lab: Cross-Validation and the Bootstrap](#org0026985)
        1.  [The Validation Set Approach](#orgb4f3f06)
        2.  [Leave-One-Out Cross-Validation](#orga0a6442)
        3.  [k-Fold Cross-Validation](#orgee62217)
        4.  [The Bootstrap](#org653c0a8)
6.  [Linear Model Selection and Regularization](#org23a0214)
    1.  [Subset Selection](#orgdf85181)
    2.  [Shrinkage Methods](#org2ba0f7a)
    3.  [Dimension Reduction Methods](#org7bb4421)
    4.  [Considerations in High Dimensions](#org68c941c)
...
Figure [2](#orga3781cb) shows graphs of Wage versus three variables. 
...
Figure [4](#org4c675a8) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org63473f5) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org6a5d5ea) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org10eb973) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org133ba4e) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org10eb973).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org18fd951) provides an illustration of the trade-off between
...
Figure [17](#org9353b30) provides a simple illustration of the clustering problem.
...
Figure [21](#orga935376) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orga935376), we see considerable
...
Figure [23](#org38a23a1) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orga935376) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org2d16cec) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orga935376), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org6b18d1f) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orga935376) - [25](#org2d16cec).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org68ecea8) provides an example using a simulated data set in
...
Figure [31](#org5343e25) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org68ecea8).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org68ecea8), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org68ecea8).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgb67e5b6) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org68ecea8) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org0cf6f68) displays the simple linear regression fit to the
...
In figure [50](#orga58ce9e), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org1713841) displays *population regression
...
right-hand panel of figure [52](#org1713841) we have generated five different
...
For `Advertising` data, table [1](#orgb8ebfb4) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgb8ebfb4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org9b0db0a), we report more information about the least squares model.  

<table id="org9b0db0a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orga5a5722)  shows results of two simple linear
...
<table id="orga5a5722" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org881fd0f) illustrates an example of the least squares fit to a
...
Table [4](#org4780610) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org4780610" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgb170582) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org4780610). 

<table id="orgb170582" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org8f3da9b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org4780610).</caption>
...
Figure [61](#org277a447) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org07c7ccf) records `balance`
...
Table [7](#org81f14c9) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org81f14c9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orge63e143) we see that the estimated `balance` for the
...
<table id="orge63e143" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org5b84615) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org934c329), the left panel shows least squares lines when
...
<table id="org5b84615" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org4c7408c) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgbffafe7) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgbffafe7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org2d56336) displays a residual plot from the
...
of figure[73](#org2d56336) displays the residual plot results from the model
...
Figure [75](#org03a61ca) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org48b2eb6), the magnitude of the
...
[79](#orge069a55) illustrates a typical outlier.  The red solid line is the
...
[79](#orge069a55), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org6024b9e) has
...
[81](#org6024b9e) are the same as the data displayed in figure
[79](#orge069a55), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orge069a55) and
[81](#org6024b9e), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org6024b9e), for a data set with two
...
point. The right-panel of figure [81](#org6024b9e) provides a plot of
...
Figure [83](#org17ad021) illustrates the concept of collinearity.
...
Figure [86](#org04408bb) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org04408bb) displays contour
...
Table [11](#org660c2e3) compares the coefficient estimates obtained from two
...
<table id="org660c2e3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org59da15b) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orga53aadd) provides an example of KNN regression with data
...
Figure [93](#org952c4cd) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org952c4cd)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orga53aadd) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org7e43b26) examines the relative performances of least squares
...
Figure [97](#org1149286) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org7e43b26), except that we have added additional *noise*
...
In figure [110](#org05582af), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org4449750) we show probability of default as a function of
...
Table [12](#orgbb2ca6c) shows the coefficient estimates and related
...
<table id="orgbb2ca6c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org40c44a5) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgc9070d1) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org40c44a5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgc9070d1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org959eb4c) shows average default rates
...
[14](#orgc9070d1).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orga08b50b), two normal density functions
...
figure [121](#orgee23ec9).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgee23ec9).  In this situation, the base
...
Figure [123](#org7cff28f) shows an example of three equally sized Gaussian
...
[15](#org876f7b6), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org3f08c71) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org876f7b6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org3f08c71" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org952e6f4) illustrates the trade-off that results from
...
Figure [128](#orge314524) displays the ROC curve for the LDA classifier on
...
Table [17](#orga1d1b53) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orga1d1b53" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org6f98924) lists many of the popular performance measures that
are used in this context.

<table id="org6f98924" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orga1d1b53).</caption>
...
Figure [132](#org7e08e4e) illustrates the performances of LDA and QDA in two
...
Figure [134](#org4a57002) illustrates the performances of the four
...
Figure [143](#orgbcf6635) displays the *validation set approach*, a simple
...
In figure [145](#orge809a4d), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orga6b3d9d) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org8178c3b) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org8178c3b) shows nine different 10-fold
...
Figure [151](#org65a1f4e) illustrates the *k*-fold CV approach.
...
In figure [153](#orge0d4fcf), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orga935376),
[23](#org38a23a1), and [25](#org2d16cec) of chapter [2](#org0703f55).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orga935376) (left), [23](#org38a23a1) (center), and [25](#org2d16cec) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orgc6be65f) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org68ecea8).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org66049b3) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org66049b3) displays the same three curves
...
Figure [160](#orga629fc7) illustrates the approach for estimating &alpha; by
...
figure [163](#org4a7cb60) displays a histogram of the resulting estimates.  The
...
[163](#org4a7cb60), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org9afe6b2).
...
Table [19](#org8f1c031) shows first four selected models for the best subset and
...
<table id="org8f1c031" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 19:</span> The first four selected models for best subset selection and forward stepwise selection on the `Credit` data set.  The first three models are identical, but the fourth models differ.</caption>
...
In figure [180](#org3825a7f) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org3825a7f) displays the same ridge
...
[182](#orgdabd983) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgafcb38d), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgafcb38d), as we
...
Figure [186](#org41e343f) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgbe4b978) displays the choice of &lambda; that results from
...
Figure [190](#orgebe391e) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgd0e2fb7), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgd0e2fb7), the left-hand panel has
...
Figure [195](#orgcfcd3c3) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgc691e19) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org9c39243) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org76c6c30) further illustrates the risk of carelessly applying
...
Figure [203](#orgf068746) illustrates the performance of the lasso in a simple
