...
1.  [Introduction](#org9a81e33)
2.  [Statistical Learning](#orgf7aeca7)
    1.  [What is Statistical Learning?](#org67436d2)
    2.  [Assessing Model Accuracy](#org705e0f4)
    3.  [Lab: Introduction to Python](#org974189b)
        1.  [Basic Commands](#org1d62391)
        2.  [Graphics](#org7cfece1)
        3.  [Indexing Data](#orge89b557)
        4.  [Loading Data](#org3b2382b)
        5.  [Additional Graphical and Numerical Summaries](#org639e688)
3.  [Linear Regression](#orgc742cba)
    1.  [Simple Linear Regression](#org1785cee)
    2.  [Multiple Linear Regression](#org5665bdf)
    3.  [Other Considerations in the Regression Model](#org7360d3d)
    4.  [The Marketing Plan](#org79f965d)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org8753989)
    6.  [Lab: Linear Regression](#orga1b5431)
        1.  [Libraries](#org7bbb03c)
        2.  [Simple Linear Regression](#org80fe88e)
        3.  [Multiple Linear Regression](#orgffa7a6a)
        4.  [Interaction Terms](#org27f9a4b)
        5.  [Non-linear Transformations of the Predictors](#org4914297)
        6.  [Qualitative Predictors](#orgac66987)
        7.  [Calling `R` from `Python`](#org5cf2034)
4.  [Classification](#org24e670f)
    1.  [An Overview of Classification](#orga32bc2a)
    2.  [Why Not Linear Regression?](#org4746ab9)
    3.  [Logistic Regression](#org6574400)
    4.  [Linear Discriminant Analysis](#org8451797)
    5.  [A Comparison of Classification Methods](#org928545e)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org3bb259a)
        1.  [The Stock Market Data](#orga90b4b6)
        2.  [Logistc Regression](#org45a891b)
        3.  [Linear Discriminant Analysis](#org03e44d0)
        4.  [Quadratic Discriminant Analysis](#org81c923b)
        5.  [K-Nearest Neightbors](#org01b94aa)
        6.  [An Application to Caravan Insurance Data](#org96df39c)
5.  [Resampling Methods](#org1c75d33)
    1.  [Cross-Validation](#orgaeb381c)
    2.  [The Bootstrap](#orga562409)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgc1c3b84)
        1.  [The Validation Set Approach](#orgfd1fa7b)
        2.  [Leave-One-Out Cross-Validation](#org6e6b533)
        3.  [k-Fold Cross-Validation](#org60856d2)
        4.  [The Bootstrap](#orgcbd6fa9)
6.  [Linear Model Selection and Regularization](#org6588d8b)
    1.  [Subset Selection](#org903b1bf)
    2.  [Shrinkage Methods](#orgbf03593)
    3.  [Dimension Reduction Methods](#org6394aeb)
    4.  [Considerations in High Dimensions](#org39ac00d)
    5.  [Lab 1: Subset Selection Methods](#orgb985a54)
        1.  [Best Subset Selection](#orgd3e4750)
        2.  [Forward and Backward Stepwise Selection](#org8ca8a46)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org12b5740)
    6.  [Lab 2: Ridge Regression and the Lasso](#org2346d7a)
        1.  [Ridge Regression](#org8f92454)
        2.  [The Lasso](#orgf5a05d5)
    7.  [Lab 3: PCR and PLS Regression](#orga09130d)
        1.  [Principal Components Regression](#org0f387cc)
        2.  [Partial Least Squares](#orgadb93c7)
...
Figure [2](#org09f1bb0) shows graphs of Wage versus three variables. 
...
Figure [4](#orgcf6bb42) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgf48900a) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org0a1ef08) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org1592456) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org67f0168) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org1592456).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org34016fd) provides an illustration of the trade-off between
...
Figure [17](#org871618e) provides a simple illustration of the clustering problem.
...
Figure [21](#orgb61e7a6) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgb61e7a6), we see considerable
...
Figure [23](#org5e08d71) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgb61e7a6) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org642ba36) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgb61e7a6), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org4e43f30) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgb61e7a6) - [25](#org642ba36).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgc7c32db) provides an example using a simulated data set in
...
Figure [31](#org65d6bb7) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgc7c32db).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgc7c32db), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgc7c32db).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org8b66382) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orgc7c32db) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgf407bba) displays the simple linear regression fit to the
...
In figure [50](#orgfec6145), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org85372c6) displays *population regression
...
right-hand panel of figure [52](#org85372c6) we have generated five different
...
For `Advertising` data, table [1](#org77b53ec) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org77b53ec" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgde1ecea), we report more information about the least squares model.  

<table id="orgde1ecea" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orge697d0d)  shows results of two simple linear
...
<table id="orge697d0d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org0e267e2) illustrates an example of the least squares fit to a
...
Table [4](#orgaed9fd4) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgaed9fd4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org3ea1cfb) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgaed9fd4). 

<table id="org3ea1cfb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org2a19f4b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgaed9fd4).</caption>
...
Figure [61](#org587e06b) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org7c6d159) records `balance`
...
Table [7](#orgaa2d42d) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgaa2d42d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgf16dc35) we see that the estimated `balance` for the
...
<table id="orgf16dc35" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org25292eb) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgc470e29), the left panel shows least squares lines when
...
<table id="org25292eb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org488e4e2) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org3eb22db) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org3eb22db" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org5d94386) displays a residual plot from the
...
of figure[73](#org5d94386) displays the residual plot results from the model
...
Figure [75](#org33e8cce) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgfa8da83), the magnitude of the
...
[79](#org5098f59) illustrates a typical outlier.  The red solid line is the
...
[79](#org5098f59), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org3a2d031) has
...
[81](#org3a2d031) are the same as the data displayed in figure
[79](#org5098f59), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org5098f59) and
[81](#org3a2d031), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org3a2d031), for a data set with two
...
point. The right-panel of figure [81](#org3a2d031) provides a plot of
...
Figure [83](#orgc5b67de) illustrates the concept of collinearity.
...
Figure [86](#orgbc56bf9) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgbc56bf9) displays contour
...
Table [11](#orgdbae3f8) compares the coefficient estimates obtained from two
...
<table id="orgdbae3f8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#orgd29a486) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orgd69dee1) provides an example of KNN regression with data
...
Figure [93](#org665fd32) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org665fd32)
...
Figure [97](#orgd1394a9) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org91f0995), except that we have added additional *noise*
...
In figure [110](#org1d9c678), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orga4eb474) we show probability of default as a function of
...
Table [12](#org5059e68) shows the coefficient estimates and related
...
<table id="org5059e68" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org82106f7) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgb55b342) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org82106f7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgb55b342" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org2f63b1b) shows average default rates
...
[14](#orgb55b342).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgc2bed0c), two normal density functions
...
figure [121](#org7244d6d).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org7244d6d).  In this situation, the base
...
Figure [123](#org2cab6c6) shows an example of three equally sized Gaussian
...
[15](#orgc0c53dc), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orga119540) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgc0c53dc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orga119540" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org662e0a2) illustrates the trade-off that results from
...
Figure [128](#org7fab9ee) displays the ROC curve for the LDA classifier on
...
Table [17](#org90e58d0) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org90e58d0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgd58e26c) lists many of the popular performance measures that
are used in this context.

<table id="orgd58e26c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org90e58d0).</caption>
...
Figure [132](#org9fa0be1) illustrates the performances of LDA and QDA in two
...
Figure [134](#org656ee2d) illustrates the performances of the four
...
Figure [143](#org92da99f) displays the *validation set approach*, a simple
...
In figure [145](#org44fa3e5), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org20c1e52) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orgdfcd281) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orgdfcd281) shows nine different 10-fold
...
Figure [151](#org9e31867) illustrates the *k*-fold CV approach.
...
In figure [153](#org9ad98f9), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgb61e7a6),
[23](#org5e08d71), and [25](#org642ba36) of chapter [2](#orgdff8792).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgb61e7a6) (left), [23](#org5e08d71) (center), and [25](#org642ba36) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orgebfaa06) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgc7c32db).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgb337757) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgb337757) displays the same three curves
...
Figure [160](#org2e77726) illustrates the approach for estimating &alpha; by
...
figure [163](#orgaab483e) displays a histogram of the resulting estimates.  The
...
[163](#orgaab483e), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orgbb4c00f).
...
Table [19](#org2c2375d) shows first four selected models for the best subset and
...
<table id="org2c2375d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org893f071) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org893f071) displays the same ridge
...
[182](#org0a4f298) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgcb06f00), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgcb06f00), as we
...
Figure [186](#orgeab0c5e) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org4837608) displays the choice of &lambda; that results from
...
Figure [190](#org8bc7d33) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org00fa2d7), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org00fa2d7), the left-hand panel has
...
Figure [195](#org6bc21ea) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgd57a744) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orga721908) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org6c96edc) further illustrates the risk of carelessly applying
...
Figure [203](#orgc764d28) illustrates the performance of the lasso in a simple
