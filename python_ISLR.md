...
1.  [Introduction](#org4da3a0a)
2.  [Statistical Learning](#orge1538a6)
    1.  [What is Statistical Learning?](#org1edd8c2)
    2.  [Assessing Model Accuracy](#org26a8af6)
    3.  [Lab: Introduction to Python](#orgc3f58b1)
        1.  [Basic Commands](#orgc48c01a)
        2.  [Graphics](#orgb0314f1)
        3.  [Indexing Data](#org5bd4d2c)
        4.  [Loading Data](#org796eb0a)
        5.  [Additional Graphical and Numerical Summaries](#orgcb62144)
3.  [Linear Regression](#orgffa7db9)
    1.  [Simple Linear Regression](#org9ab63da)
    2.  [Multiple Linear Regression](#org869fcd1)
    3.  [Other Considerations in the Regression Model](#orgd679791)
    4.  [The Marketing Plan](#org7209224)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orgd439ae2)
    6.  [Lab: Linear Regression](#orgac5ab2e)
        1.  [Libraries](#orgcf8514f)
        2.  [Simple Linear Regression](#org8510056)
        3.  [Multiple Linear Regression](#orgc9fb954)
        4.  [Interaction Terms](#orgb5cb036)
        5.  [Non-linear Transformations of the Predictors](#org6ee21cc)
        6.  [Qualitative Predictors](#orge04f3f3)
        7.  [Calling `R` from `Python`](#orge7b583b)
4.  [Classification](#org8b08186)
    1.  [An Overview of Classification](#org382eccc)
    2.  [Why Not Linear Regression?](#orgfa97258)
    3.  [Logistic Regression](#orgbd907bf)
    4.  [Linear Discriminant Analysis](#orga8340f7)
    5.  [A Comparison of Classification Methods](#orgc45feb5)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org7a2932c)
        1.  [The Stock Market Data](#orge213f29)
        2.  [Logistc Regression](#orgc1545d5)
        3.  [Linear Discriminant Analysis](#orgb870f1d)
        4.  [Quadratic Discriminant Analysis](#org29fd472)
        5.  [K-Nearest Neightbors](#orga37d0b4)
        6.  [An Application to Caravan Insurance Data](#org6503591)
5.  [Resampling Methods](#orgc76f21e)
    1.  [Cross-Validation](#orge2bdf24)
    2.  [The Bootstrap](#orge8c1ccc)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgb21e2bc)
        1.  [The Validation Set Approach](#org8d23877)
        2.  [Leave-One-Out Cross-Validation](#org1a2c0a0)
        3.  [k-Fold Cross-Validation](#org489306a)
        4.  [The Bootstrap](#orgb6a32c4)
6.  [Linear Model Selection and Regularization](#org9b71f06)
    1.  [Subset Selection](#org727a9ef)
    2.  [Shrinkage Methods](#org324e711)
...
Figure [2](#org7b63bb3) shows graphs of Wage versus three variables. 
...
Figure [4](#orgb2199a6) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org58879ac) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orga41799a) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orgc470199) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org2da8895) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orgc470199).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org80b1b6e) provides an illustration of the trade-off between
...
Figure [17](#orgd726f03) provides a simple illustration of the clustering problem.
...
Figure [21](#orgf70d48a) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgf70d48a), we see considerable
...
Figure [23](#org5354f83) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgf70d48a) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org40145e4) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgf70d48a), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org8f39d71) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgf70d48a) - [25](#org40145e4).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org13a548f) provides an example using a simulated data set in
...
Figure [31](#org1775354) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org13a548f).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org13a548f), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org13a548f).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgdda6321) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org13a548f) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org10a3133) displays the simple linear regression fit to the
...
In figure [50](#org3a4e454), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orga605d22) displays *population regression
...
right-hand panel of figure [52](#orga605d22) we have generated five different
...
For `Advertising` data, table [1](#org34e91ef) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org34e91ef" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org5e488c0), we report more information about the least squares model.  

<table id="org5e488c0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orga3e7157)  shows results of two simple linear
...
<table id="orga3e7157" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org3252832) illustrates an example of the least squares fit to a
...
Table [4](#orgbe666c8) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgbe666c8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org7c99304) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgbe666c8). 

<table id="org7c99304" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org62dd1a8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgbe666c8).</caption>
...
Figure [61](#org766c211) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgf0b13de) records `balance`
...
Table [7](#org3a0d88a) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org3a0d88a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org09e8c51) we see that the estimated `balance` for the
...
<table id="org09e8c51" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orgcaeb2f7) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org3aa89a1), the left panel shows least squares lines when
...
<table id="orgcaeb2f7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgefdf096) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgf579ac3) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgf579ac3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org4749156) displays a residual plot from the
...
of figure[73](#org4749156) displays the residual plot results from the model
...
Figure [75](#org457b5c2) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org4d58e56), the magnitude of the
...
[79](#orge1ada4f) illustrates a typical outlier.  The red solid line is the
...
[79](#orge1ada4f), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orga70a687) has
...
[81](#orga70a687) are the same as the data displayed in figure
[79](#orge1ada4f), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orge1ada4f) and
[81](#orga70a687), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orga70a687), for a data set with two
...
point. The right-panel of figure [81](#orga70a687) provides a plot of
...
Figure [83](#orgd1c372e) illustrates the concept of collinearity.
...
Figure [86](#org03bb3ec) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org03bb3ec) displays contour
...
Table [11](#orgcb06eb2) compares the coefficient estimates obtained from two
...
<table id="orgcb06eb2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org073dbb7) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org96f5fb4) provides an example of KNN regression with data
...
Figure [93](#org55635d3) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org55635d3)
...
Figure [97](#orgaa8b1b4) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org54c00a3), except that we have added additional *noise*
...
In figure [110](#org632af92), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org73eb178) we show probability of default as a function of
...
Table [12](#org02f4069) shows the coefficient estimates and related
...
<table id="org02f4069" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgafc2744) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org675206a) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgafc2744" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org675206a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org5ac69bd) shows average default rates
...
[14](#org675206a).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org01ef997), two normal density functions
...
figure [121](#org6e9d888).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org6e9d888).  In this situation, the base
...
Figure [123](#orgd3c7982) shows an example of three equally sized Gaussian
...
[15](#orgdc47d76), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org6634501) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgdc47d76" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org6634501" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgcad38c7) illustrates the trade-off that results from
...
Figure [128](#orgf62270f) displays the ROC curve for the LDA classifier on
...
Table [17](#org921a5a9) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org921a5a9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org87cb210) lists many of the popular performance measures that
are used in this context.

<table id="org87cb210" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org921a5a9).</caption>
...
Figure [132](#org3b07843) illustrates the performances of LDA and QDA in two
...
Figure [134](#org8a80356) illustrates the performances of the four
...
Figure [143](#org10c027a) displays the *validation set approach*, a simple
...
In figure [145](#orgc6a6458), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org2d2f6cc) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org820f1b5) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org820f1b5) shows nine different 10-fold
...
Figure [151](#org15028b6) illustrates the *k*-fold CV approach.
...
In figure [153](#org0094d65), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgf70d48a),
[23](#org5354f83), and [25](#org40145e4) of chapter [2](#org609c355).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgf70d48a) (left), [23](#org5354f83) (center), and [25](#org40145e4) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org37b16fc) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org13a548f).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org8d50267) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org8d50267) displays the same three curves
...
Figure [160](#org0b06f0e) illustrates the approach for estimating &alpha; by
...
figure [163](#org3c9c473) displays a histogram of the resulting estimates.  The
...
[163](#org3c9c473), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org892b766).
...
Table [19](#org53343fa) shows first four selected models for the best subset and
...
<table id="org53343fa" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org9c3140d) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org9c3140d) displays the same ridge
