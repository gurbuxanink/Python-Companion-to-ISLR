...
1.  [Introduction](#org783e1e5)
2.  [Statistical Learning](#org75c4d7e)
    1.  [What is Statistical Learning?](#org66a6df0)
    2.  [Assessing Model Accuracy](#orga039e48)
    3.  [Lab: Introduction to Python](#org965e2cf)
        1.  [Basic Commands](#org82df22f)
        2.  [Graphics](#org319122d)
        3.  [Indexing Data](#org93562e2)
        4.  [Loading Data](#org4164a3b)
        5.  [Additional Graphical and Numerical Summaries](#org9b7b3f2)
3.  [Linear Regression](#orgc0311db)
    1.  [Simple Linear Regression](#orgd2b0a20)
    2.  [Multiple Linear Regression](#org3733319)
    3.  [Other Considerations in the Regression Model](#org828adf5)
    4.  [The Marketing Plan](#org1d72d51)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orgd7e7e4b)
    6.  [Lab: Linear Regression](#org0e92eeb)
        1.  [Libraries](#orge80712f)
        2.  [Simple Linear Regression](#orgfc14a67)
        3.  [Multiple Linear Regression](#orga00677f)
        4.  [Interaction Terms](#org177eba0)
        5.  [Non-linear Transformations of the Predictors](#org106eddb)
        6.  [Qualitative Predictors](#orgfd646e2)
        7.  [Calling `R` from `Python`](#org963b5ce)
4.  [Classification](#orgcb3f3ca)
    1.  [An Overview of Classification](#org6b59e83)
    2.  [Why Not Linear Regression?](#org5d10c12)
    3.  [Logistic Regression](#orga5f1043)
    4.  [Linear Discriminant Analysis](#org6c0f861)
    5.  [A Comparison of Classification Methods](#org4c3cd4a)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgf84c2e6)
        1.  [The Stock Market Data](#org875c361)
        2.  [Logistc Regression](#org90a83f5)
        3.  [Linear Discriminant Analysis](#orgde6f5cb)
        4.  [Quadratic Discriminant Analysis](#org4029e02)
        5.  [K-Nearest Neightbors](#org96b3d20)
        6.  [An Application to Caravan Insurance Data](#org84d4b5c)
5.  [Resampling Methods](#org5ee7628)
    1.  [Cross-Validation](#org5ed4ef0)
    2.  [The Bootstrap](#orge3fbed6)
    3.  [Lab: Cross-Validation and the Bootstrap](#org4ee0225)
        1.  [The Validation Set Approach](#org431cc64)
        2.  [Leave-One-Out Cross-Validation](#orgd84dd4e)
        3.  [k-Fold Cross-Validation](#orgd8043ac)
        4.  [The Bootstrap](#org9d35ea7)
6.  [Linear Model Selection and Regularization](#org2b8a3b3)
    1.  [Subset Selection](#org7503674)
    2.  [Shrinkage Methods](#orgbb4c0db)
    3.  [Dimension Reduction Methods](#org7e922b9)
    4.  [Considerations in High Dimensions](#org3f4b30c)
    5.  [Lab 1: Subset Selection Methods](#org235c4c0)
        1.  [Best Subset Selection](#orgbb89baa)
        2.  [Forward and Backward Stepwise Selection](#orgde84dea)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org4d679c2)
    6.  [Lab 2: Ridge Regression and the Lasso](#org4b55711)
        1.  [Ridge Regression](#org4de63f6)
        2.  [The Lasso](#orge10be9b)
    7.  [Lab 3: PCR and PLS Regression](#org1478886)
        1.  [Principal Components Regression](#org9b7e5ee)
        2.  [Partial Least Squares](#org9dc3070)
7.  [Moving Beyond Linearity](#org111ea19)
    1.  [Polynomial Regression](#orgb69ae70)
    2.  [Step Functions](#org5bb16b9)
    3.  [Basis Functions](#org5b55620)
    4.  [Regression Splines](#org1e0c383)
    5.  [Lab: Non-linear Modeling](#orge085124)
        1.  [Polynomial Regression and Step Functions](#orgcb8c656)
8.  [Tree-Based Models](#org449ca6c)
    1.  [The Basics of Decision Trees](#orgc9b73ac)
        1.  [Regression Trees](#org7b06963)
        2.  [Classification Trees](#orgfe9736f)
        3.  [Trees versus Linear Models](#orgcc278d4)
    2.  [Bagging, Random Forests, Boosting](#org6216b0a)
    3.  [Lab: Decision Trees](#org7305019)
        1.  [Fitting Classification Trees](#org3eb08b1)
        2.  [Fitting Regression Trees](#org5758bd7)
        3.  [Bagging and Random Forests](#org8a3d0a1)
...
Figure [2](#org4db063a) shows graphs of Wage versus three variables. 
...
Figure [4](#orgbd62a3b) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orged19933) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org7f8741c) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org931687f) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgfd0b249) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org931687f).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org8c12ff3) provides an illustration of the trade-off between
...
Figure [17](#org45b25ff) provides a simple illustration of the clustering problem.
...
Figure [21](#org5148d32) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org5148d32), we see considerable
...
Figure [23](#orgdd90e42) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org5148d32) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orge317865) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org5148d32), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgd7e2c12) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org5148d32) - [25](#orge317865).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org010351c) provides an example using a simulated data set in
...
Figure [31](#org1051029) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org010351c).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org010351c), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org010351c).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org168c957) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org010351c) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org0a563f3) displays the simple linear regression fit to the
...
In figure [50](#org082b0c1), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org24a389f) displays *population regression
...
right-hand panel of figure [52](#org24a389f) we have generated five different
...
For `Advertising` data, table [1](#org2e6ec22) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org2e6ec22" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgeaf0a90), we report more information about the least squares model.  

<table id="orgeaf0a90" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org93da0b6)  shows results of two simple linear
...
<table id="org93da0b6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org52446a1) illustrates an example of the least squares fit to a
...
Table [4](#orge16e3f0) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orge16e3f0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgec4bd73) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orge16e3f0). 

<table id="orgec4bd73" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org2759b9e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orge16e3f0).</caption>
...
Figure [61](#org514b5e9) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org2837562) records `balance`
...
Table [7](#orgbc27396) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgbc27396" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgfe9c341) we see that the estimated `balance` for the
...
<table id="orgfe9c341" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org6571826) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org0e0fd6b), the left panel shows least squares lines when
...
<table id="org6571826" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org7d42660) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orge4357b2) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orge4357b2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org56ccad9) displays a residual plot from the
...
of figure[73](#org56ccad9) displays the residual plot results from the model
...
Figure [75](#org72b2f6a) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgda58ac5), the magnitude of the
...
[79](#org9418dce) illustrates a typical outlier.  The red solid line is the
...
[79](#org9418dce), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org3060001) has
...
[81](#org3060001) are the same as the data displayed in figure
[79](#org9418dce), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org9418dce) and
[81](#org3060001), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org3060001), for a data set with two
...
point. The right-panel of figure [81](#org3060001) provides a plot of
...
Figure [83](#orgea275d8) illustrates the concept of collinearity.
...
Figure [86](#org91465ca) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org91465ca) displays contour
...
Table [11](#org0ab2706) compares the coefficient estimates obtained from two
...
<table id="org0ab2706" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org2458fa1) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orgf0035b1) provides an example of KNN regression with data
...
Figure [93](#orgc7dd816) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgc7dd816)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orgf0035b1) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgd22e2a6) examines the relative performances of least squares
...
Figure [97](#orgea5b863) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgd22e2a6), except that we have added additional *noise*
...
In figure [110](#org576cc53), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org4d6664c) we show probability of default as a function of
...
Table [12](#org96f0817) shows the coefficient estimates and related
...
<table id="org96f0817" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orge4fbcec) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org218397a) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orge4fbcec" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org218397a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgc902294) shows average default rates
...
[14](#org218397a).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org0b8ea7b), two normal density functions
...
figure [121](#orgfbefbb8).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgfbefbb8).  In this situation, the base
...
Figure [123](#orgffe08f8) shows an example of three equally sized Gaussian
...
[15](#orgae0a781), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgf434536) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgae0a781" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgf434536" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgaeb0e8d) illustrates the trade-off that results from
...
Figure [128](#orge00d4a9) displays the ROC curve for the LDA classifier on
...
Table [17](#orgf853121) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orgf853121" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org67993a8) lists many of the popular performance measures that
are used in this context.

<table id="org67993a8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orgf853121).</caption>
...
Figure [132](#orgf162767) illustrates the performances of LDA and QDA in two
...
Figure [134](#org20d8d61) illustrates the performances of the four
...
Figure [143](#org1d070b1) displays the *validation set approach*, a simple
...
In figure [145](#orgb2b1121), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orga0f4d8b) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org8671607) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org8671607) shows nine different 10-fold
...
Figure [151](#org9ee509c) illustrates the *k*-fold CV approach.
...
In figure [153](#orgbc02dda), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org5148d32),
[23](#orgdd90e42), and [25](#orge317865) of chapter [2](#org5953b72).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org5148d32) (left), [23](#orgdd90e42) (center), and [25](#orge317865) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org61217a8) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org010351c).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org3bb42b1) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org3bb42b1) displays the same three curves
...
Figure [160](#org14160fa) illustrates the approach for estimating &alpha; by
...
figure [163](#org3eeaf0e) displays a histogram of the resulting estimates.  The
...
[163](#org3eeaf0e), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org03660be).
...
Table [19](#org4b6d78a) shows first four selected models for the best subset and
...
<table id="org4b6d78a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org9bd1532) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org9bd1532) displays the same ridge
...
[182](#orgb00b972) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgd5c1c71), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgd5c1c71), as we
...
Figure [186](#orgf3df403) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgb76561b) displays the choice of &lambda; that results from
...
Figure [190](#org8ce87b3) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org879d87a), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org879d87a), the left-hand panel has
...
Figure [195](#org2a49756) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org2c9fb2b) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org1bf6fa8) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgb74ccd1) further illustrates the risk of carelessly applying
...
Figure [203](#orga95aff2) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#orga610a93) is a plot of `wage` against
...
The left-hand panel of figure [227](#org7a21d65) shows a fit of step functions
to the `Wage` data from figure [225](#orga610a93).  We also fit the logistic
...
Figure [234](#org6062cc6) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org6397e88) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org6062cc6).")

Figure [238](#orgff4b1d5) shows a five-region example of prediction via
...
Figure [240](#orgeade7c8) is an example of when a linear model or a tree
...
Figure [242](#org1c33cef) is a graphical representation of *variable
