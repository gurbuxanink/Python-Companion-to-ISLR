...
1.  [Introduction](#org3fefb94)
2.  [Statistical Learning](#org3f0e356)
    1.  [What is Statistical Learning?](#org221a0d4)
    2.  [Assessing Model Accuracy](#org952406e)
    3.  [Lab: Introduction to Python](#orgd0a8fd2)
        1.  [Basic Commands](#org9ab17cf)
        2.  [Graphics](#org7dcf416)
        3.  [Indexing Data](#org44f4942)
        4.  [Loading Data](#org0246479)
        5.  [Additional Graphical and Numerical Summaries](#orge4a496a)
3.  [Linear Regression](#org82b6c47)
    1.  [Simple Linear Regression](#orgfb42e45)
    2.  [Multiple Linear Regression](#org3810614)
    3.  [Other Considerations in the Regression Model](#org1724319)
    4.  [The Marketing Plan](#org91c7343)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org5f1f390)
    6.  [Lab: Linear Regression](#orgb3716cb)
        1.  [Libraries](#org4abcba0)
        2.  [Simple Linear Regression](#orgcf6be82)
        3.  [Multiple Linear Regression](#org8582e39)
        4.  [Interaction Terms](#orgf5bbc1c)
        5.  [Non-linear Transformations of the Predictors](#org19546d9)
        6.  [Qualitative Predictors](#org046206c)
        7.  [Calling `R` from `Python`](#org103c1b7)
4.  [Classification](#orgb9661e1)
    1.  [An Overview of Classification](#orgd0e6f17)
    2.  [Why Not Linear Regression?](#orgc430fba)
    3.  [Logistic Regression](#orgf092732)
    4.  [Linear Discriminant Analysis](#orgf5f03b5)
    5.  [A Comparison of Classification Methods](#orgc65e15d)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgc9e0ff7)
        1.  [The Stock Market Data](#orgc9869ab)
        2.  [Logistc Regression](#org6642561)
        3.  [Linear Discriminant Analysis](#org6a3d66d)
        4.  [Quadratic Discriminant Analysis](#org9933d14)
        5.  [K-Nearest Neightbors](#org5854d2e)
        6.  [An Application to Caravan Insurance Data](#orga1f80ba)
5.  [Resampling Methods](#org0bc4fa3)
    1.  [Cross-Validation](#org943b8e4)
    2.  [The Bootstrap](#org940dbf0)
    3.  [Lab: Cross-Validation and the Bootstrap](#org2877edb)
        1.  [The Validation Set Approach](#org80f27d7)
        2.  [Leave-One-Out Cross-Validation](#orgb818a96)
        3.  [k-Fold Cross-Validation](#org6dcedf8)
        4.  [The Bootstrap](#org9afe83d)
6.  [Linear Model Selection and Regularization](#orgceda4b1)
    1.  [Subset Selection](#org6ff9638)
    2.  [Shrinkage Methods](#orge20d27f)
    3.  [Dimension Reduction Methods](#orgebede0f)
    4.  [Considerations in High Dimensions](#org2a76a0c)
    5.  [Lab 1: Subset Selection Methods](#org6b21a94)
        1.  [Best Subset Selection](#org3fed395)
        2.  [Forward and Backward Stepwise Selection](#org7e87c7b)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#orgc202186)
    6.  [Lab 2: Ridge Regression and the Lasso](#org58b56f5)
        1.  [Ridge Regression](#orgb016e02)
        2.  [The Lasso](#orgfe165c2)
    7.  [Lab 3: PCR and PLS Regression](#org3e55030)
        1.  [Principal Components Regression](#orgdb6bcf7)
        2.  [Partial Least Squares](#org26b03b5)
7.  [Moving Beyond Linearity](#org6d2eace)
    1.  [Polynomial Regression](#org7042a14)
    2.  [Step Functions](#orgc23629e)
    3.  [Basis Functions](#org4b46dda)
    4.  [Regression Splines](#org0b03992)
    5.  [Lab: Non-linear Modeling](#orgff021e3)
        1.  [Polynomial Regression and Step Functions](#orgb7ac956)
8.  [Tree-Based Models](#orga44cc09)
    1.  [The Basics of Decision Trees](#orgdffe4ed)
        1.  [Regression Trees](#org3c7bfb0)
        2.  [Classification Trees](#org26efa8a)
        3.  [Trees versus Linear Models](#org983cca6)
    2.  [Bagging, Random Forests, Boosting](#org41ec164)
    3.  [Lab: Decision Trees](#org73f1499)
        1.  [Fitting Classification Trees](#orge8394ac)
        2.  [Fitting Regression Trees](#org703e8b0)
        3.  [Bagging and Random Forests](#org2a25041)
        4.  [Boosting](#orgec5bd1e)
9.  [Support Vector Machines](#orge0b1fb5)
    1.  [Maximal Margin Classifier](#org1b338d9)
        1.  [What is a Hyperplane?](#org98d9ed9)
        2.  [Classification Using a Separating Hyperplane](#org3a7c07f)
...
Figure [2](#org9992568) shows graphs of Wage versus three variables. 
...
Figure [4](#org4c967ee) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org81099e5) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org6aba930) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org492b1a7) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org49475fb) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org492b1a7).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org6d989ad) provides an illustration of the trade-off between
...
Figure [17](#org0844bdf) provides a simple illustration of the clustering problem.
...
Figure [21](#org0246a54) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org0246a54), we see considerable
...
Figure [23](#org262653c) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org0246a54) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orga9b4250) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org0246a54), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgf0bec47) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org0246a54) - [25](#orga9b4250).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgd73cc0e) provides an example using a simulated data set in
...
Figure [31](#orge1a5a86) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgd73cc0e).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgd73cc0e), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgd73cc0e).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgce2a1ad) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orgd73cc0e) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org0323a62) displays the simple linear regression fit to the
...
In figure [50](#org0937d82), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org824ee13) displays *population regression
...
right-hand panel of figure [52](#org824ee13) we have generated five different
...
For `Advertising` data, table [1](#org821ea37) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org821ea37" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgc832e85), we report more information about the least squares model.  

<table id="orgc832e85" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgaffe594)  shows results of two simple linear
...
<table id="orgaffe594" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org03ce67f) illustrates an example of the least squares fit to a
...
Table [4](#org0df2154) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org0df2154" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgf8bcac6) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org0df2154). 

<table id="orgf8bcac6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgc97e0d2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org0df2154).</caption>
...
Figure [61](#org3f6f985) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org684e024) records `balance`
...
Table [7](#org0ebc31b) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org0ebc31b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org8b692d6) we see that the estimated `balance` for the
...
<table id="org8b692d6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org9824cb4) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org12bd55e), the left panel shows least squares lines when
...
<table id="org9824cb4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org52b4d25) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org2c25cc8) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org2c25cc8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgc737d9e) displays a residual plot from the
...
of figure[73](#orgc737d9e) displays the residual plot results from the model
...
Figure [75](#org639e5e9) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgc0c0ac8), the magnitude of the
...
[79](#org8b7cd44) illustrates a typical outlier.  The red solid line is the
...
[79](#org8b7cd44), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgadf6cfc) has
...
[81](#orgadf6cfc) are the same as the data displayed in figure
[79](#org8b7cd44), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org8b7cd44) and
[81](#orgadf6cfc), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgadf6cfc), for a data set with two
...
point. The right-panel of figure [81](#orgadf6cfc) provides a plot of
...
Figure [83](#org6273f1b) illustrates the concept of collinearity.
...
Figure [86](#org510ab8a) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org510ab8a) displays contour
...
Table [11](#orgf74d3c2) compares the coefficient estimates obtained from two
...
<table id="orgf74d3c2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org675f159) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org1d193e0) provides an example of KNN regression with data
...
Figure [93](#org63c2cec) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org63c2cec)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org1d193e0) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org195da16) examines the relative performances of least squares
...
Figure [97](#orgacf0702) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org195da16), except that we have added additional *noise*
...
In figure [110](#org6fc8ba8), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgedf61a0) we show probability of default as a function of
...
Table [12](#org451bef4) shows the coefficient estimates and related
...
<table id="org451bef4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org620dae9) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org2609965) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org620dae9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org2609965" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgf0a5baa) shows average default rates
...
[14](#org2609965).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org2ce35a6), two normal density functions
...
figure [121](#orga4cb7e3).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orga4cb7e3).  In this situation, the base
...
Figure [123](#org79ee071) shows an example of three equally sized Gaussian
...
[15](#org4953079), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org94d2f64) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org4953079" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org94d2f64" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org89c20f6) illustrates the trade-off that results from
...
Figure [128](#orgd25f50c) displays the ROC curve for the LDA classifier on
...
Table [17](#org4c05a6a) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org4c05a6a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgcb4e765) lists many of the popular performance measures that
are used in this context.

<table id="orgcb4e765" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org4c05a6a).</caption>
...
Figure [132](#org0cca30d) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgb73a324) illustrates the performances of the four
...
Figure [143](#org58c637b) displays the *validation set approach*, a simple
...
In figure [145](#org7c5b1b8), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org34ae37b) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org2c9b772) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org2c9b772) shows nine different 10-fold
...
Figure [151](#org1935492) illustrates the *k*-fold CV approach.
...
In figure [153](#org6839295), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org0246a54),
[23](#org262653c), and [25](#orga9b4250) of chapter [2](#orgb1b9afc).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org0246a54) (left), [23](#org262653c) (center), and [25](#orga9b4250) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org795e537) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgd73cc0e).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orga1f6bbd) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orga1f6bbd) displays the same three curves
...
Figure [160](#org09452de) illustrates the approach for estimating &alpha; by
...
figure [163](#org41d7c2e) displays a histogram of the resulting estimates.  The
...
[163](#org41d7c2e), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org4b76c28).
...
Table [19](#orga4d9229) shows first four selected models for the best subset and
...
<table id="orga4d9229" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org6fd8aa1) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org6fd8aa1) displays the same ridge
...
[182](#orga038697) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgad444c4), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgad444c4), as we
...
Figure [186](#orgb2671c8) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org1beb379) displays the choice of &lambda; that results from
...
Figure [190](#org976c25d) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org85ac033), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org85ac033), the left-hand panel has
...
Figure [195](#org1c55c90) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgdbd4554) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orgeac24c8) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org094b1ed) further illustrates the risk of carelessly applying
...
Figure [203](#org8a8e8fb) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org0d5a233) is a plot of `wage` against
...
The left-hand panel of figure [227](#org919db19) shows a fit of step functions
to the `Wage` data from figure [225](#org0d5a233).  We also fit the logistic
...
Figure [234](#orgf28b299) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org736e941) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#orgf28b299).")

Figure [238](#org5212e96) shows a five-region example of prediction via
...
Figure [240](#orgb98bca7) is an example of when a linear model or a tree
...
Figure [242](#orgaa219e1) is a graphical representation of *variable
...
Figure [247](#orgc090d7d) shows a hyperplane in two-dimensional space.
...
Figure [249](#orgcdb4e16) shows an example of a separating hyperplane classifier.
