...
1.  [Introduction](#orgf7e25c5)
2.  [Statistical Learning](#orgbbeddd5)
    1.  [What is Statistical Learning?](#org5b045b0)
    2.  [Assessing Model Accuracy](#org0779f06)
    3.  [Lab: Introduction to Python](#orgb2459c6)
        1.  [Basic Commands](#orgf26b972)
        2.  [Graphics](#orgaf2071a)
        3.  [Indexing Data](#org32bd2ec)
        4.  [Loading Data](#orgece07f1)
        5.  [Additional Graphical and Numerical Summaries](#orgc2d8239)
3.  [Linear Regression](#org458c7af)
    1.  [Simple Linear Regression](#orgc2d885d)
    2.  [Multiple Linear Regression](#orgb1e4b19)
    3.  [Other Considerations in the Regression Model](#org4a97a2e)
    4.  [The Marketing Plan](#org7b693f3)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org521f0c4)
    6.  [Lab: Linear Regression](#org1a55bf2)
        1.  [Libraries](#org66fac00)
        2.  [Simple Linear Regression](#orgb151f42)
        3.  [Multiple Linear Regression](#org023f5d8)
        4.  [Interaction Terms](#orgf64c6c9)
        5.  [Non-linear Transformations of the Predictors](#orgdb8da32)
        6.  [Qualitative Predictors](#orge514d3d)
        7.  [Calling `R` from `Python`](#org1b19a5f)
4.  [Classification](#org9e06ccb)
    1.  [An Overview of Classification](#org9afcce2)
    2.  [Why Not Linear Regression?](#orgeb693b6)
    3.  [Logistic Regression](#orgf754967)
    4.  [Linear Discriminant Analysis](#org801d69d)
    5.  [A Comparison of Classification Methods](#org51d9617)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgf1223d6)
        1.  [The Stock Market Data](#org6bf5cd0)
        2.  [Logistc Regression](#org92c9388)
        3.  [Linear Discriminant Analysis](#org60fae11)
        4.  [Quadratic Discriminant Analysis](#orga691734)
        5.  [K-Nearest Neightbors](#org412012f)
        6.  [An Application to Caravan Insurance Data](#orge7a8bda)
5.  [Resampling Methods](#orgf47495d)
    1.  [Cross-Validation](#org55398b7)
    2.  [The Bootstrap](#org4772cea)
    3.  [Lab: Cross-Validation and the Bootstrap](#orgbf730bc)
        1.  [The Validation Set Approach](#orga21c51a)
        2.  [Leave-One-Out Cross-Validation](#org7f85bc0)
        3.  [k-Fold Cross-Validation](#org3dc2f9d)
        4.  [The Bootstrap](#org59dbd35)
6.  [Linear Model Selection and Regularization](#orgc5ee450)
    1.  [Subset Selection](#org424fae5)
    2.  [Shrinkage Methods](#orga778056)
    3.  [Dimension Reduction Methods](#org31eab87)
    4.  [Considerations in High Dimensions](#org21a4e0e)
    5.  [Lab 1: Subset Selection Methods](#org0240d2c)
        1.  [Best Subset Selection](#org79ac631)
        2.  [Forward and Backward Stepwise Selection](#org97a4a32)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org558c980)
    6.  [Lab 2: Ridge Regression and the Lasso](#org37a9930)
        1.  [Ridge Regression](#orgbdf7528)
        2.  [The Lasso](#orge5dea8e)
    7.  [Lab 3: PCR and PLS Regression](#orge09f243)
        1.  [Principal Components Regression](#org2ac5013)
        2.  [Partial Least Squares](#org9c5404e)
7.  [Moving Beyond Linearity](#org1cabf5f)
    1.  [Polynomial Regression](#orga3b1b3c)
    2.  [Step Functions](#org01ac833)
    3.  [Basis Functions](#org9779515)
    4.  [Regression Splines](#orgc27a755)
    5.  [Lab: Non-linear Modeling](#orgd8d5051)
        1.  [Polynomial Regression and Step Functions](#org257bcdd)
8.  [Tree-Based Models](#org959f9ed)
    1.  [The Basics of Decision Trees](#org14bd878)
        1.  [Regression Trees](#org00a31ae)
        2.  [Classification Trees](#org6cd5f03)
        3.  [Trees versus Linear Models](#org1ef74ad)
    2.  [Bagging, Random Forests, Boosting](#orgea3c824)
    3.  [Lab: Decision Trees](#org44cf80c)
        1.  [Fitting Classification Trees](#org39c7828)
        2.  [Fitting Regression Trees](#org836b4a6)
        3.  [Bagging and Random Forests](#org5973c5d)
        4.  [Boosting](#org38fc3f2)
9.  [Support Vector Machines](#orgace3957)
    1.  [Maximal Margin Classifier](#orgfe31abe)
        1.  [What is a Hyperplane?](#orgc937e41)
        2.  [Classification Using a Separating Hyperplane](#org38370da)
        3.  [The Maximal Margin Classifier](#org00605b6)
        4.  [Construction of the Maximal Margin Classifier](#org33a61a9)
        5.  [The Non-separable Case](#org12a9a0f)
    2.  [Support Vector Classifiers](#org691a031)
        1.  [Overview of the Support Vector Classifier](#orgdde3796)
        2.  [Details of the Support Vector Classifier](#orgcd6e661)
    3.  [Support Vector Machines](#org35f2edd)
        1.  [Classification with Non-linear Decision Boundaries](#orgd4495d7)
        2.  [The Support Vector Machine](#orgb456f35)
        3.  [An Application to the Heart Disease Data](#orgd87bbba)
    4.  [SVMs with More than Two Classes](#orge0f5d9f)
        1.  [One-Versus-One Classification](#org47ba6c8)
        2.  [One-Versus-All Classification](#org9f5f78c)
    5.  [Relationship with Logistic Regression](#org8806186)
    6.  [Lab: Support Vector Machines](#org1a8b860)
        1.  [Support Vector Classifier](#orgbad0598)
        2.  [Support Vector Machine](#org69f2e92)
        3.  [ROC Curves](#org4acc9e6)
        4.  [SVM with Multiple Classes](#org3dc1634)
        5.  [Application to Gene Expression Data](#orgb214cf7)
10. [Unsupervised Learning](#orgcbd066b)
    1.  [The Challenge of Unsupervised Learning](#org479d4b0)
    2.  [Principal Component Analysis](#org10c0f81)
        1.  [What are Principal Components?](#org243ed06)
        2.  [Another Interpretation of Principal Components](#orgdeae041)
        3.  [More on PCA](#org29a8434)
...
Figure [2](#org49a8415) shows graphs of Wage versus three variables. 
...
Figure [4](#orgd70a068) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgdf2a189) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgaed8b39) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org9a4f093) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org82c36db) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org9a4f093).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org0812001) provides an illustration of the trade-off between
...
Figure [17](#org186d2c2) provides a simple illustration of the clustering problem.
...
Figure [21](#org5e120ba) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org5e120ba), we see considerable
...
Figure [23](#org2c0be29) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org5e120ba) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org54227e0) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org5e120ba), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org38b0aa7) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org5e120ba) - [25](#org54227e0).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org2c40703) provides an example using a simulated data set in
...
Figure [31](#org93625fe) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org2c40703).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org2c40703), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org2c40703).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgc530638) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org2c40703) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgce33880) displays the simple linear regression fit to the
...
In figure [50](#orgbaf2183), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org3d903b6) displays *population regression
...
right-hand panel of figure [52](#org3d903b6) we have generated five different
...
For `Advertising` data, table [1](#org5c4ba4c) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org5c4ba4c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org7550a58), we report more information about the least squares model.  

<table id="org7550a58" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgefc75b1)  shows results of two simple linear
...
<table id="orgefc75b1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org435a262) illustrates an example of the least squares fit to a
...
Table [4](#org8715f6d) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org8715f6d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org7ead71d) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org8715f6d). 

<table id="org7ead71d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgfacfd22" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org8715f6d).</caption>
...
Figure [61](#org650fc32) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org9d7124e) records `balance`
...
Table [7](#orgee31aa6) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgee31aa6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org0e61efd) we see that the estimated `balance` for the
...
<table id="org0e61efd" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org35f84dc) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org3b8c294), the left panel shows least squares lines when
...
<table id="org35f84dc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org8f7f89f) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orge1f87c7) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orge1f87c7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgbab3b62) displays a residual plot from the
...
of figure[73](#orgbab3b62) displays the residual plot results from the model
...
Figure [75](#orgf9bde17) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orge07944a), the magnitude of the
...
[79](#org4d94f06) illustrates a typical outlier.  The red solid line is the
...
[79](#org4d94f06), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org8d92f49) has
...
[81](#org8d92f49) are the same as the data displayed in figure
[79](#org4d94f06), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org4d94f06) and
[81](#org8d92f49), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org8d92f49), for a data set with two
...
point. The right-panel of figure [81](#org8d92f49) provides a plot of
...
Figure [83](#org432000b) illustrates the concept of collinearity.
...
Figure [86](#org38bdcfb) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org38bdcfb) displays contour
...
Table [11](#org137812e) compares the coefficient estimates obtained from two
...
<table id="org137812e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org6282873) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org407f7b9) provides an example of KNN regression with data
...
Figure [93](#orgd70dfdb) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgd70dfdb)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org407f7b9) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org6fc61e2) examines the relative performances of least squares
...
Figure [97](#org0329997) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org6fc61e2), except that we have added additional *noise*
...
In figure [110](#org67dfca1), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org6f0fc9c) we show probability of default as a function of
...
Table [12](#orgbac6960) shows the coefficient estimates and related
...
<table id="orgbac6960" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org8035fe3) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org635f47d) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org8035fe3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org635f47d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgdbea6ea) shows average default rates
...
[14](#org635f47d).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org07d9d55), two normal density functions
...
figure [121](#org508bb57).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org508bb57).  In this situation, the base
...
Figure [123](#org8057f67) shows an example of three equally sized Gaussian
...
[15](#org32b8ccb), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org846c0f2) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org32b8ccb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org846c0f2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgcc32495) illustrates the trade-off that results from
...
Figure [128](#org7efe2d8) displays the ROC curve for the LDA classifier on
...
Table [17](#orgdb973d9) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orgdb973d9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org78f23a4) lists many of the popular performance measures that
are used in this context.

<table id="org78f23a4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orgdb973d9).</caption>
...
Figure [132](#org1b37111) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgfcbe260) illustrates the performances of the four
...
Figure [143](#org71e4570) displays the *validation set approach*, a simple
...
In figure [145](#org3d6aaf5), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orgb653597) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org251f10e) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org251f10e) shows nine different 10-fold
...
Figure [151](#org6119438) illustrates the *k*-fold CV approach.
...
In figure [153](#orgcdfd2d5), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org5e120ba),
[23](#org2c0be29), and [25](#org54227e0) of chapter [2](#orgd61c56a).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org5e120ba) (left), [23](#org2c0be29) (center), and [25](#org54227e0) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orgaf1ab0f) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org2c40703).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgc970485) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgc970485) displays the same three curves
...
Figure [160](#orgdf0684f) illustrates the approach for estimating &alpha; by
...
figure [163](#org9f2dcc0) displays a histogram of the resulting estimates.  The
...
[163](#org9f2dcc0), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org6a1081b).
...
Table [19](#org6c839f4) shows first four selected models for the best subset and
...
<table id="org6c839f4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org75976a0) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org75976a0) displays the same ridge
...
[182](#org932588f) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org191f3f8), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org191f3f8), as we
...
Figure [186](#orgd925d0a) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org887266a) displays the choice of &lambda; that results from
...
Figure [190](#orgac28be8) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org437fe20), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org437fe20), the left-hand panel has
...
Figure [195](#org61c1a7a) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org282e276) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org2a07cb6) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org5b04586) further illustrates the risk of carelessly applying
...
Figure [203](#org5d1fa1e) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org1628d04) is a plot of `wage` against
...
The left-hand panel of figure [227](#org3b06f57) shows a fit of step functions
to the `Wage` data from figure [225](#org1628d04).  We also fit the logistic
...
Figure [234](#orga99edd9) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org45b599c) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#orga99edd9).")

Figure [238](#org506922d) shows a five-region example of prediction via
...
Figure [240](#org20ed513) is an example of when a linear model or a tree
...
Figure [242](#orgf9a0996) is a graphical representation of *variable
...
Figure [247](#org5dc7fcf) shows a hyperplane in two-dimensional space.
...
Figure [249](#org75edd6f) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#orgbebd8d2), we see that three training observations are
...
[251](#orgbebd8d2), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#org235ad03) shows an example where we cannot *exactly* separate the two
...
In figures [255](#org0e1f852), addition of a single observation in the right hand panel
...
Figure [257](#orga3b990c) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#org33680b8) illustrates the width of margin for different values of
...
In figure [261](#org38f6afd) consider the data shown in the left panel.  It is clear
...
In figure [263](#orgaab247b), the left-hand panel shows an example of SVM with a
polynomial kernel applied the non-linear data from figure [261](#org38f6afd).  The fit
...
![img](figures/fig9_9.png "Left: An SVM with a polynomial kernel of degree 3 is applied to the non-linear data from figure [261](#org38f6afd), resulting in a more appropriate decision rule.  Right: An SVM with a radial kernel is applied.  In this example, radial kernel is the most capable of capturing the decision boundary.")
...
In figure [265](#org64ca11b), the left-hand panel displays ROC curves for training set
...
Figure [267](#orge139be6) compares ROC curves on test observations.  Using default
...
[20](#org73077a4) shows loadings of the first two principal components.
Figure [273](#org8374c0a) plots the first two principal components of these
data.  The figure represents both the principal component scores and the loading
vectors in a single *biplot* display.

<table id="org73077a4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 20:</span> The principal component loading factors, &phi;<sub>1</sub> and &phi;<sub>2</sub>, for the `USArrests` data.  These are also displayed in figure [273](#org8374c0a).</caption>
...
In figure [275](#org1688b02), the left-hand panel is the same as figure
[273](#org8374c0a), where each variable was first scaled to have mean zero and standard
...
![img](figures/fig10_3.png "Two principal component biplots for `USArrests` data.  Left: Same as figure [273](#org8374c0a), with variables scaled to have unit standard deviations.  Right: Principal components using unscaled data.  `Assault` has by far the largest loading on the first principal component because it has the largest variance among the four variables.  In general, it is recommended to scale variables to have standard deviation one.")

In Figure [277](#orga7d58c4), the left-hand panel shows the proportion of
