...
1.  [Introduction](#org425a78d)
2.  [Statistical Learning](#orga7120e7)
...
Figure [2](#org984b2a6) shows graphs of Wage versus three variables. 
...
Figure [4](#orgada1241) shows boxplots of previous days' percentage changes in S&P
...
Figure [6](#orgca92e04) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [8](#org3cde8df) is a plot of `Income` versus `Years of Education` from the
