...
1.  [Introduction](#orgb1689c4)
2.  [Statistical Learning](#org3fe04ad)
    1.  [What is Statistical Learning?](#orga3d5508)
    2.  [Assessing Model Accuracy](#org8bf6e32)
    3.  [Lab: Introduction to Python](#org6b3c0a1)
        1.  [Basic Commands](#orge1ffbbc)
        2.  [Graphics](#org781ee03)
        3.  [Indexing Data](#orgfc4ee53)
        4.  [Loading Data](#orgcd0b55d)
        5.  [Additional Graphical and Numerical Summaries](#org6423bc7)
3.  [Linear Regression](#orgd3cbbd6)
    1.  [Simple Linear Regression](#org87bfa42)
    2.  [Multiple Linear Regression](#org1a10f3c)
    3.  [Other Considerations in the Regression Model](#org0bfda2c)
    4.  [The Marketing Plan](#orgfa6ccb6)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orga2b19c3)
    6.  [Lab: Linear Regression](#org0d71b4b)
        1.  [Libraries](#orgb3571cd)
        2.  [Simple Linear Regression](#org2748ccb)
        3.  [Multiple Linear Regression](#org2942c50)
        4.  [Interaction Terms](#org7296d83)
        5.  [Non-linear Transformations of the Predictors](#orgd67737c)
        6.  [Qualitative Predictors](#org3c85fc1)
        7.  [Calling `R` from `Python`](#org0c58fba)
4.  [Classification](#org7b67078)
    1.  [An Overview of Classification](#org02d3b27)
    2.  [Why Not Linear Regression?](#orgba78419)
    3.  [Logistic Regression](#orgcaf26eb)
    4.  [Linear Discriminant Analysis](#orgdc27a0e)
    5.  [A Comparison of Classification Methods](#org74dce0c)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgb75fbc8)
        1.  [The Stock Market Data](#orgfc45b52)
        2.  [Logistc Regression](#org5b99252)
        3.  [Linear Discriminant Analysis](#orgab9668f)
        4.  [Quadratic Discriminant Analysis](#orgf6bbae1)
        5.  [K-Nearest Neightbors](#org6183b63)
        6.  [An Application to Caravan Insurance Data](#org2b7d7e8)
5.  [Resampling Methods](#org9f51bfe)
    1.  [Cross-Validation](#org249c90e)
    2.  [The Bootstrap](#org84387ce)
    3.  [Lab: Cross-Validation and the Bootstrap](#org0a7a38c)
        1.  [The Validation Set Approach](#org87fc558)
        2.  [Leave-One-Out Cross-Validation](#org99b4948)
        3.  [k-Fold Cross-Validation](#org2d35c48)
        4.  [The Bootstrap](#org5b1e080)
6.  [Linear Model Selection and Regularization](#org8345e34)
    1.  [Subset Selection](#orgfd3bfeb)
    2.  [Shrinkage Methods](#org7c1112d)
    3.  [Dimension Reduction Methods](#org4608ae8)
    4.  [Considerations in High Dimensions](#orga375f6c)
    5.  [Lab 1: Subset Selection Methods](#org238706b)
        1.  [Best Subset Selection](#orgd94c218)
        2.  [Forward and Backward Stepwise Selection](#org55f64a0)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org0ae6c3c)
    6.  [Lab 2: Ridge Regression and the Lasso](#org532d7cf)
        1.  [Ridge Regression](#org6d8620c)
        2.  [The Lasso](#org11d4714)
    7.  [Lab 3: PCR and PLS Regression](#orge7c6f7e)
        1.  [Principal Components Regression](#org536d036)
        2.  [Partial Least Squares](#org5b157b6)
7.  [Moving Beyond Linearity](#org6be81e2)
    1.  [Polynomial Regression](#org7aa869c)
    2.  [Step Functions](#orgc29a570)
    3.  [Basis Functions](#org9f9084d)
    4.  [Regression Splines](#org785ce02)
    5.  [Lab: Non-linear Modeling](#org2be80fd)
        1.  [Polynomial Regression and Step Functions](#orgb95e51f)
8.  [Tree-Based Models](#org6d9ba75)
    1.  [The Basics of Decision Trees](#org2d73c9c)
        1.  [Regression Trees](#org7f30afd)
...
Figure [2](#orga2d41af) shows graphs of Wage versus three variables. 
...
Figure [4](#orgb8e0cbd) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orga49b882) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgd2d08bb) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org4de4aa9) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org065d752) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org4de4aa9).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org4efc166) provides an illustration of the trade-off between
...
Figure [17](#org345fe6b) provides a simple illustration of the clustering problem.
...
Figure [21](#orgdae6db6) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgdae6db6), we see considerable
...
Figure [23](#org99e2680) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgdae6db6) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org7280fe2) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgdae6db6), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orga9c6a30) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgdae6db6) - [25](#org7280fe2).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org9b22828) provides an example using a simulated data set in
...
Figure [31](#org58e84fc) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org9b22828).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org9b22828), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org9b22828).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org136f12a) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org9b22828) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org4014801) displays the simple linear regression fit to the
...
In figure [50](#orgf9d592e), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org2eb477b) displays *population regression
...
right-hand panel of figure [52](#org2eb477b) we have generated five different
...
For `Advertising` data, table [1](#org1cc188f) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org1cc188f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org6e6a0a9), we report more information about the least squares model.  

<table id="org6e6a0a9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org9bed7be)  shows results of two simple linear
...
<table id="org9bed7be" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#orgd40238e) illustrates an example of the least squares fit to a
...
Table [4](#orgda6b8f7) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgda6b8f7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgc09a783) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgda6b8f7). 

<table id="orgc09a783" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgdc87b4c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgda6b8f7).</caption>
...
Figure [61](#org12e9af3) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org2f73095) records `balance`
...
Table [7](#orge52d25c) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orge52d25c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orge3179ee) we see that the estimated `balance` for the
...
<table id="orge3179ee" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org23b31b5) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org5e661da), the left panel shows least squares lines when
...
<table id="org23b31b5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org7de7853) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgd7a97fe) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgd7a97fe" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgc68eb8d) displays a residual plot from the
...
of figure[73](#orgc68eb8d) displays the residual plot results from the model
...
Figure [75](#orgfbf95fc) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgcbbe630), the magnitude of the
...
[79](#org180ac1c) illustrates a typical outlier.  The red solid line is the
...
[79](#org180ac1c), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org91e2663) has
...
[81](#org91e2663) are the same as the data displayed in figure
[79](#org180ac1c), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org180ac1c) and
[81](#org91e2663), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org91e2663), for a data set with two
...
point. The right-panel of figure [81](#org91e2663) provides a plot of
...
Figure [83](#org9efa30c) illustrates the concept of collinearity.
...
Figure [86](#org3cf8f57) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org3cf8f57) displays contour
...
Table [11](#org4dec001) compares the coefficient estimates obtained from two
...
<table id="org4dec001" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org8ce7d81) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#orgbee3acb) provides an example of KNN regression with data
...
Figure [93](#orgc741995) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgc741995)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#orgbee3acb) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org5b30c6f) examines the relative performances of least squares
...
Figure [97](#org1e2220e) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org5b30c6f), except that we have added additional *noise*
...
In figure [110](#orgced4f79), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgf235bab) we show probability of default as a function of
...
Table [12](#orgaf6e606) shows the coefficient estimates and related
...
<table id="orgaf6e606" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgaa929be) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orge831a1e) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgaa929be" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orge831a1e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgf6842b0) shows average default rates
...
[14](#orge831a1e).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org5b66e9c), two normal density functions
...
figure [121](#orgec6f07e).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgec6f07e).  In this situation, the base
...
Figure [123](#org709883a) shows an example of three equally sized Gaussian
...
[15](#org4ba75a6), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgf26c455) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org4ba75a6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgf26c455" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org3244949) illustrates the trade-off that results from
...
Figure [128](#org6bddf85) displays the ROC curve for the LDA classifier on
...
Table [17](#org27e4278) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org27e4278" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org1afb286) lists many of the popular performance measures that
are used in this context.

<table id="org1afb286" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org27e4278).</caption>
...
Figure [132](#org670b149) illustrates the performances of LDA and QDA in two
...
Figure [134](#org4012bee) illustrates the performances of the four
...
Figure [143](#orgf0b5f41) displays the *validation set approach*, a simple
...
In figure [145](#orgb13e706), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org070060e) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org2ec5fbb) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org2ec5fbb) shows nine different 10-fold
...
Figure [151](#orgf37ae94) illustrates the *k*-fold CV approach.
...
In figure [153](#orgd878faa), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgdae6db6),
[23](#org99e2680), and [25](#org7280fe2) of chapter [2](#org35a3da0).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgdae6db6) (left), [23](#org99e2680) (center), and [25](#org7280fe2) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org3c1961f) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org9b22828).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgc6ec457) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgc6ec457) displays the same three curves
...
Figure [160](#org4a066f1) illustrates the approach for estimating &alpha; by
...
figure [163](#org2d11a3e) displays a histogram of the resulting estimates.  The
...
[163](#org2d11a3e), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orgdd1cc39).
...
Table [19](#org394cc2b) shows first four selected models for the best subset and
...
<table id="org394cc2b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org58f8da8) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org58f8da8) displays the same ridge
...
[182](#org6a5842a) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org1f941d8), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org1f941d8), as we
...
Figure [186](#org7a67b68) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org44b95f4) displays the choice of &lambda; that results from
...
Figure [190](#org08ef990) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgccbfd9d), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgccbfd9d), the left-hand panel has
...
Figure [195](#orge2610fe) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org6d4feb1) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org2a444b6) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org1832f2f) further illustrates the risk of carelessly applying
...
Figure [203](#orgcbe9d30) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org5d814ec) is a plot of `wage` against
...
The left-hand panel of figure [227](#org1e6656e) shows a fit of step functions
to the `Wage` data from figure [225](#org5d814ec).  We also fit the logistic
...
Figure [234](#orgec556b2) shows a regression tree fit to `Hitters` data.  We
...
assigns observations having `Years < 4.5` to the left branch.  Although this
group is further subidivided into two groups (`Hits < 15.5` and `Hits > 15.5`),
almost all the players are in the second group (88 out of 90).   Players with
...
117.5\}\).  Figure [236](#org68e7b4e) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#orgec556b2).")

Figure [238](#org435935b) shows a five-region example of prediction via
