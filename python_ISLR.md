...
1.  [Introduction](#orgd03a3ad)
2.  [Statistical Learning](#orgba2364e)
    1.  [What is Statistical Learning?](#org34a8ae7)
    2.  [Assessing Model Accuracy](#org4c8042a)
    3.  [Lab: Introduction to Python](#orgc9c8037)
        1.  [Basic Commands](#orgbc8ee23)
        2.  [Graphics](#orge080d32)
        3.  [Indexing Data](#orgcc419e0)
        4.  [Loading Data](#org90789a9)
        5.  [Additional Graphical and Numerical Summaries](#orga5438db)
3.  [Linear Regression](#org1d3e11e)
    1.  [Simple Linear Regression](#orgaf88587)
    2.  [Multiple Linear Regression](#orge3d9b6a)
    3.  [Other Considerations in the Regression Model](#org8c345f1)
    4.  [The Marketing Plan](#org93031c4)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org6529930)
    6.  [Lab: Linear Regression](#org5e2152b)
        1.  [Libraries](#org537d2b2)
        2.  [Simple Linear Regression](#org9e9da0d)
        3.  [Multiple Linear Regression](#org815ef10)
        4.  [Interaction Terms](#orgeaa0ccb)
        5.  [Non-linear Transformations of the Predictors](#orgcc8b050)
        6.  [Qualitative Predictors](#org509b1a0)
        7.  [Calling `R` from `Python`](#org6c5ad10)
4.  [Classification](#org11b56c4)
    1.  [An Overview of Classification](#org13b9fb1)
    2.  [Why Not Linear Regression?](#orge9aaa82)
    3.  [Logistic Regression](#org08f3164)
    4.  [Linear Discriminant Analysis](#org8362199)
    5.  [A Comparison of Classification Methods](#org6249399)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org7f28658)
        1.  [The Stock Market Data](#org87c05be)
        2.  [Logistc Regression](#org65b0b7d)
        3.  [Linear Discriminant Analysis](#org3864266)
        4.  [Quadratic Discriminant Analysis](#orgf84e11a)
        5.  [K-Nearest Neightbors](#org334d170)
        6.  [An Application to Caravan Insurance Data](#orgaef8782)
5.  [Resampling Methods](#org6f972d0)
    1.  [Cross-Validation](#orge2893ee)
    2.  [The Bootstrap](#org8b7019c)
    3.  [Lab: Cross-Validation and the Bootstrap](#org959e63d)
        1.  [The Validation Set Approach](#org5c73927)
        2.  [Leave-One-Out Cross-Validation](#org68316b5)
        3.  [k-Fold Cross-Validation](#orgf90bd9d)
        4.  [The Bootstrap](#orge456475)
6.  [Linear Model Selection and Regularization](#org536fd93)
    1.  [Subset Selection](#orgc781570)
    2.  [Shrinkage Methods](#org14120a6)
    3.  [Dimension Reduction Methods](#org9d27e88)
    4.  [Considerations in High Dimensions](#orge41a4d7)
    5.  [Lab 1: Subset Selection Methods](#org89f94ae)
        1.  [Best Subset Selection](#org6d0f7b1)
        2.  [Forward and Backward Stepwise Selection](#orgffaae3d)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org9771e34)
    6.  [Lab 2: Ridge Regression and the Lasso](#org339840f)
        1.  [Ridge Regression](#orgca4e73f)
        2.  [The Lasso](#orga572878)
    7.  [Lab 3: PCR and PLS Regression](#org9ad4bd3)
...
Figure [2](#org9fba49d) shows graphs of Wage versus three variables. 
...
Figure [4](#orgab3f74f) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org0aaeed5) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgdfeb1b7) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org4c1764b) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org490037c) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org4c1764b).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orgae05318) provides an illustration of the trade-off between
...
Figure [17](#orgae25ab5) provides a simple illustration of the clustering problem.
...
Figure [21](#orgad5dcfb) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgad5dcfb), we see considerable
...
Figure [23](#orgdc17fbe) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgad5dcfb) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org6ee680d) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgad5dcfb), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orga7ccbdd) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgad5dcfb) - [25](#org6ee680d).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org5c052fa) provides an example using a simulated data set in
...
Figure [31](#orgd7ba6e5) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org5c052fa).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org5c052fa), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org5c052fa).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgff5e210) we have plotted the KNN test and training errors as
...
Figure [48](#orge9705b9) displays the simple linear regression fit to the
...
In figure [50](#orgd89398c), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org3fd92f1) displays *population regression
...
right-hand panel of figure [52](#org3fd92f1) we have generated five different
...
For `Advertising` data, table [1](#org71dffc8) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org71dffc8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org6f07f99), we report more information about the least squares model.  

<table id="org6f07f99" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgc740d58)  shows results of two simple linear
...
<table id="orgc740d58" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#orgae32dfd) illustrates an example of the least squares fit to a
...
Table [4](#org0116fef) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org0116fef" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org32eebce) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org0116fef). 

<table id="org32eebce" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orga7f2182" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org0116fef).</caption>
...
Figure [61](#org0406d0b) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org2aee298) records `balance`
...
Table [7](#orgdfaae0b) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgdfaae0b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orge781113) we see that the estimated `balance` for the
...
<table id="orge781113" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org5be11a0) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgee986a8), the left panel shows least squares lines when
...
<table id="org5be11a0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgce40604) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org83a8bcf) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org83a8bcf" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org5a7c64e) displays a residual plot from the
...
of figure[73](#org5a7c64e) displays the residual plot results from the model
...
Figure [75](#orgc513256) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org4bd75d7), the magnitude of the
...
[79](#org987c01e) illustrates a typical outlier.  The red solid line is the
...
[79](#org987c01e), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org3effc8a) has
...
[81](#org3effc8a) are the same as the data displayed in figure
[79](#org987c01e), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org987c01e) and
[81](#org3effc8a), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org3effc8a), for a data set with two
...
point. The right-panel of figure [81](#org3effc8a) provides a plot of
...
Figure [83](#org391a73b) illustrates the concept of collinearity.
...
Figure [86](#orga888462) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orga888462) displays contour
...
Table [11](#org8177a16) compares the coefficient estimates obtained from two
...
<table id="org8177a16" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org3a8f70a) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org6ad07d7) provides an example of KNN regression with data
...
Figure [93](#org969ba76) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org969ba76)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org6ad07d7) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org4814cbb) examines the relative performances of least squares
...
Figure [97](#org2d1454e) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org4814cbb), except that we have added additional *noise*
...
In figure [110](#org7b5976f), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org39d0f59) we show probability of default as a function of
...
Table [12](#org6636029) shows the coefficient estimates and related
...
<table id="org6636029" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org181aa99) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org7c7f32a) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org181aa99" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org7c7f32a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org2749c5d) shows average default rates
...
[14](#org7c7f32a).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org9bbef2e), two normal density functions
...
figure [121](#org1ae3a22).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org1ae3a22).  In this situation, the base
...
Figure [123](#orgf58a833) shows an example of three equally sized Gaussian
...
[15](#org9920af5), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org283d374) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org9920af5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org283d374" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org7a75101) illustrates the trade-off that results from
...
Figure [128](#org486d17d) displays the ROC curve for the LDA classifier on
...
Table [17](#org180b87a) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org180b87a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgc5d7aaf) lists many of the popular performance measures that
are used in this context.

<table id="orgc5d7aaf" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org180b87a).</caption>
...
Figure [132](#org9b3a87b) illustrates the performances of LDA and QDA in two
...
Figure [134](#org32a1e95) illustrates the performances of the four
...
Figure [143](#org73488ab) displays the *validation set approach*, a simple
...
In figure [145](#orgfc5ade1), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orgd0a23e0) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org5a59171) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org5a59171) shows nine different 10-fold
...
Figure [151](#orgc210113) illustrates the *k*-fold CV approach.
...
In figure [153](#org80cff3c), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgad5dcfb),
[23](#orgdc17fbe), and [25](#org6ee680d) of chapter [2](#orgf80e5fa).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgad5dcfb) (left), [23](#orgdc17fbe) (center), and [25](#org6ee680d) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org241487f) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org5c052fa).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgcf01762) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgcf01762) displays the same three curves
...
Figure [160](#org68ea145) illustrates the approach for estimating &alpha; by
...
figure [163](#org3f8bea0) displays a histogram of the resulting estimates.  The
...
[163](#org3f8bea0), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org2bb5c75).
...
Table [19](#orge47f953) shows first four selected models for the best subset and
...
<table id="orge47f953" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org82d6702) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org82d6702) displays the same ridge
...
[182](#orga424d32) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgdc8fee9), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgdc8fee9), as we
...
Figure [186](#org3839cb0) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org7660103) displays the choice of &lambda; that results from
...
Figure [190](#org89d25f1) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgd0acf26), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgd0acf26), the left-hand panel has
...
Figure [195](#orgf94ecad) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org9dc991a) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orgc8e117c) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orge7e00e3) further illustrates the risk of carelessly applying
...
Figure [203](#orgce17132) illustrates the performance of the lasso in a simple
