...
1.  [Introduction](#orgbe2368c)
2.  [Statistical Learning](#org7210ee2)
    1.  [What is Statistical Learning?](#org3f04671)
    2.  [Assessing Model Accuracy](#org249bb05)
    3.  [Lab: Introduction to Python](#org7dc4be7)
        1.  [Basic Commands](#orgbd5f5bc)
        2.  [Graphics](#org2de1168)
        3.  [Indexing Data](#org2052c90)
        4.  [Loading Data](#orga25423a)
        5.  [Additional Graphical and Numerical Summaries](#org1a192e5)
3.  [Linear Regression](#org0f4564e)
    1.  [Simple Linear Regression](#orgc2ef435)
    2.  [Multiple Linear Regression](#org5d4a8a1)
    3.  [Other Considerations in the Regression Model](#org6b2b11a)
    4.  [The Marketing Plan](#org8517571)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orgba87061)
    6.  [Lab: Linear Regression](#org3241772)
        1.  [Libraries](#org2f7bf06)
        2.  [Simple Linear Regression](#org400fde0)
        3.  [Multiple Linear Regression](#org7a85247)
        4.  [Interaction Terms](#orgf9fc68a)
        5.  [Non-linear Transformations of the Predictors](#org11f94c7)
        6.  [Qualitative Predictors](#orgf32a03d)
        7.  [Calling `R` from `Python`](#org96fca86)
4.  [Classification](#orgf789920)
    1.  [An Overview of Classification](#orgf895dfb)
    2.  [Why Not Linear Regression?](#org8689d84)
    3.  [Logistic Regression](#org97d9aae)
    4.  [Linear Discriminant Analysis](#org39123d0)
    5.  [A Comparison of Classification Methods](#orgfbc661c)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org627063d)
        1.  [The Stock Market Data](#orge4deeb1)
        2.  [Logistc Regression](#org0d2c819)
        3.  [Linear Discriminant Analysis](#org9f5994d)
        4.  [Quadratic Discriminant Analysis](#orgcf54d12)
        5.  [K-Nearest Neightbors](#org73ff1d1)
        6.  [An Application to Caravan Insurance Data](#org92c4792)
5.  [Resampling Methods](#org51afa0d)
    1.  [Cross-Validation](#org2839ce5)
    2.  [The Bootstrap](#org42f9182)
    3.  [Lab: Cross-Validation and the Bootstrap](#org40fa4d1)
        1.  [The Validation Set Approach](#orgbf4f417)
        2.  [Leave-One-Out Cross-Validation](#org6557171)
        3.  [k-Fold Cross-Validation](#orged321a3)
        4.  [The Bootstrap](#org5f2cb55)
6.  [Linear Model Selection and Regularization](#org8532307)
    1.  [Subset Selection](#org6655488)
    2.  [Shrinkage Methods](#org2a5980b)
    3.  [Dimension Reduction Methods](#orgd92abd3)
    4.  [Considerations in High Dimensions](#orge5d51a9)
    5.  [Lab 1: Subset Selection Methods](#orgca2b00a)
        1.  [Best Subset Selection](#orge99cc56)
        2.  [Forward and Backward Stepwise Selection](#orgc106d19)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#orgc567ade)
    6.  [Lab 2: Ridge Regression and the Lasso](#org744fc1d)
        1.  [Ridge Regression](#org75b7eb0)
        2.  [The Lasso](#org1a9019f)
    7.  [Lab 3: PCR and PLS Regression](#orga3a5004)
        1.  [Principal Components Regression](#orgbed4c43)
        2.  [Partial Least Squares](#org9100d60)
7.  [Moving Beyond Linearity](#orgd9803d5)
    1.  [Polynomial Regression](#org4bce376)
    2.  [Step Functions](#orge834e83)
    3.  [Basis Functions](#org0abf30e)
    4.  [Regression Splines](#org4313879)
    5.  [Lab: Non-linear Modeling](#org841a146)
        1.  [Polynomial Regression and Step Functions](#orga122679)
8.  [Tree-Based Models](#orgf7d4742)
    1.  [The Basics of Decision Trees](#orgc9a446f)
        1.  [Regression Trees](#org32c37ad)
        2.  [Classification Trees](#orgcd5441d)
        3.  [Trees versus Linear Models](#org60afc10)
    2.  [Bagging, Random Forests, Boosting](#orge1bfbee)
    3.  [Lab: Decision Trees](#org197d890)
        1.  [Fitting Classification Trees](#orgb75602d)
        2.  [Fitting Regression Trees](#org17445fc)
        3.  [Bagging and Random Forests](#org7316606)
        4.  [Boosting](#org54c1fb5)
9.  [Support Vector Machines](#orge1570ad)
    1.  [Maximal Margin Classifier](#orgf4d63d8)
        1.  [What is a Hyperplane?](#org50064ec)
        2.  [Classification Using a Separating Hyperplane](#orgd1e6edb)
        3.  [The Maximal Margin Classifier](#org4dd2f53)
        4.  [Construction of the Maximal Margin Classifier](#orgdf83831)
        5.  [The Non-separable Case](#orgbdde9ef)
    2.  [Support Vector Classifiers](#org6c234aa)
        1.  [Overview of the Support Vector Classifier](#orgb7bb8aa)
        2.  [Details of the Support Vector Classifier](#org4f17f60)
    3.  [Support Vector Machines](#orgc7330b7)
        1.  [Classification with Non-linear Decision Boundaries](#org3f9c378)
        2.  [The Support Vector Machine](#org93ae90a)
        3.  [An Application to the Heart Disease Data](#org60243cb)
    4.  [SVMs with More than Two Classes](#orgd9b724f)
        1.  [One-Versus-One Classification](#org506ade0)
        2.  [One-Versus-All Classification](#org49757fc)
    5.  [Relationship with Logistic Regression](#org97f6b61)
    6.  [Lab: Support Vector Machines](#orga132e82)
        1.  [Support Vector Classifier](#orgb78df9a)
        2.  [Support Vector Machine](#org2922a0b)
        3.  [ROC Curves](#org6dc57cc)
        4.  [SVM with Multiple Classes](#org5c56882)
        5.  [Application to Gene Expression Data](#org00e2db8)
10. [Unsupervised Learning](#org9d46af0)
    1.  [The Challenge of Unsupervised Learning](#orgf3a6ced)
    2.  [Principal Component Analysis](#orga86e921)
        1.  [What are Principal Components?](#orged7970d)
        2.  [Another Interpretation of Principal Components](#org193774e)
        3.  [More on PCA](#org1e93b39)
    3.  [Clustering Methods](#org771dac3)
        1.  [K-Means Clustering](#org33d0901)
        2.  [Hierarchical Clustering](#org2a0e484)
...
Figure [2](#org2796e26) shows graphs of Wage versus three variables. 
...
Figure [4](#org3153074) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org497ec32) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org1c68103) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org6b379dc) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgb9b710e) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org6b379dc).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org0cebc99) provides an illustration of the trade-off between
...
Figure [17](#org96de8ed) provides a simple illustration of the clustering problem.
...
Figure [21](#org8a5961e) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org8a5961e), we see considerable
...
Figure [23](#orgec6a5a9) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org8a5961e) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orgd71bb68) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org8a5961e), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org0d6db9d) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org8a5961e) - [25](#orgd71bb68).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org25e08e9) provides an example using a simulated data set in
...
Figure [31](#org35972bc) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org25e08e9).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org25e08e9), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org25e08e9).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#orgc781fee) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org25e08e9) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org22b9eec) displays the simple linear regression fit to the
...
In figure [50](#org57f4b2a), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgffa2f0c) displays *population regression
...
right-hand panel of figure [52](#orgffa2f0c) we have generated five different
...
For `Advertising` data, table [1](#org7d69af0) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org7d69af0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org7a12467), we report more information about the least squares model.  

<table id="org7a12467" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#orgb27ee8c)  shows results of two simple linear
...
<table id="orgb27ee8c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org99efa2d) illustrates an example of the least squares fit to a
...
Table [4](#orga676bb9) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orga676bb9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgb2891ba) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orga676bb9). 

<table id="orgb2891ba" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org4191055" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orga676bb9).</caption>
...
Figure [61](#org07dc0cd) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org93551fb) records `balance`
...
Table [7](#orge061a2a) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orge061a2a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orga5d3468) we see that the estimated `balance` for the
...
<table id="orga5d3468" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orgd5368be) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org97ab59b), the left panel shows least squares lines when
...
<table id="orgd5368be" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgdd0702e) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org9c4cffc) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org9c4cffc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org285e265) displays a residual plot from the
...
of figure[73](#org285e265) displays the residual plot results from the model
...
Figure [75](#orgecf6a00) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgc17619c), the magnitude of the
...
[79](#org71a5879) illustrates a typical outlier.  The red solid line is the
...
[79](#org71a5879), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org9584745) has
...
[81](#org9584745) are the same as the data displayed in figure
[79](#org71a5879), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org71a5879) and
[81](#org9584745), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org9584745), for a data set with two
...
point. The right-panel of figure [81](#org9584745) provides a plot of
...
Figure [83](#org218e666) illustrates the concept of collinearity.
...
Figure [86](#org32217fc) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org32217fc) displays contour
...
Table [11](#orgbef2361) compares the coefficient estimates obtained from two
...
<table id="orgbef2361" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org6518e74) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org4aab699) provides an example of KNN regression with data
...
Figure [93](#org76abc8b) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org76abc8b)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org4aab699) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgd00d7bc) examines the relative performances of least squares
...
Figure [97](#org8742496) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgd00d7bc), except that we have added additional *noise*
...
In figure [110](#org65ce287), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org98b2107) we show probability of default as a function of
...
Table [12](#org08c6f45) shows the coefficient estimates and related
...
<table id="org08c6f45" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orga65b902) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orga510a4a) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orga65b902" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orga510a4a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org4afe58d) shows average default rates
...
[14](#orga510a4a).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgfd95ef2), two normal density functions
...
figure [121](#orgcc4c9d4).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgcc4c9d4).  In this situation, the base
...
Figure [123](#org7e88f4b) shows an example of three equally sized Gaussian
...
[15](#orge705c10), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgd4e28c4) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orge705c10" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgd4e28c4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orge41ed3c) illustrates the trade-off that results from
...
Figure [128](#orgcabe2e2) displays the ROC curve for the LDA classifier on
...
Table [17](#org4e24905) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org4e24905" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org6f145b2) lists many of the popular performance measures that
are used in this context.

<table id="org6f145b2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org4e24905).</caption>
...
Figure [132](#org07c1f9c) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgf13e053) illustrates the performances of the four
...
Figure [143](#org5144634) displays the *validation set approach*, a simple
...
In figure [145](#org02526eb), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orga1578fc) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org58825d8) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org58825d8) shows nine different 10-fold
...
Figure [151](#orgc044105) illustrates the *k*-fold CV approach.
...
In figure [153](#orga492c60), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org8a5961e),
[23](#orgec6a5a9), and [25](#orgd71bb68) of chapter [2](#orgab42007).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org8a5961e) (left), [23](#orgec6a5a9) (center), and [25](#orgd71bb68) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org8cf8d7d) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org25e08e9).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org4730725) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org4730725) displays the same three curves
...
Figure [160](#org535556d) illustrates the approach for estimating &alpha; by
...
figure [163](#org60fcb63) displays a histogram of the resulting estimates.  The
...
[163](#org60fcb63), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orge1f535e).
...
Table [19](#org84162cc) shows first four selected models for the best subset and
...
<table id="org84162cc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#orgeb36c02) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#orgeb36c02) displays the same ridge
...
[182](#org0a97557) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org3874395), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org3874395), as we
...
Figure [186](#org81c4b6b) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org1b456a1) displays the choice of &lambda; that results from
...
Figure [190](#orgf0ca9fe) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgc967861), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgc967861), the left-hand panel has
...
Figure [195](#orga1311a4) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org0b21967) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org8e94a1f) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org9ec6132) further illustrates the risk of carelessly applying
...
Figure [203](#org168c0f6) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org3c753f1) is a plot of `wage` against
...
The left-hand panel of figure [227](#org634a9d8) shows a fit of step functions
to the `Wage` data from figure [225](#org3c753f1).  We also fit the logistic
...
Figure [234](#org0593ddf) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#org5d04421) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org0593ddf).")

Figure [238](#org9a2a9c3) shows a five-region example of prediction via
...
Figure [240](#org6359666) is an example of when a linear model or a tree
...
Figure [242](#orgfeb1554) is a graphical representation of *variable
...
Figure [247](#org7550d7f) shows a hyperplane in two-dimensional space.
...
Figure [249](#orged082c5) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#org8de85aa), we see that three training observations are
...
[251](#org8de85aa), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#org9f7b598) shows an example where we cannot *exactly* separate the two
...
In figures [255](#orge43b461), addition of a single observation in the right hand panel
...
Figure [257](#org9f143b3) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#org5627976) illustrates the width of margin for different values of
...
In figure [261](#org138a99e) consider the data shown in the left panel.  It is clear
...
In figure [263](#org33ac9bc), the left-hand panel shows an example of SVM with a
polynomial kernel applied the non-linear data from figure [261](#org138a99e).  The fit
...
![img](figures/fig9_9.png "Left: An SVM with a polynomial kernel of degree 3 is applied to the non-linear data from figure [261](#org138a99e), resulting in a more appropriate decision rule.  Right: An SVM with a radial kernel is applied.  In this example, radial kernel is the most capable of capturing the decision boundary.")
...
In figure [265](#org98836a9), the left-hand panel displays ROC curves for training set
...
Figure [267](#orgb8de0cb) compares ROC curves on test observations.  Using default
...
[20](#orgcd4b96a) shows loadings of the first two principal components.
Figure [273](#org77d8fa8) plots the first two principal components of these
data.  The figure represents both the principal component scores and the loading
vectors in a single *biplot* display.

<table id="orgcd4b96a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 20:</span> The principal component loading factors, &phi;<sub>1</sub> and &phi;<sub>2</sub>, for the `USArrests` data.  These are also displayed in figure [273](#org77d8fa8).</caption>
...
In figure [275](#orgabddd06), the left-hand panel is the same as figure
[273](#org77d8fa8), where each variable was first scaled to have mean zero and standard
...
![img](figures/fig10_3.png "Two principal component biplots for `USArrests` data.  Left: Same as figure [273](#org77d8fa8), with variables scaled to have unit standard deviations.  Right: Principal components using unscaled data.  `Assault` has by far the largest loading on the first principal component because it has the largest variance among the four variables.  In general, it is recommended to scale variables to have standard deviation one.")

In Figure [277](#orgd390024), the left-hand panel shows the proportion of
...
Figure [279](#orgb470670) shows the results obtained from performing *K*-means
...
Figure [281](#orga067b64) shows the progression of the *K*-Means Clustering
Algorithm on the toy example from figure [279](#orgb470670). 

![img](figures/fig10_6.png "The progress of *K*-means algorithm on the example of figure [279](#orgb470670) with \(K = 3\).  Top left: The observations are shown.  Top center: In Step 1 of the algorithm, each observation is randomly assigned to a cluster.  Top right: In Step 2(a), the cluster centroids are computed.  These are shown as \(\times\).  Since the clusters were chosen at random, initially centroids are almost overlapping.  Bottom left: In Step 2(b), each observation is assigned to the nearest centroid.  Bottom center: Step 2(a) is once again performed, leading to new cluster centroids.  Bottom right: The results obtained after five iterations.")

Figure [283](#orga5b0ab5) shows the local optima obtained by running *K*-means
clustering six times using six different initial cluster assignments, using toy data
from figure [279](#orgb470670). 
...
We begin with the simulated data set shown in figure [285](#org114e5e2),
...
figure [286](#orgf368a69).  In the center-panel, cutting the dendrogram at a
