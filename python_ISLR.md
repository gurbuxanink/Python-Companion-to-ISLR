...
1.  [Introduction](#org7fc000a)
2.  [Statistical Learning](#orgf72e1aa)
    1.  [What is Statistical Learning?](#org2fcd57c)
    2.  [Assessing Model Accuracy](#orge9987df)
    3.  [Lab: Introduction to Python](#org16490ca)
        1.  [Basic Commands](#org5ae18c6)
        2.  [Graphics](#org6bd958d)
        3.  [Indexing Data](#org20fda97)
        4.  [Loading Data](#org84cd1e9)
        5.  [Additional Graphical and Numerical Summaries](#orga88ca34)
3.  [Linear Regression](#orgfaa7db4)
    1.  [Simple Linear Regression](#org9e5a3a0)
    2.  [Multiple Linear Regression](#org07f89d5)
    3.  [Other Considerations in the Regression Model](#org9d88f08)
    4.  [The Marketing Plan](#org366603a)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org0c69458)
    6.  [Lab: Linear Regression](#orgf8b18b7)
        1.  [Libraries](#org64a3ad8)
        2.  [Simple Linear Regression](#org1055562)
        3.  [Multiple Linear Regression](#orgf53501d)
        4.  [Interaction Terms](#orgecf5743)
        5.  [Non-linear Transformations of the Predictors](#org6223153)
        6.  [Qualitative Predictors](#org6e84df6)
        7.  [Calling `R` from `Python`](#org0a7ff38)
4.  [Classification](#org0480573)
    1.  [An Overview of Classification](#org90437c5)
    2.  [Why Not Linear Regression?](#orgef97c69)
    3.  [Logistic Regression](#org55fcdae)
    4.  [Linear Discriminant Analysis](#orgccb34ae)
    5.  [A Comparison of Classification Methods](#org943fecf)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org4ce2410)
        1.  [The Stock Market Data](#org1c001ce)
        2.  [Logistc Regression](#orgb417696)
        3.  [Linear Discriminant Analysis](#orga2a7dfa)
        4.  [Quadratic Discriminant Analysis](#orgc0fa747)
        5.  [K-Nearest Neightbors](#org0c9383a)
        6.  [An Application to Caravan Insurance Data](#org3cdb139)
5.  [Resampling Methods](#org3cde72e)
    1.  [Cross-Validation](#org050c826)
    2.  [The Bootstrap](#org0801536)
    3.  [Lab: Cross-Validation and the Bootstrap](#org7c702c8)
        1.  [The Validation Set Approach](#orgec9584f)
        2.  [Leave-One-Out Cross-Validation](#orgbaf3913)
        3.  [k-Fold Cross-Validation](#org4bfdd64)
        4.  [The Bootstrap](#org3ae4fc8)
6.  [Linear Model Selection and Regularization](#org0d36bb4)
    1.  [Subset Selection](#orgede129e)
    2.  [Shrinkage Methods](#org74adda4)
    3.  [Dimension Reduction Methods](#orgefa0a48)
    4.  [Considerations in High Dimensions](#orgba3d1e5)
...
Figure [2](#orgf94c51b) shows graphs of Wage versus three variables. 
...
Figure [4](#org8b8fde7) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org0f2aa4c) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org8d27d18) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orgbedcac7) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org8b4a7e4) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orgbedcac7).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org2241481) provides an illustration of the trade-off between
...
Figure [17](#orgc1d4909) provides a simple illustration of the clustering problem.
...
Figure [21](#org5c3ed74) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org5c3ed74), we see considerable
...
Figure [23](#org0f30270) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org5c3ed74) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org661da73) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org5c3ed74), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org1a5b315) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org5c3ed74) - [25](#org661da73).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org961beac) provides an example using a simulated data set in
...
Figure [31](#org8d70d50) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org961beac).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org961beac), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org961beac).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org4ac823e) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org961beac) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org47fc7c3) displays the simple linear regression fit to the
...
In figure [50](#org0d44888), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#org2f098bc) displays *population regression
...
right-hand panel of figure [52](#org2f098bc) we have generated five different
...
For `Advertising` data, table [1](#orgecb70ef) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgecb70ef" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org6fc9a7c), we report more information about the least squares model.  

<table id="org6fc9a7c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org152e1a0)  shows results of two simple linear
...
<table id="org152e1a0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org8a27479) illustrates an example of the least squares fit to a
...
Table [4](#org84ea691) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org84ea691" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgc55306d) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org84ea691). 

<table id="orgc55306d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgae4a644" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org84ea691).</caption>
...
Figure [61](#orgeffde2a) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org427170e) records `balance`
...
Table [7](#org748a70b) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org748a70b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org549bee6) we see that the estimated `balance` for the
...
<table id="org549bee6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org48c3943) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgf4b25e9), the left panel shows least squares lines when
...
<table id="org48c3943" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org53f2d46) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org8404a9f) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org8404a9f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org6d0707f) displays a residual plot from the
...
of figure[73](#org6d0707f) displays the residual plot results from the model
...
Figure [75](#org017d4c5) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgfaa85b6), the magnitude of the
...
[79](#orga890ee2) illustrates a typical outlier.  The red solid line is the
...
[79](#orga890ee2), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org5ad74f1) has
...
[81](#org5ad74f1) are the same as the data displayed in figure
[79](#orga890ee2), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orga890ee2) and
[81](#org5ad74f1), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org5ad74f1), for a data set with two
...
point. The right-panel of figure [81](#org5ad74f1) provides a plot of
...
Figure [83](#orga4a5d19) illustrates the concept of collinearity.
...
Figure [86](#org3f4402e) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org3f4402e) displays contour
...
Table [11](#org9b0e096) compares the coefficient estimates obtained from two
...
<table id="org9b0e096" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org2eda508) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org666385c) provides an example of KNN regression with data
...
Figure [93](#orgba15549) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgba15549)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org666385c) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org9640519) examines the relative performances of least squares
...
Figure [97](#orga9ebecd) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org9640519), except that we have added additional *noise*
...
In figure [110](#org10f04f2), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orga883230) we show probability of default as a function of
...
Table [12](#orgd4bc015) shows the coefficient estimates and related
...
<table id="orgd4bc015" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org560bd80) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org7058963) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org560bd80" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org7058963" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org549e403) shows average default rates
...
[14](#org7058963).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgfbc64c3), two normal density functions
...
figure [121](#orgf85b098).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#orgf85b098).  In this situation, the base
...
Figure [123](#orgc723d5d) shows an example of three equally sized Gaussian
...
[15](#org18407c3), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org7846a82) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org18407c3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org7846a82" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org4b56e24) illustrates the trade-off that results from
...
Figure [128](#orgaf4f70f) displays the ROC curve for the LDA classifier on
...
Table [17](#org9a48956) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org9a48956" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgc60c6ca) lists many of the popular performance measures that
are used in this context.

<table id="orgc60c6ca" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org9a48956).</caption>
...
Figure [132](#org02d41cb) illustrates the performances of LDA and QDA in two
...
Figure [134](#org8c57133) illustrates the performances of the four
...
Figure [143](#org0aa1980) displays the *validation set approach*, a simple
...
In figure [145](#org26d846b), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orga9cdb22) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org09e4e3c) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org09e4e3c) shows nine different 10-fold
...
Figure [151](#org31e2cac) illustrates the *k*-fold CV approach.
...
In figure [153](#orgd0e0a8b), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org5c3ed74),
[23](#org0f30270), and [25](#org661da73) of chapter [2](#org8f20122).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org5c3ed74) (left), [23](#org0f30270) (center), and [25](#org661da73) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orgb947ba3) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org961beac).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org390953e) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org390953e) displays the same three curves
...
Figure [160](#org2f6a19c) illustrates the approach for estimating &alpha; by
...
figure [163](#org49d7701) displays a histogram of the resulting estimates.  The
...
[163](#org49d7701), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org5b58f6e).
...
Table [19](#org78732f1) shows first four selected models for the best subset and
...
<table id="org78732f1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org1519b64) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org1519b64) displays the same ridge
...
[182](#orge9f4291) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org516c470), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org516c470), as we
...
Figure [186](#org198bf29) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgfc2144a) displays the choice of &lambda; that results from
...
Figure [190](#org0c4358e) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org8d44b3a), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org8d44b3a), the left-hand panel has
...
Figure [195](#orga5f3aef) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgfd4ccd6) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org25abb6d) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orgedb7eed) further illustrates the risk of carelessly applying
