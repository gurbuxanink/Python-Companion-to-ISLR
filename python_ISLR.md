...
1.  [Introduction](#org9a77150)
2.  [Statistical Learning](#orgee69dc7)
    1.  [What is Statistical Learning?](#org64c29db)
    2.  [Assessing Model Accuracy](#org581575a)
    3.  [Lab: Introduction to Python](#orgfb4737b)
        1.  [Basic Commands](#org95ff33d)
        2.  [Graphics](#orge97b448)
        3.  [Indexing Data](#orgb88d0fe)
        4.  [Loading Data](#org4fb5dbb)
        5.  [Additional Graphical and Numerical Summaries](#orga6c97ca)
3.  [Linear Regression](#org31392f9)
    1.  [Simple Linear Regression](#orgef0b78c)
    2.  [Multiple Linear Regression](#org42a4758)
    3.  [Other Considerations in the Regression Model](#org1d82f8c)
    4.  [The Marketing Plan](#orga34f121)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org1fd142b)
    6.  [Lab: Linear Regression](#org8ac08bb)
        1.  [Libraries](#org77d552a)
        2.  [Simple Linear Regression](#org0bb2288)
        3.  [Multiple Linear Regression](#org5a6fab8)
        4.  [Interaction Terms](#orgb5a8349)
        5.  [Non-linear Transformations of the Predictors](#orgee48821)
        6.  [Qualitative Predictors](#orgdb044f1)
        7.  [Calling `R` from `Python`](#org6295bb8)
4.  [Classification](#org25ece8f)
    1.  [An Overview of Classification](#org8965bee)
    2.  [Why Not Linear Regression?](#org2acd390)
    3.  [Logistic Regression](#orge2924ae)
    4.  [Linear Discriminant Analysis](#orgecb3c63)
    5.  [A Comparison of Classification Methods](#org583b04d)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org2839092)
        1.  [The Stock Market Data](#org68c37e0)
        2.  [Logistc Regression](#org32b246c)
        3.  [Linear Discriminant Analysis](#org596ae49)
        4.  [Quadratic Discriminant Analysis](#orgb2ca344)
        5.  [K-Nearest Neightbors](#org4c4111f)
        6.  [An Application to Caravan Insurance Data](#org5ec856d)
5.  [Resampling Methods](#orgd599432)
    1.  [Cross-Validation](#orgdeeb451)
    2.  [The Bootstrap](#org07f4dad)
    3.  [Lab: Cross-Validation and the Bootstrap](#org2cee5ee)
        1.  [The Validation Set Approach](#orgbdfb3eb)
        2.  [Leave-One-Out Cross-Validation](#orge805c76)
        3.  [k-Fold Cross-Validation](#org0e77f21)
        4.  [The Bootstrap](#org108f54b)
6.  [Linear Model Selection and Regularization](#org2f0089d)
    1.  [Subset Selection](#org9bd7a9d)
    2.  [Shrinkage Methods](#org0e48c1c)
    3.  [Dimension Reduction Methods](#org928ae8b)
...
Figure [2](#org1de0e7a) shows graphs of Wage versus three variables. 
...
Figure [4](#org22accad) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org1d6bcda) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orgbef05fd) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#orgbba3491) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org812e89b) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#orgbba3491).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org045259a) provides an illustration of the trade-off between
...
Figure [17](#orgb38d2a9) provides a simple illustration of the clustering problem.
...
Figure [21](#org37d72e4) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org37d72e4), we see considerable
...
Figure [23](#org2a6069f) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org37d72e4) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org6d4d441) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org37d72e4), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org90003a4) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org37d72e4) - [25](#org6d4d441).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org993aaea) provides an example using a simulated data set in
...
Figure [31](#orga8bee01) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org993aaea).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org993aaea), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org993aaea).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org8175140) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org993aaea) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgd016866) displays the simple linear regression fit to the
...
In figure [50](#orgc81909e), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgd2ebff9) displays *population regression
...
right-hand panel of figure [52](#orgd2ebff9) we have generated five different
...
For `Advertising` data, table [1](#org3e69151) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org3e69151" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#orgd20c64b), we report more information about the least squares model.  

<table id="orgd20c64b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org41b1799)  shows results of two simple linear
...
<table id="org41b1799" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org77a4d1e) illustrates an example of the least squares fit to a
...
Table [4](#org67a57af) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org67a57af" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgb465444) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org67a57af). 

<table id="orgb465444" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org9ac691a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org67a57af).</caption>
...
Figure [61](#org0c58ff8) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org201e3f6) records `balance`
...
Table [7](#org7244db2) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org7244db2" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgcd3106c) we see that the estimated `balance` for the
...
<table id="orgcd3106c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org4ade2d0) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#orgb97a9b5), the left panel shows least squares lines when
...
<table id="org4ade2d0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgf049de1) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org3305968) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org3305968" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orge31212a) displays a residual plot from the
...
of figure[73](#orge31212a) displays the residual plot results from the model
...
Figure [75](#orga4edb73) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgea1bca2), the magnitude of the
...
[79](#orgf86b532) illustrates a typical outlier.  The red solid line is the
...
[79](#orgf86b532), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org0316881) has
...
[81](#org0316881) are the same as the data displayed in figure
[79](#orgf86b532), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgf86b532) and
[81](#org0316881), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org0316881), for a data set with two
...
point. The right-panel of figure [81](#org0316881) provides a plot of
...
Figure [83](#org8baa79c) illustrates the concept of collinearity.
...
Figure [86](#orgcbedbc9) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgcbedbc9) displays contour
...
Table [11](#org250eec8) compares the coefficient estimates obtained from two
...
<table id="org250eec8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org43fa0e5) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org4004bdf) provides an example of KNN regression with data
...
Figure [93](#org4164013) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org4164013)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org4004bdf) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org2cd507e) examines the relative performances of least squares
...
Figure [97](#org832adc6) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org2cd507e), except that we have added additional *noise*
...
In figure [110](#org8dcac22), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orge48cc03) we show probability of default as a function of
...
Table [12](#org4d23d26) shows the coefficient estimates and related
...
<table id="org4d23d26" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orge721aec) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org41f86f7) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orge721aec" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org41f86f7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org936e6ff) shows average default rates
...
[14](#org41f86f7).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org9d97b98), two normal density functions
...
figure [121](#org0b096c2).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org0b096c2).  In this situation, the base
...
Figure [123](#orgd4093fc) shows an example of three equally sized Gaussian
...
[15](#org3152705), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org9671bff) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org3152705" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org9671bff" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org86ee21f) illustrates the trade-off that results from
...
Figure [128](#org8c2a30a) displays the ROC curve for the LDA classifier on
...
Table [17](#orgb7fb312) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orgb7fb312" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orgb052585) lists many of the popular performance measures that
are used in this context.

<table id="orgb052585" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-above"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orgb7fb312).</caption>
...
Figure [132](#org53452d1) illustrates the performances of LDA and QDA in two
...
Figure [134](#orgfa750ca) illustrates the performances of the four
...
Figure [143](#org9db2f60) displays the *validation set approach*, a simple
...
In figure [145](#orga82f8e1), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org6cc6235) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org4697593) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org4697593) shows nine different 10-fold
...
Figure [151](#orgac548ab) illustrates the *k*-fold CV approach.
...
In figure [153](#org85e36af), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org37d72e4),
[23](#org2a6069f), and [25](#org6d4d441) of chapter [2](#org518429d).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org37d72e4) (left), [23](#org2a6069f) (center), and [25](#org6d4d441) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org6e4ca2f) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org993aaea).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org594a361) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org594a361) displays the same three curves
...
Figure [160](#org0fd9958) illustrates the approach for estimating &alpha; by
...
figure [163](#orga1d8d52) displays a histogram of the resulting estimates.  The
...
[163](#orga1d8d52), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org3083c9a).
...
Table [19](#orgcc9b229) shows first four selected models for the best subset and
...
<table id="orgcc9b229" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#orga9f9b67) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#orga9f9b67) displays the same ridge
...
[182](#org4677c01) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgff694e0), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgff694e0), as we
...
Figure [186](#org40c5a76) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgd6fc192) displays the choice of &lambda; that results from
