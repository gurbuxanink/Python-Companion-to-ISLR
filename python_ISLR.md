...
1.  [Introduction](#org8ad0bcf)
2.  [Statistical Learning](#orgd6d5b2d)
    1.  [What is Statistical Learning?](#org24d1e38)
    2.  [Assessing Model Accuracy](#orgbd44655)
    3.  [Lab: Introduction to Python](#org26c29f1)
        1.  [Basic Commands](#org33bbd7a)
        2.  [Graphics](#org79e7881)
        3.  [Indexing Data](#orgaa29377)
        4.  [Loading Data](#org16e5b28)
        5.  [Additional Graphical and Numerical Summaries](#org5bd86e6)
3.  [Linear Regression](#orgc6aeddc)
    1.  [Simple Linear Regression](#orgf41a4f7)
    2.  [Multiple Linear Regression](#org45e8791)
    3.  [Other Considerations in the Regression Model](#org026b5c4)
    4.  [The Marketing Plan](#org510ae2e)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org3a073e3)
    6.  [Lab: Linear Regression](#org1de9c31)
        1.  [Libraries](#org3da7c7f)
        2.  [Simple Linear Regression](#orgd8906bf)
        3.  [Multiple Linear Regression](#org8dfed84)
        4.  [Interaction Terms](#org4f77376)
        5.  [Non-linear Transformations of the Predictors](#orgcf91ef2)
        6.  [Qualitative Predictors](#org8433fe5)
        7.  [Calling `R` from `Python`](#orge7835e2)
4.  [Classification](#org078ccb8)
    1.  [An Overview of Classification](#org52d94d6)
    2.  [Why Not Linear Regression?](#orgef460fd)
    3.  [Logistic Regression](#orgcca4482)
    4.  [Linear Discriminant Analysis](#orgd66bfae)
    5.  [A Comparison of Classification Methods](#orge455d5e)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org3d095ac)
        1.  [The Stock Market Data](#org420406e)
        2.  [Logistc Regression](#org30cab0b)
        3.  [Linear Discriminant Analysis](#orgbea9269)
        4.  [Quadratic Discriminant Analysis](#org642085c)
        5.  [K-Nearest Neightbors](#orga441100)
        6.  [An Application to Caravan Insurance Data](#org6fb94ca)
5.  [Resampling Methods](#org6b00740)
    1.  [Cross-Validation](#orgfaad441)
    2.  [The Bootstrap](#orgebfdc4b)
    3.  [Lab: Cross-Validation and the Bootstrap](#org34aa89c)
        1.  [The Validation Set Approach](#orgfcf324f)
        2.  [Leave-One-Out Cross-Validation](#orgaeae1ca)
        3.  [k-Fold Cross-Validation](#orgd42a799)
        4.  [The Bootstrap](#orgb90874e)
6.  [Linear Model Selection and Regularization](#org549b19b)
    1.  [Subset Selection](#orgae80ede)
    2.  [Shrinkage Methods](#orgf8f235c)
    3.  [Dimension Reduction Methods](#org4a87b38)
    4.  [Considerations in High Dimensions](#org40b1695)
    5.  [Lab 1: Subset Selection Methods](#org17624de)
        1.  [Best Subset Selection](#orgc90270e)
        2.  [Forward and Backward Stepwise Selection](#org235ccc5)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org2f5b70b)
...
Figure [2](#orge74d6d2) shows graphs of Wage versus three variables. 
...
Figure [4](#org24bf664) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org125a501) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#orge98b814) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org47ad6a2) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org52ec0a6) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org47ad6a2).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orgc7432c2) provides an illustration of the trade-off between
...
Figure [17](#orgd0096a9) provides a simple illustration of the clustering problem.
...
Figure [21](#org10eff07) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#org10eff07), we see considerable
...
Figure [23](#orgffc98c3) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#org10eff07) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org7faeb3c) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#org10eff07), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgf5ed680) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#org10eff07) - [25](#org7faeb3c).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org5d041ba) provides an example using a simulated data set in
...
Figure [31](#orgcc9bb87) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org5d041ba).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org5d041ba), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org5d041ba).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org6d86b95) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org5d041ba) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#orgcda60c4) displays the simple linear regression fit to the
...
In figure [50](#org3978fc4), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgd7a45c3) displays *population regression
...
right-hand panel of figure [52](#orgd7a45c3) we have generated five different
...
For `Advertising` data, table [1](#org9feda94) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org9feda94" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org16b1cd3), we report more information about the least squares model.  

<table id="org16b1cd3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org7394f85)  shows results of two simple linear
...
<table id="org7394f85" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org2e1e30b) illustrates an example of the least squares fit to a
...
Table [4](#orgdd558f3) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgdd558f3" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orge6cfc1b) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgdd558f3). 

<table id="orge6cfc1b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org685cc66" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgdd558f3).</caption>
...
Figure [61](#org44e4d31) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orgdcfd053) records `balance`
...
Table [7](#org5bfc86b) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org5bfc86b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orged0d4bb) we see that the estimated `balance` for the
...
<table id="orged0d4bb" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org49be73c) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org44bf0b6), the left panel shows least squares lines when
...
<table id="org49be73c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgef03613) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org131b306) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org131b306" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orga3001b4) displays a residual plot from the
...
of figure[73](#orga3001b4) displays the residual plot results from the model
...
Figure [75](#orgccf445a) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org9a42af9), the magnitude of the
...
[79](#org2fe4893) illustrates a typical outlier.  The red solid line is the
...
[79](#org2fe4893), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org1068283) has
...
[81](#org1068283) are the same as the data displayed in figure
[79](#org2fe4893), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org2fe4893) and
[81](#org1068283), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org1068283), for a data set with two
...
point. The right-panel of figure [81](#org1068283) provides a plot of
...
Figure [83](#orgd4d9287) illustrates the concept of collinearity.
...
Figure [86](#org539829a) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org539829a) displays contour
...
Table [11](#org56c4cd5) compares the coefficient estimates obtained from two
...
<table id="org56c4cd5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#orgb3eb50e) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org6bac3d7) provides an example of KNN regression with data
...
Figure [93](#org32689dd) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org32689dd)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org6bac3d7) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgf4a2b59) examines the relative performances of least squares
...
Figure [97](#org5024aa2) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgf4a2b59), except that we have added additional *noise*
...
In figure [110](#orgac00002), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org6e82d3a) we show probability of default as a function of
...
Table [12](#orgcd1f1f0) shows the coefficient estimates and related
...
<table id="orgcd1f1f0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org15a668e) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org23d9f15) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org15a668e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org23d9f15" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgc77cf47) shows average default rates
...
[14](#org23d9f15).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org2d0457c), two normal density functions
...
figure [121](#org6391cd8).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org6391cd8).  In this situation, the base
...
Figure [123](#org2337c58) shows an example of three equally sized Gaussian
...
[15](#org3d9257f), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#org205ce73) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org3d9257f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org205ce73" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgb989fa7) illustrates the trade-off that results from
...
Figure [128](#org812a71b) displays the ROC curve for the LDA classifier on
...
Table [17](#org3cc00ef) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org3cc00ef" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org0d2b136) lists many of the popular performance measures that
are used in this context.

<table id="org0d2b136" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org3cc00ef).</caption>
...
Figure [132](#org50632ad) illustrates the performances of LDA and QDA in two
...
Figure [134](#org8a5f3a0) illustrates the performances of the four
...
Figure [143](#orgb9b55ef) displays the *validation set approach*, a simple
...
In figure [145](#org0e0d576), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org5700301) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#orgaf7730c) shows test set MSE as a function of
...
The right-hand panel of figure [149](#orgaf7730c) shows nine different 10-fold
...
Figure [151](#orge3c409f) illustrates the *k*-fold CV approach.
...
In figure [153](#orgbadbfbf), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#org10eff07),
[23](#orgffc98c3), and [25](#org7faeb3c) of chapter [2](#org21c79d4).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#org10eff07) (left), [23](#orgffc98c3) (center), and [25](#org7faeb3c) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org41f4ba2) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org5d041ba).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgfb29c4a) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgfb29c4a) displays the same three curves
...
Figure [160](#org113b9e9) illustrates the approach for estimating &alpha; by
...
figure [163](#org406fd0b) displays a histogram of the resulting estimates.  The
...
[163](#org406fd0b), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orgce5fa94).
...
Table [19](#org3fc6939) shows first four selected models for the best subset and
...
<table id="org3fc6939" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org25e8338) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org25e8338) displays the same ridge
...
[182](#org8627e3f) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org44c0838), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org44c0838), as we
...
Figure [186](#org222887a) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgae76927) displays the choice of &lambda; that results from
...
Figure [190](#orge44d9d6) shows daily changes in 10-year Treasury note yield (`10
...
[193](#orgec72750), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#orgec72750), the left-hand panel has
...
Figure [195](#orge908924) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org4c7be29) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orgc4da5e8) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org87e08f7) further illustrates the risk of carelessly applying
...
Figure [203](#org10416e3) illustrates the performance of the lasso in a simple
