...
1.  [Introduction](#org8139eca)
2.  [Statistical Learning](#org1392da6)
    1.  [What is Statistical Learning?](#org8fa2456)
    2.  [Assessing Model Accuracy](#org79f9699)
    3.  [Lab: Introduction to Python](#org91c993f)
        1.  [Basic Commands](#orgda20d39)
        2.  [Graphics](#orga3f4b36)
        3.  [Indexing Data](#org59040c4)
        4.  [Loading Data](#orga0c3381)
        5.  [Additional Graphical and Numerical Summaries](#org13b6168)
3.  [Linear Regression](#org1fa7bce)
    1.  [Simple Linear Regression](#org02d660f)
    2.  [Multiple Linear Regression](#org0319e47)
    3.  [Other Considerations in the Regression Model](#org6b2f7b9)
    4.  [The Marketing Plan](#orgffa9480)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org5209662)
    6.  [Lab: Linear Regression](#orgc5c7351)
        1.  [Libraries](#orgf1440ca)
        2.  [Simple Linear Regression](#org5a51de9)
        3.  [Multiple Linear Regression](#orgd0d70ec)
        4.  [Interaction Terms](#org3c07c14)
        5.  [Non-linear Transformations of the Predictors](#org1b612ea)
        6.  [Qualitative Predictors](#orgd5caf12)
        7.  [Calling `R` from `Python`](#org4483b70)
4.  [Classification](#org3d7af59)
    1.  [An Overview of Classification](#org54cc017)
    2.  [Why Not Linear Regression?](#orgc302087)
    3.  [Logistic Regression](#org49a8e57)
    4.  [Linear Discriminant Analysis](#org24e8f37)
    5.  [A Comparison of Classification Methods](#org2f29d92)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org2b0ebc7)
        1.  [The Stock Market Data](#org28eb455)
        2.  [Logistc Regression](#orgaef8389)
        3.  [Linear Discriminant Analysis](#orgd2b7e3f)
        4.  [Quadratic Discriminant Analysis](#orge6e94ef)
        5.  [K-Nearest Neightbors](#org00bfc8e)
        6.  [An Application to Caravan Insurance Data](#orgf9c8f70)
5.  [Resampling Methods](#org525e331)
    1.  [Cross-Validation](#org9c4210d)
    2.  [The Bootstrap](#orgfb98461)
    3.  [Lab: Cross-Validation and the Bootstrap](#org35f6137)
        1.  [The Validation Set Approach](#orgcb377c2)
        2.  [Leave-One-Out Cross-Validation](#org8ec8ad7)
        3.  [k-Fold Cross-Validation](#orga48cbfb)
        4.  [The Bootstrap](#org4af0da0)
6.  [Linear Model Selection and Regularization](#org8efc743)
    1.  [Subset Selection](#orgd764d6d)
    2.  [Shrinkage Methods](#orgf83679b)
    3.  [Dimension Reduction Methods](#org62778c4)
    4.  [Considerations in High Dimensions](#org90b0655)
    5.  [Lab 1: Subset Selection Methods](#orgea535e6)
        1.  [Best Subset Selection](#orge47a69f)
        2.  [Forward and Backward Stepwise Selection](#org0dd04e7)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#orgc73fba3)
    6.  [Lab 2: Ridge Regression and the Lasso](#org0b93a24)
        1.  [Ridge Regression](#orgf7e4b5b)
        2.  [The Lasso](#org5697ecb)
    7.  [Lab 3: PCR and PLS Regression](#org144e75d)
        1.  [Principal Components Regression](#orgc6c465e)
        2.  [Partial Least Squares](#org54c6e4f)
7.  [Moving Beyond Linearity](#org3436271)
    1.  [Polynomial Regression](#org1530791)
...
Figure [2](#orga71bcc8) shows graphs of Wage versus three variables. 
...
Figure [4](#org9c87b58) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org4d4a68c) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org27ad839) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org392c28c) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgc023db0) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org392c28c).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#org563298c) provides an illustration of the trade-off between
...
Figure [17](#orge0706bd) provides a simple illustration of the clustering problem.
...
Figure [21](#orgec478f2) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgec478f2), we see considerable
...
Figure [23](#orgf2fbc7b) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgec478f2) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#orgb9aa91b) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgec478f2), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org21eb136) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgec478f2) - [25](#orgb9aa91b).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#org2b22c62) provides an example using a simulated data set in
...
Figure [31](#org69c61e1) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#org2b22c62).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#org2b22c62), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#org2b22c62).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org0d5b300) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#org2b22c62) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org7bc8eae) displays the simple linear regression fit to the
...
In figure [50](#org1620afa), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgfd2b467) displays *population regression
...
right-hand panel of figure [52](#orgfd2b467) we have generated five different
...
For `Advertising` data, table [1](#orgdf7cbaa) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgdf7cbaa" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org8847c6d), we report more information about the least squares model.  

<table id="org8847c6d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org9aa3467)  shows results of two simple linear
...
<table id="org9aa3467" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#orgd84116a) illustrates an example of the least squares fit to a
...
Table [4](#orgba4b63b) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgba4b63b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org713225b) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgba4b63b). 

<table id="org713225b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orged9b257" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgba4b63b).</caption>
...
Figure [61](#org6d14bbf) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#org4a011b3) records `balance`
...
Table [7](#orgb063921) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgb063921" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org6e6886f) we see that the estimated `balance` for the
...
<table id="org6e6886f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org0127073) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org301daff), the left panel shows least squares lines when
...
<table id="org0127073" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org07d1c35) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#org2e768f1) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="org2e768f1" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orga7730e3) displays a residual plot from the
...
of figure[73](#orga7730e3) displays the residual plot results from the model
...
Figure [75](#orge59478f) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#org0881b25), the magnitude of the
...
[79](#org1ba7754) illustrates a typical outlier.  The red solid line is the
...
[79](#org1ba7754), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org251b6d0) has
...
[81](#org251b6d0) are the same as the data displayed in figure
[79](#org1ba7754), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#org1ba7754) and
[81](#org251b6d0), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org251b6d0), for a data set with two
...
point. The right-panel of figure [81](#org251b6d0) provides a plot of
...
Figure [83](#orgf24a628) illustrates the concept of collinearity.
...
Figure [86](#orgf607f0e) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orgf607f0e) displays contour
...
Table [11](#org5f5e29f) compares the coefficient estimates obtained from two
...
<table id="org5f5e29f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#orgdde6c89) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org65af229) provides an example of KNN regression with data
...
Figure [93](#orgb5f8653) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#orgb5f8653)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org65af229) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org4d5fa91) examines the relative performances of least squares
...
Figure [97](#org2fe867d) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org4d5fa91), except that we have added additional *noise*
...
In figure [110](#org2f3e2ef), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org400396b) we show probability of default as a function of
...
Table [12](#orgb153044) shows the coefficient estimates and related
...
<table id="orgb153044" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org65a1494) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org08a7d73) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org65a1494" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org08a7d73" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org8eb21f1) shows average default rates
...
[14](#org08a7d73).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgdbaaded), two normal density functions
...
figure [121](#org575a90a).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org575a90a).  In this situation, the base
...
Figure [123](#orgc336c54) shows an example of three equally sized Gaussian
...
[15](#org6bb6af4), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgac9c89a) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="org6bb6af4" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgac9c89a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#org67df865) illustrates the trade-off that results from
...
Figure [128](#org9f9acbb) displays the ROC curve for the LDA classifier on
...
Table [17](#org29ab388) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="org29ab388" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org2bf28cd) lists many of the popular performance measures that
are used in this context.

<table id="org2bf28cd" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#org29ab388).</caption>
...
Figure [132](#orgffb9aac) illustrates the performances of LDA and QDA in two
...
Figure [134](#org73c22d2) illustrates the performances of the four
...
Figure [143](#org763e589) displays the *validation set approach*, a simple
...
In figure [145](#org2aada2e), the left-hand panel shows validation sample MSE as a
...
Figure [147](#orgd4854f1) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org6cdd90c) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org6cdd90c) shows nine different 10-fold
...
Figure [151](#orgb2ba5be) illustrates the *k*-fold CV approach.
...
In figure [153](#org11438a5), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgec478f2),
[23](#orgf2fbc7b), and [25](#orgb9aa91b) of chapter [2](#org925e203).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgec478f2) (left), [23](#orgf2fbc7b) (center), and [25](#orgb9aa91b) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org576d2b5) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#org2b22c62).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org09f72e9) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org09f72e9) displays the same three curves
...
Figure [160](#orgf893847) illustrates the approach for estimating &alpha; by
...
figure [163](#org53c1962) displays a histogram of the resulting estimates.  The
...
[163](#org53c1962), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org0b8d72b).
...
Table [19](#orgc4d11e7) shows first four selected models for the best subset and
...
<table id="orgc4d11e7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org7fa62df) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org7fa62df) displays the same ridge
...
[182](#orgbe2c8dd) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#orgf136578), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#orgf136578), as we
...
Figure [186](#org66b057d) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org3a77d0a) displays the choice of &lambda; that results from
...
Figure [190](#orgbb8dc11) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org1fcdcc0), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org1fcdcc0), the left-hand panel has
...
Figure [195](#org01eb053) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org7cd011c) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org4a238dc) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org8630c37) further illustrates the risk of carelessly applying
...
Figure [203](#org3cc9730) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org0c7e93d) is a plot of `wage` against
