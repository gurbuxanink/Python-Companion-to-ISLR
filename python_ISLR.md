...
1.  [Introduction](#org5ff8bf4)
2.  [Statistical Learning](#orgfaabd95)
    1.  [What is Statistical Learning?](#org1e4f0cf)
    2.  [Assessing Model Accuracy](#org4699b35)
    3.  [Lab: Introduction to Python](#org200af4a)
        1.  [Basic Commands](#org934be0d)
        2.  [Graphics](#org232179f)
        3.  [Indexing Data](#org924ba68)
        4.  [Loading Data](#orge441c92)
        5.  [Additional Graphical and Numerical Summaries](#orgd7d5309)
3.  [Linear Regression](#org17c85c2)
    1.  [Simple Linear Regression](#orgc9eb65f)
    2.  [Multiple Linear Regression](#org108a5e6)
    3.  [Other Considerations in the Regression Model](#orgd32aad5)
    4.  [The Marketing Plan](#org2224bd0)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#orgbdb316e)
    6.  [Lab: Linear Regression](#orgdfac0e0)
        1.  [Libraries](#org10ed830)
        2.  [Simple Linear Regression](#orgd1765c7)
        3.  [Multiple Linear Regression](#org10edcd8)
        4.  [Interaction Terms](#org0a53fef)
        5.  [Non-linear Transformations of the Predictors](#orga91c5f9)
        6.  [Qualitative Predictors](#org106dd28)
        7.  [Calling `R` from `Python`](#org5e79cf8)
4.  [Classification](#org3ca6988)
    1.  [An Overview of Classification](#org4b9d3cf)
    2.  [Why Not Linear Regression?](#orgc54c215)
    3.  [Logistic Regression](#org6a43427)
    4.  [Linear Discriminant Analysis](#org81f450c)
    5.  [A Comparison of Classification Methods](#org945a78e)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#orgf8e082a)
        1.  [The Stock Market Data](#org5d29747)
        2.  [Logistc Regression](#orgff5b861)
        3.  [Linear Discriminant Analysis](#orgc76fc60)
        4.  [Quadratic Discriminant Analysis](#org81a3678)
        5.  [K-Nearest Neightbors](#orgf5acd24)
        6.  [An Application to Caravan Insurance Data](#org5ff544d)
5.  [Resampling Methods](#org88d6edc)
    1.  [Cross-Validation](#org39c1560)
    2.  [The Bootstrap](#orgfcbace0)
    3.  [Lab: Cross-Validation and the Bootstrap](#org42cdf87)
        1.  [The Validation Set Approach](#orga17956f)
        2.  [Leave-One-Out Cross-Validation](#org8bbe7bd)
        3.  [k-Fold Cross-Validation](#org1789eea)
        4.  [The Bootstrap](#orgc2e6711)
6.  [Linear Model Selection and Regularization](#org12caff2)
    1.  [Subset Selection](#org5851f63)
    2.  [Shrinkage Methods](#org631055a)
    3.  [Dimension Reduction Methods](#org6c8524e)
    4.  [Considerations in High Dimensions](#org101224e)
    5.  [Lab 1: Subset Selection Methods](#orgf8f02fd)
        1.  [Best Subset Selection](#orgbd9d74f)
        2.  [Forward and Backward Stepwise Selection](#org580aef3)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org36ffa05)
    6.  [Lab 2: Ridge Regression and the Lasso](#org6b27f1c)
        1.  [Ridge Regression](#orgac0928c)
        2.  [The Lasso](#orgaa574a9)
    7.  [Lab 3: PCR and PLS Regression](#org7d20757)
        1.  [Principal Components Regression](#orgc4e6888)
        2.  [Partial Least Squares](#orgf5fef65)
7.  [Moving Beyond Linearity](#org6ed8855)
    1.  [Polynomial Regression](#org9f7d13f)
    2.  [Step Functions](#org40f796e)
    3.  [Basis Functions](#org94b46c9)
    4.  [Regression Splines](#org6381bae)
    5.  [Lab: Non-linear Modeling](#orgfcb28a0)
        1.  [Polynomial Regression and Step Functions](#org57f48aa)
8.  [Tree-Based Models](#org87d4925)
    1.  [The Basics of Decision Trees](#org65f5be6)
        1.  [Regression Trees](#org7dc2636)
        2.  [Classification Trees](#org5c37f87)
        3.  [Trees versus Linear Models](#orgd807a39)
    2.  [Bagging, Random Forests, Boosting](#org5cf84e5)
    3.  [Lab: Decision Trees](#org4f31386)
        1.  [Fitting Classification Trees](#org4728c25)
        2.  [Fitting Regression Trees](#org32ae67d)
        3.  [Bagging and Random Forests](#orgd53f7e9)
        4.  [Boosting](#orgb6da90a)
9.  [Support Vector Machines](#org947ef17)
    1.  [Maximal Margin Classifier](#org2ab0fcd)
        1.  [What is a Hyperplane?](#orgf47708e)
        2.  [Classification Using a Separating Hyperplane](#org58268a8)
        3.  [The Maximal Margin Classifier](#orgc014f94)
        4.  [Construction of the Maximal Margin Classifier](#org15ef3df)
        5.  [The Non-separable Case](#org962401e)
    2.  [Support Vector Classifiers](#org69fef2e)
        1.  [Overview of the Support Vector Classifier](#org0d517a0)
        2.  [Details of the Support Vector Classifier](#org32878e6)
    3.  [Support Vector Machines](#org7ae69e2)
        1.  [Classification with Non-linear Decision Boundaries](#org8f0ed05)
        2.  [The Support Vector Machine](#orgf7f60ff)
        3.  [An Application to the Heart Disease Data](#orgd22dce8)
    4.  [SVMs with More than Two Classes](#orged2c182)
        1.  [One-Versus-One Classification](#orgc87dbe7)
        2.  [One-Versus-All Classification](#org534719e)
    5.  [Relationship with Logistic Regression](#org45d9fb0)
    6.  [Lab: Support Vector Machines](#org4511ea0)
        1.  [Support Vector Classifier](#org605b418)
        2.  [Support Vector Machine](#orgb8a7744)
        3.  [ROC Curves](#orgac9937f)
        4.  [SVM with Multiple Classes](#org56077a3)
        5.  [Application to Gene Expression Data](#orgf92d417)
10. [Unsupervised Learning](#org3b0de7a)
    1.  [The Challenge of Unsupervised Learning](#orge931730)
    2.  [Principal Component Analysis](#orga6aac5f)
        1.  [What are Principal Components?](#org56a571d)
        2.  [Another Interpretation of Principal Components](#orgbda4990)
        3.  [More on PCA](#org398ee50)
    3.  [Clustering Methods](#org72ce96a)
        1.  [K-Means Clustering](#org16164ad)
        2.  [Hierarchical Clustering](#orgd3e91b7)
...
Figure [2](#org4b4ebd3) shows graphs of Wage versus three variables. 
...
Figure [4](#orgbe9c61b) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#orgea49c74) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org89a4d6d) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org97fd000) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#orgd12dac7) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org97fd000).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orgb31ee1e) provides an illustration of the trade-off between
...
Figure [17](#org6e0f39d) provides a simple illustration of the clustering problem.
...
Figure [21](#orgb865321) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgb865321), we see considerable
...
Figure [23](#org6c82db2) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgb865321) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org07f9127) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgb865321), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#org9e436dd) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgb865321) - [25](#org07f9127).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgdb6bd3a) provides an example using a simulated data set in
...
Figure [31](#org1763983) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgdb6bd3a).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgdb6bd3a), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgdb6bd3a).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org74b3609) we have plotted the KNN test and training errors as
...
Figure [48](#orgd6164a3) displays the simple linear regression fit to the
...
In figure [50](#org2f54436), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgfb7df0c) displays *population regression
...
right-hand panel of figure [52](#orgfb7df0c) we have generated five different
...
For `Advertising` data, table [1](#org9abb5c6) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="org9abb5c6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org5da463e), we report more information about the least squares model.  

<table id="org5da463e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org9acccdd)  shows results of two simple linear
...
<table id="org9acccdd" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org22da858) illustrates an example of the least squares fit to a
...
Table [4](#orgda6f941) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="orgda6f941" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#org271c60c) shows the correlation matrix for the three predictor
variables and response variable in table [4](#orgda6f941). 

<table id="org271c60c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org59c1904" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#orgda6f941).</caption>
...
Figure [61](#org99a1ed3) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orga25d6fe) records `balance`
...
Table [7](#org855b132) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="org855b132" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#orgd65a88d) we see that the estimated `balance` for the
...
<table id="orgd65a88d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#org6f1f01a) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org54a9487), the left panel shows least squares lines when
...
<table id="org6f1f01a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#org9e4f2d7) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orgc7accd8) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orgc7accd8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#org02bb377) displays a residual plot from the
...
of figure[73](#org02bb377) displays the residual plot results from the model
...
Figure [75](#org4237e7d) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orga0682d4), the magnitude of the
...
[79](#orgfbbbe95) illustrates a typical outlier.  The red solid line is the
...
[79](#orgfbbbe95), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#org3fae8da) has
...
[81](#org3fae8da) are the same as the data displayed in figure
[79](#orgfbbbe95), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgfbbbe95) and
[81](#org3fae8da), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#org3fae8da), for a data set with two
...
point. The right-panel of figure [81](#org3fae8da) provides a plot of
...
Figure [83](#org37941df) illustrates the concept of collinearity.
...
Figure [86](#orga10f07f) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#orga10f07f) displays contour
...
Table [11](#orgc06c6ec) compares the coefficient estimates obtained from two
...
<table id="orgc06c6ec" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org461c86d) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org0f89d91) provides an example of KNN regression with data
...
Figure [93](#org9c8717e) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org9c8717e)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org0f89d91) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#orgd318ba6) examines the relative performances of least squares
...
Figure [97](#org7be01f6) considers the same strongly non-linear situation as in the lower
panel of figure [95](#orgd318ba6), except that we have added additional *noise*
...
In figure [110](#orgbbb2e04), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#orgfa6f4e3) we show probability of default as a function of
...
Table [12](#org8cdc20b) shows the coefficient estimates and related
...
<table id="org8cdc20b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#org2640b08) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#orgfecad6a) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="org2640b08" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgfecad6a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#orgac6dd8f) shows average default rates
...
[14](#orgfecad6a).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#org30578af), two normal density functions
...
figure [121](#org4bf3a82).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org4bf3a82).  In this situation, the base
...
Figure [123](#org12df485) shows an example of three equally sized Gaussian
...
[15](#orga34d28b), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orga87973c) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orga34d28b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orga87973c" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgb0ae400) illustrates the trade-off that results from
...
Figure [128](#org159931a) displays the ROC curve for the LDA classifier on
...
Table [17](#orgcefc277) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orgcefc277" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#orga87fdf8) lists many of the popular performance measures that
are used in this context.

<table id="orga87fdf8" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orgcefc277).</caption>
...
Figure [132](#org2e238f7) illustrates the performances of LDA and QDA in two
...
Figure [134](#org1bbe5dc) illustrates the performances of the four
...
Figure [143](#org18cf937) displays the *validation set approach*, a simple
...
In figure [145](#orgd7ee22c), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org33270ac) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org137d88c) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org137d88c) shows nine different 10-fold
...
Figure [151](#org7462bc3) illustrates the *k*-fold CV approach.
...
In figure [153](#orgbfb022d), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgb865321),
[23](#org6c82db2), and [25](#org07f9127) of chapter [2](#orgc9e2375).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgb865321) (left), [23](#org6c82db2) (center), and [25](#org07f9127) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#org5cfff85) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgdb6bd3a).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#orgb2849f0) displays in black 10-fold CV
...
The right-hand panel of figure [158](#orgb2849f0) displays the same three curves
...
Figure [160](#orgb1a1632) illustrates the approach for estimating &alpha; by
...
figure [163](#org8c20064) displays a histogram of the resulting estimates.  The
...
[163](#org8c20064), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#orgc5132a3).
...
Table [19](#org83a7e3a) shows first four selected models for the best subset and
...
<table id="org83a7e3a" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org4bf7336) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org4bf7336) displays the same ridge
...
[182](#org6bb3e1b) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org80ee1c1), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org80ee1c1), as we
...
Figure [186](#org6996344) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#orgae31d2e) displays the choice of &lambda; that results from
...
Figure [190](#org85010fb) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org5527bed), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org5527bed), the left-hand panel has
...
Figure [195](#orgdbab0b1) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#orgdba93f9) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#orgb318384) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#orge3dd2db) further illustrates the risk of carelessly applying
...
Figure [203](#orgb7e5054) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org6b3faf4) is a plot of `wage` against
...
The left-hand panel of figure [227](#org8b4fd46) shows a fit of step functions
to the `Wage` data from figure [225](#org6b3faf4).  We also fit the logistic
...
Figure [234](#orgfc24e82) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#orgeef08c1) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#orgfc24e82).")

Figure [238](#orgec0e2a9) shows a five-region example of prediction via
...
Figure [240](#org42421e9) is an example of when a linear model or a tree
...
Figure [242](#orgfedc2a9) is a graphical representation of *variable
...
Figure [247](#org7f4be5e) shows a hyperplane in two-dimensional space.
...
Figure [249](#org1f5002d) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#org421e363), we see that three training observations are
...
[251](#org421e363), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#org99aa8ac) shows an example where we cannot *exactly* separate the two
...
In figures [255](#orgb4ee524), addition of a single observation in the right hand panel
...
Figure [257](#org31f4e7d) is an example of a *support vector classifier*.  Most of the
...
Figure [259](#org76d2136) illustrates the width of margin for different values of
...
In figure [261](#orgd56deb0) consider the data shown in the left panel.  It is clear
...
In figure [263](#org291f072), the left-hand panel shows an example of SVM with a
polynomial kernel applied the non-linear data from figure [261](#orgd56deb0).  The fit
...
![img](figures/fig9_9.png "Left: An SVM with a polynomial kernel of degree 3 is applied to the non-linear data from figure [261](#orgd56deb0), resulting in a more appropriate decision rule.  Right: An SVM with a radial kernel is applied.  In this example, radial kernel is the most capable of capturing the decision boundary.")
...
In figure [265](#org51b0cec), the left-hand panel displays ROC curves for training set
...
Figure [267](#org131a17f) compares ROC curves on test observations.  Using default
...
[20](#orgead8eca) shows loadings of the first two principal components.
Figure [273](#org22e6d6e) plots the first two principal components of these
data.  The figure represents both the principal component scores and the loading
vectors in a single *biplot* display.

<table id="orgead8eca" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 20:</span> The principal component loading factors, &phi;<sub>1</sub> and &phi;<sub>2</sub>, for the `USArrests` data.  These are also displayed in figure [273](#org22e6d6e).</caption>
...
In figure [275](#org0d3e63a), the left-hand panel is the same as figure
[273](#org22e6d6e), where each variable was first scaled to have mean zero and standard
...
![img](figures/fig10_3.png "Two principal component biplots for `USArrests` data.  Left: Same as figure [273](#org22e6d6e), with variables scaled to have unit standard deviations.  Right: Principal components using unscaled data.  `Assault` has by far the largest loading on the first principal component because it has the largest variance among the four variables.  In general, it is recommended to scale variables to have standard deviation one.")

In Figure [277](#org7746924), the left-hand panel shows the proportion of
...
Figure [279](#org8de1912) shows the results obtained from performing *K*-means
...
We begin with the simulated data set shown in figure [285](#org1fabea5),
