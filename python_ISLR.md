...
1.  [Introduction](#orgd810353)
2.  [Statistical Learning](#org5aa89fa)
    1.  [What is Statistical Learning?](#org6872e34)
    2.  [Assessing Model Accuracy](#org6831bbb)
    3.  [Lab: Introduction to Python](#org2c5acea)
        1.  [Basic Commands](#org755022b)
        2.  [Graphics](#org2737bc7)
        3.  [Indexing Data](#org349760a)
        4.  [Loading Data](#org9c5ccbc)
        5.  [Additional Graphical and Numerical Summaries](#orgefa3b68)
3.  [Linear Regression](#org0a3151b)
    1.  [Simple Linear Regression](#orge1b6bfd)
    2.  [Multiple Linear Regression](#orgc6ff660)
    3.  [Other Considerations in the Regression Model](#orgab70e83)
    4.  [The Marketing Plan](#orgf4ce8c0)
    5.  [Comparison of Linear Regression with K-Nearest Neighbors](#org1a03248)
    6.  [Lab: Linear Regression](#org6f4ccd7)
        1.  [Libraries](#org12f2a9a)
        2.  [Simple Linear Regression](#org3d297a0)
        3.  [Multiple Linear Regression](#orgad3ca8f)
        4.  [Interaction Terms](#orgbfece5d)
        5.  [Non-linear Transformations of the Predictors](#orgb8df2a0)
        6.  [Qualitative Predictors](#org71545e7)
        7.  [Calling `R` from `Python`](#org6676db8)
4.  [Classification](#org322562a)
    1.  [An Overview of Classification](#orge9d063b)
    2.  [Why Not Linear Regression?](#orgf73b7c3)
    3.  [Logistic Regression](#org4c861e9)
    4.  [Linear Discriminant Analysis](#org0f74294)
    5.  [A Comparison of Classification Methods](#orga63c3e2)
    6.  [Lab: Logistic Regression, LDA, QDA, and KNN](#org2a4f82e)
        1.  [The Stock Market Data](#org1323d92)
        2.  [Logistc Regression](#org3c31001)
        3.  [Linear Discriminant Analysis](#orgc5a632e)
        4.  [Quadratic Discriminant Analysis](#org5170138)
        5.  [K-Nearest Neightbors](#orgf7309d3)
        6.  [An Application to Caravan Insurance Data](#org0ca6ab4)
5.  [Resampling Methods](#orgb3a20b8)
    1.  [Cross-Validation](#org1d4d92f)
    2.  [The Bootstrap](#orgf68d745)
    3.  [Lab: Cross-Validation and the Bootstrap](#org3b25f49)
        1.  [The Validation Set Approach](#org3e71c4b)
        2.  [Leave-One-Out Cross-Validation](#orga1b7e97)
        3.  [k-Fold Cross-Validation](#org2a016b5)
        4.  [The Bootstrap](#org27dc443)
6.  [Linear Model Selection and Regularization](#orga64db99)
    1.  [Subset Selection](#orgb5c4354)
    2.  [Shrinkage Methods](#org58f2abb)
    3.  [Dimension Reduction Methods](#orgf148674)
    4.  [Considerations in High Dimensions](#orga50d629)
    5.  [Lab 1: Subset Selection Methods](#org17f2230)
        1.  [Best Subset Selection](#org3e13643)
        2.  [Forward and Backward Stepwise Selection](#org859492f)
        3.  [Choosing Among Models Using the Validation Set Approach and Cross-Validation](#org9998e2e)
    6.  [Lab 2: Ridge Regression and the Lasso](#orge0cae6f)
        1.  [Ridge Regression](#org2dd3b7e)
        2.  [The Lasso](#orga4f974d)
    7.  [Lab 3: PCR and PLS Regression](#org08647d6)
        1.  [Principal Components Regression](#orga12fa24)
        2.  [Partial Least Squares](#org7977ede)
7.  [Moving Beyond Linearity](#org3ecff02)
    1.  [Polynomial Regression](#org02a8344)
    2.  [Step Functions](#org1f20c31)
    3.  [Basis Functions](#org6236d69)
    4.  [Regression Splines](#org550587e)
    5.  [Lab: Non-linear Modeling](#orge644465)
        1.  [Polynomial Regression and Step Functions](#org3dcca14)
8.  [Tree-Based Models](#orgab2e2e6)
    1.  [The Basics of Decision Trees](#orgedefbbd)
        1.  [Regression Trees](#org4dbdaca)
        2.  [Classification Trees](#org5efe7fb)
        3.  [Trees versus Linear Models](#org6b8ca52)
    2.  [Bagging, Random Forests, Boosting](#orgadbcdd5)
    3.  [Lab: Decision Trees](#org0a594e1)
        1.  [Fitting Classification Trees](#orgd3cb374)
        2.  [Fitting Regression Trees](#org75b223d)
        3.  [Bagging and Random Forests](#org513c379)
        4.  [Boosting](#org5cca2bc)
9.  [Support Vector Machines](#org614ded5)
    1.  [Maximal Margin Classifier](#org5eb0b23)
        1.  [What is a Hyperplane?](#org2525117)
        2.  [Classification Using a Separating Hyperplane](#orgcd60610)
        3.  [The Maximal Margin Classifier](#org082f32d)
        4.  [Construction of the Maximal Margin Classifier](#org90908ee)
        5.  [The Non-separable Case](#org93c3f96)
    2.  [Support Vector Classifiers](#org1290c6a)
...
Figure [2](#orgc3b3f84) shows graphs of Wage versus three variables. 
...
Figure [4](#orgb2c0532) shows boxplots of previous days' percentage changes in S&P
...
Figure [7](#org3bce7af) shows scatter plots of `sales` versus `TV`, `radio`,
...
Figure [9](#org5e6bd7e) is a plot of `Income` versus `Years of Education` from the
...
Figure [11](#org2f4b1a3) is a plot of `Income` versus `Years of Education` and
...
Figure [13](#org7672573) shows an example of the parametric approach applied to
the `Income` data from previous figure. 

![img](figures/fig2_4.png "A linear model fit by least squares to the `Income` data from figure [11](#org2f4b1a3).  The observations are shown in red, and the blue plane indicates the least squares fit to the data.")

Figure [15](#orgfa9d0aa) provides an illustration of the trade-off between
...
Figure [17](#org5f79dff) provides a simple illustration of the clustering problem.
...
Figure [21](#orgb56f4b5) illustrates the tradeoff between training MSE and test
...
When we repeat the simulations for figure [21](#orgb56f4b5), we see considerable
...
Figure [23](#org46d7726) provides another example in which the true \(f\) is
approximately linear. 

![img](figures/fig2_10.png "Details are as in figure [21](#orgb56f4b5) using a different true \(f\) that is much closer to linear.  In this setting, linear regression provides a very good fit to the data.")

Figure [25](#org3cc5030) displays an example in which \(f\) is highly
non-linear. The training and test MSE curves still exhibit the same general
patterns.

![img](figures/fig2_11.png "Details are as in figure [21](#orgb56f4b5), using a different \(f\) that is far from linear.  In this setting, linear regression provides a very poor fit to the data.")

Figure [27](#orgdc7610f) displays the relationship between bias, variance, and
...
![img](figures/fig2_12.png "Squared bias (blue curve), variance (orange curve), \(Var(\epsilon)\) (dashed line), and test MSE (red curve) for the three data sets in figures [21](#orgb56f4b5) - [25](#org3cc5030).  The vertical dotted line indicates the flexibility level corresponding to the smallest test MSE.")

Figure [29](#orgb124b87) provides an example using a simulated data set in
...
Figure [31](#org99e6480) displays the KNN decision boundary, using \(K=10\), when
applied to the simulated data set from figure [29](#orgb124b87).  Even though
...
![img](figures/fig2_15.png "The firm line indicates the KNN decision boundary on the data from figure [29](#orgb124b87), using \(K = 10\). The Bayes decision boundary is shown as a dashed line.  The KNN and Bayes decision boundaries are very similar.")

![img](figures/fig2_16.png "A comparison of the KNN decision boundaries (solid curves) obtained using \(K=1\) and \(K=100\) on the data from figure [29](#orgb124b87).  With \(K=1\), the decision boundary is overly flexible, while with \(K=100\) it is not sufficiently flexible.  The Bayes decision boundary is shown as dashed line.")

In figure [34](#org0d96ab3) we have plotted the KNN test and training errors as
...
![img](figures/fig2_17.png "The KNN training error rate (blue, 200 observations) and test error rate (orange, 5,000 observations) on the data from figure [29](#orgb124b87) as the level of flexibility (assessed using \(\frac{1}{K}\)) increases, or equivalently as the number of neighbors \(K\) decreases.  The black dashed line indicates the Bayes error rate.")
...
Figure [48](#org5f6c5f5) displays the simple linear regression fit to the
...
In figure [50](#org696f0b0), we have computed RSS for a number of values of
...
The left-hand panel of figure [52](#orgdae3944) displays *population regression
...
right-hand panel of figure [52](#orgdae3944) we have generated five different
...
For `Advertising` data, table [1](#orgedda95d) provides details of the least squares model for the
regression of number of units sold on TV advertising budget. 

<table id="orgedda95d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Next, in table [2](#org00815d5), we report more information about the least squares model.  

<table id="org00815d5" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [3](#org3ce3ce6)  shows results of two simple linear
...
<table id="org3ce3ce6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [57](#org7dddf82) illustrates an example of the least squares fit to a
...
Table [4](#org1993157) displays multiple regression coefficient estimates when
TV, radio, and newspaper advertising budgets are used to predict product sales
using `Advertising` data.

<table id="org1993157" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [5](#orgd24ed2f) shows the correlation matrix for the three predictor
variables and response variable in table [4](#org1993157). 

<table id="orgd24ed2f" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgcad44ab" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 6:</span> More information about the least squares model for the regression of number of units sold on TV, newspaper, and radio advertising budgets in the `Advertising` data.  Other information about this model was displayed in table [4](#org1993157).</caption>
...
Figure [61](#org45577dd) displays a three-dimensional plot of `TV` and `radio`
versus `sales`.  
...
`Credit` data set displayed in figure [63](#orge8483d5) records `balance`
...
Table [7](#orgbabc2b0) displays the coefficient estimates and other information
associated with the model where `gender` is the only explanatory variable.

<table id="orgbabc2b0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
From table [8](#org37074c0) we see that the estimated `balance` for the
...
<table id="org37074c0" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [9](#orgf84aacc) shows results of regressing `sales` and `TV` and `radio`
when an interaction term is included.  Coefficient of interaction term
`TV:radio` is highly significant.

In figure [68](#org2cf3907), the left panel shows least squares lines when
...
<table id="orgf84aacc" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [70](#orgcd70732) shows a scatter plot of `mpg` (gas mileage in miles per
...
Table [10](#orge8634f9) shows regression results of a quadratic fit to explain
`mpg` as a function of `horsepower` and \(\mathttt{horsepower^2}\).  

<table id="orge8634f9" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left panel of figure [73](#orgefce036) displays a residual plot from the
...
of figure[73](#orgefce036) displays the residual plot results from the model
...
Figure [75](#org7b54a69) provides an illustration of correlations among
...
In the left-hand panel of figure [77](#orgbe9a18d), the magnitude of the
...
[79](#orgd5fb411) illustrates a typical outlier.  The red solid line is the
...
[79](#orgd5fb411), the outlier is clearly visible.  In practice, to decide if
...
Observation 41 in the left-hand panel in figure [81](#orgfb86145) has
...
[81](#orgfb86145) are the same as the data displayed in figure
[79](#orgd5fb411), except for the addition of a single high leverage
...
removed. Comparing the left-hand panels of figures [79](#orgd5fb411) and
[81](#orgfb86145), we observe that removing the high leverage observation has a
much more substantial impact on least squares line than removing the outlier.
The center panel of figure [81](#orgfb86145), for a data set with two
...
point. The right-panel of figure [81](#orgfb86145) provides a plot of
...
Figure [83](#orgc9e9af0) illustrates the concept of collinearity.
...
Figure [86](#org8a360e6) illustrates some of the difficulties that can result
...
In contrast, the right hand panel of figure [86](#org8a360e6) displays contour
...
Table [11](#orga16a59d) compares the coefficient estimates obtained from two
...
<table id="orga16a59d" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [89](#org7fd338e) illustrates two KNN fits on a data set with \(p = 2\)
...
Figure [91](#org4164f54) provides an example of KNN regression with data
...
Figure [93](#org83a37d1) represents the linear regression fit to the same
data.  It is almost perfect.  The right hand panel of figure [93](#org83a37d1)
...
![img](figures/fig3_18.png "The same data set shown in figure [91](#org4164f54) is investigated further.  Left: The blue dashed line is the least squares fit to the data.  Since \(f(X)\) is in fact linear (displayed in black line), the least squares regression line provides a very good estimate of \(f(X)\).  Right: The dashed horizontal line represents the least squares test set MSE, while the green line corresponds to the MSE for KNN as a function of \(\frac{1}{K}\).  Linear regression achieves a lower test MSE than does KNN regression, since \(f(X)\) is in fact linear.")

Figure [95](#org4162b30) examines the relative performances of least squares
...
Figure [97](#orgdd95ab4) considers the same strongly non-linear situation as in the lower
panel of figure [95](#org4162b30), except that we have added additional *noise*
...
In figure [110](#org87aa60a), we have plotted annual `income` and monthly
...
Using `Default` data set, in figure [112](#org7e8d767) we show probability of default as a function of
...
Table [12](#org628eea6) shows the coefficient estimates and related
...
<table id="org628eea6" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [13](#orgb411568) shows the results of logistic model where `default`
is a function of the qualitative variable `student`.  

Table [14](#org0e2ce38) shows the coefficient estimates for a logistic
regression model that uses `balance`, `income` (in thousands of dollars), and
`student` status to predict probability of `default`.

<table id="orgb411568" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="org0e2ce38" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
The left hand panel of figure [117](#org05d9559) shows average default rates
...
[14](#org0e2ce38).  But the horizontal lines near the base of the plot, which show the default rates
...
In the left panel of figure [119](#orgfe8556b), two normal density functions
...
figure [121](#org308dd87).  In the upper panel, the height of the surface at
...
right-hand panel of figure [121](#org308dd87).  In this situation, the base
...
Figure [123](#org5e83a57) shows an example of three equally sized Gaussian
...
[15](#orgad0b9c7), is a convenient way to display prediction of default in
comparison to true default.  Table [16](#orgb5deb78) shows the error rates
that result when we label any customer with a posterior probability of default
above 20% to the *default* class.

<table id="orgad0b9c7" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
<table id="orgb5deb78" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Figure [126](#orgd9bb143) illustrates the trade-off that results from
...
Figure [128](#org7edc874) displays the ROC curve for the LDA classifier on
...
Table [17](#orga017042) shows the possible results when applying a
classifier (or diagnostic test) to a population.  

<table id="orga017042" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
Table [18](#org83e4e7b) lists many of the popular performance measures that
are used in this context.

<table id="org83e4e7b" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
<caption class="t-bottom"><span class="table-number">Table 18:</span> Important measures for classification and diagnostic testing, derived from quantities in table [17](#orga017042).</caption>
...
Figure [132](#org790a6e6) illustrates the performances of LDA and QDA in two
...
Figure [134](#org04c0316) illustrates the performances of the four
...
Figure [143](#org75dd125) displays the *validation set approach*, a simple
...
In figure [145](#org11b49a0), the left-hand panel shows validation sample MSE as a
...
Figure [147](#org2665c7f) displas the Leave One Out Cross Validation (LOOCV) approach.
...
The left-hand panel of figure [149](#org18cfda2) shows test set MSE as a function of
...
The right-hand panel of figure [149](#org18cfda2) shows nine different 10-fold
...
Figure [151](#org52d85bc) illustrates the *k*-fold CV approach.
...
In figure [153](#org562dbe0), we plot the cross-validation estimates and true
test error rates that result from fitting least squares polynomials to the
simulated data sets illustrated in figures [21](#orgb56f4b5),
[23](#org46d7726), and [25](#org3cc5030) of chapter [2](#org2021ced).  In all
three plots, the two cross validation errors are very similar.  

![img](figures/fig5_6.png "True and estimated test MSE for the simulated data sets in Figures [21](#orgb56f4b5) (left), [23](#org46d7726) (center), and [25](#org3cc5030) (right).  The true test MSE is shown in blue, the LOOCV estimate is shown in black dashed line, and the 10-fold CV estimate is shown in red dotted line.")

Figure [155](#orgab9eea6) shows Bayesian decision boundary (blue dashed line)
and logistic regression decision boundary (black line) for 1- to 4-degree
polynomials on \(X_1\) and \(X_2\). 

![img](figures/fig5_7.png "Logistic regression fits on the two-dimensional classification data displayed in figure [29](#orgb124b87).  The Bayes decision boundary is represented using a blue dashed line.  Estimated decision boundaries from linear, quadratic, cubic, and quartic (degrees 1-4) logistic regressions are displayed in black.")

The left-hand panel of figure [158](#org5bc41cb) displays in black 10-fold CV
...
The right-hand panel of figure [158](#org5bc41cb) displays the same three curves
...
Figure [160](#org82d14a6) illustrates the approach for estimating &alpha; by
...
figure [163](#orge819f30) displays a histogram of the resulting estimates.  The
...
[163](#orge819f30), which displays a histogram of 1000 bootstrap estimates of
...
An application of best subset selection is shown in figure [172](#org80b172f).
...
Table [19](#orgdd3df5e) shows first four selected models for the best subset and
...
<table id="orgdd3df5e" border="2" cellspacing="0" cellpadding="6" rules="groups" frame="hsides">
...
In figure [180](#org7ae21d5) the ridge regression coefficient estimates for the
...
The right-hand panel of figure [180](#org7ae21d5) displays the same ridge
...
[182](#org5eca282) shows the bias-tradeoff on this simulated data set.
...
In figure [184](#org0736d85), coefficient plots are generated from applying the
...
are quite different.  In the right-hand panel of figure [184](#org0736d85), as we
...
Figure [186](#org2cd0a8a) illustrates why lasso, unlike ridge regression, results
...
Figure [188](#org496ff30) displays the choice of &lambda; that results from
...
Figure [190](#org7db5631) shows daily changes in 10-year Treasury note yield (`10
...
[193](#org382541f), the left-hand panel shows the distances between data points
...
In the right-hand panel of figure [193](#org382541f), the left-hand panel has
...
Figure [195](#org68e2a03) displays `10 YR` and `2 YR` versus first principal
...
Figure [197](#org2b42bd5) displays `10 YR` and `2 YR` versus second principal
...
Figure [199](#org1d6bb7c) shows *p* = 1 feature (plus an intercept) in two
...
Figure [201](#org2c97c37) further illustrates the risk of carelessly applying
...
Figure [203](#orgd8b96a8) illustrates the performance of the lasso in a simple
...
The left-hand panel of figure [225](#org1c3bf1c) is a plot of `wage` against
...
The left-hand panel of figure [227](#org4f1b430) shows a fit of step functions
to the `Wage` data from figure [225](#org1c3bf1c).  We also fit the logistic
...
Figure [234](#org0716f8a) shows a regression tree fit to `Hitters` data.  We
...
117.5\}\).  Figure [236](#orgcfbe824) illustrates the regions as a function of
`Years` and `Hits`. 

![img](figures/fig8_2.png "The four-region partition for the `Hitters` data set from the regression tree in Figure [234](#org0716f8a).")

Figure [238](#org44d87f8) shows a five-region example of prediction via
...
Figure [240](#orgf0ef98d) is an example of when a linear model or a tree
...
Figure [242](#org7680783) is a graphical representation of *variable
...
Figure [247](#org25a7695) shows a hyperplane in two-dimensional space.
...
Figure [249](#orgd122854) shows an example of a separating hyperplane classifier.
...
Examining figure [251](#orgb230758), we see that three training observations are
...
[251](#orgb230758), \(p=2\)) and they \`\`support'' the maximal margin hyperplane.  If
...
Figure [253](#org09b3a79) shows an example where we cannot *exactly* separate the two
